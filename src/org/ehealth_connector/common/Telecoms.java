...
public class Telecoms {
	...
	/**
	 * Weist der Telecoms Liste eine Fax Nummer zu. Diese MÜSSEN folgendes Format haben: "+41.32.234.66.77"
	 *
	 * @param fax <br>
	 ...
	 * Weist der Telecoms Liste eine Fax Nummer zu. Diese MÜSSEN folgendes Format haben: "+41.32.234.66.77"
	 *
	 * @param phoneNr            Telefonnummer (nur internationale Rufnummer ohne Sonderzeichen: "+41.32.234.66.77"
	...
	/**
	 * <div class="en">Gets the e mails.</div>
	 * <div class="de">Liefert e mails.</div>
	 * <div class="fr"></div>
	 * <div class="it"></div>
	 *
	...
	/**
	 * <div class="en">Gets the faxes.</div>
	 * <div class="de">Liefert alle Fax Nummern</div>
	 * <div class="fr"></div>
	 * <div class="it"></div>
	 *
	...
	/**
	 * <div class="en">Gets the mdht telecoms.</div>
	 * <div class="de">Liefert mdht telecoms.</div>
	 * <div class="fr"></div>
	 * <div class="it"></div>
	 *
	...
	/**
	 * <div class="en">Gets the phones.</div>
	 * <div class="de">Liefert alle Telefonnummern</div>
	 * <div class="fr"></div>
	 * <div class="it"></div>
	 *
