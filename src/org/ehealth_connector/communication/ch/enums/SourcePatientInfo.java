...
public enum SourcePatientInfo implements CodedMetadataEnumInterface {
	...
	/**
	 * <div class="de">mehrdeutig</div> <div class="fr"></div> <div
	 * class="it"></div>
	 */
	AMBIGUOUS("A", "Ambiguous"),
	/**
	 * <div class="de">weiblich</div> <div class="fr">feminin</div> <div
	 * class="it">femminile</div>
	 */
	FEMALE("F", "Female"),
	/**
	 * <div class="de">männlich</div> <div class="fr">masculin</div> <div
	 * class="it">maschile</div>
	 */
	MALE("M", "Male"),
	/**
	 * <div class="de">nicht zutreffend</div> <div class="fr"></div> <div
	 * class="it"></div>
	 */
