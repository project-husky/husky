...
public enum ClassCode
	...
	ALERTS("DTC13", "Alerts"),
	/**
	 * <div class="de">Behandlungspläne, Behandlungsschemata</div> <div
	 * class="fr">Plans de soins</div> <div class="it">Schema di terapia</div>
	 */
	...
	/**
	 * <div class="de">Eigene Daten des Patienten</div> <div
	 * class="fr">Documents introduits par le patients</div> <div
	 * class="it">Documenti inseriti dal paziente</div>
	 */
	DATA_FROM_PATIENT("DTC21", "Data from Patient"),
	/**
	 * <div class="de">Diagnostische Untersuchungsbefunde</div> <div
	 * class="fr">Résultats d'examen diagnostic</div> <div class="it">Risultati
	 * di esame diagnostico</div>
	 */
	...
	/**
	 * <div class="de">Zusammenfassungen der Krankengeschichte</div> <div
	 * class="fr">Résumés d'antécédents</div> <div class="it">Riassunti della
	 * storia clinica</div>
	 */
	HISTORIC_OVERVIEWS("DTC10", "Historic Overviews"),
	/**
	 * <div class="de">Konsultationseinträge/-Notizen</div> <div
	 * class="fr">Notes de consultation</div> <div class="it">Rapporti e note di
	 * consultazione</div>
	 */
	NOTES_ON_CONSULTATIONS("DTC01", "Notes on Consultations"),
	/**
	 * <div class="de">Interventionseinträge/-Notizen</div> <div
	 * class="fr">Notes d'interventions</div> <div class="it">Rapporti e note
	 * d'intervento</div>
	 */
	NOTES_ON_PROCEDURES("DTC03", "Notes on Procedures"),
	/**
	 * <div class="de">Meldungen</div> <div
	 * class="fr">"Notifications/Déclarations"</div> <div
	 * class="it">Notifiche/dichiarazioni</div>
	 */
	...
	/**
	 * <div class="de">Zusammenfassungen aktueller Zustand</div> <div
	 * class="fr">Résumés de l'état actuel</div> <div class="it">Riassunti dello
	 * stato attuale</div>
	 */
	...
	/**
	 * <div class="de">Untersuchungs-/ Prozedur-Anforderungen</div> <div
	 * class="fr">Demandes d'examen / procédure</div> <div class="it">Richieste
	 * d'esame</div>
	 */
	...
	/**
	 * <div class="de">Code für Behandlungspläne, Behandlungsschemata</div> <div
	 * class="fr">Code de Plans de soins</div> <div class="it">Code per Schema
	 * di terapia</div>
	 */
	public static final String CARE_PLANS_CODE = "DTC12";

	/**
	 * <div class="de">Code für Zuweisungen/Überweisungen</div> <div
	 * class="fr">Code de Demandes de prise en charge</div> <div class="it">Code
	 * per Richieste di presa a carico</div>
	 */
	public static final String CLINICAL_CARE_REFERRALS_CODE = "DTC05";

	/**
	 * <div class="de">Code für Eigene Daten des Patienten</div> <div
	 * class="fr">Code de Documents introduits par le patients</div> <div
	 * class="it">Code per Documenti inseriti dal paziente</div>
	 */
	public static final String DATA_FROM_PATIENT_CODE = "DTC21";

	/**
	 * <div class="de">Code für Diagnostische Untersuchungsbefunde</div> <div
	 * class="fr">Code de Résultats d'examen diagnostic</div> <div
	 * class="it">Code per Risultati di esame diagnostico</div>
	 */
	public static final String DIAGNOSTIC_TEST_RESULTS_CODE = "DTC08";

	/**
	 * <div class="de">Code für Zusammenfassende Berichte</div> <div
	 * class="fr">Code de Résumés d'épisode</div> <div class="it">Code per
	...
	/**
	 * <div class="de">Code für Konsultationseinträge/-Notizen</div> <div
	 * class="fr">Code de Notes de consultation</div> <div class="it">Code per
	 * Rapporti e note di consultazione</div>
	 */
	public static final String NOTES_ON_CONSULTATIONS_CODE = "DTC01";

	/**
	 * <div class="de">Code für Interventionseinträge/-Notizen</div> <div
	 * class="fr">Code de Notes d'interventions</div> <div class="it">Code per
	 * Rapporti e note d'intervento</div>
	 */
	...
	/**
	 * <div class="de">Code für anderweitige Dokumente</div> <div
	 * class="fr">Code de Autre</div> <div class="it">Code per Altro</div>
	 */
	public static final String OTHER_COMPOSITION_CODE = "DTC90";

	/**
	 * <div class="de">Code für Zusammenfassungen aktueller Zustand</div> <div
	 * class="fr">Code de Résumés de l'état actuel</div> <div class="it">Code
	 * per Riassunti dello stato attuale</div>
	 */
	public static final String PRESENT_STATE_SUMMARIES_CODE = "DTC11";

	/**
	 * <div class="de">Code für Verlaufseinträge/-Notizen</div> <div
	 * class="fr">Code de Notes de suivi</div> <div class="it">Code per Note di
	 * evoluzione</div>
	 */
	 ...
	 * <div class="fr">Code de Demandes d'examen / procédure</div> <div
	 * class="it">Code per Richieste d'esame</div>
	 */
