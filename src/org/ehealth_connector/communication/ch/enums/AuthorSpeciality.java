...
public enum AuthorSpeciality implements CodedMetadataEnumInterface {
	...
	/**
	 * <div class="de">andere Gesundheitsbezogene Fachrichtung</div> <div
	 * class="fr">autre spécialisation du domaine de la santé</div> <div
	 * class="it">Altri rami specialistici in ambito sanitario</div>
	 */
	ANDERE_GESUNDHEITSBEZOGENE_FACHRICHTUNG("50999", "andere Gesundheitsbezogene Fachrichtung"),
	/**
	 * <div class="de">Apothekerin/Apotheker in Offizinpharmazie </div> <div
	 * class="fr">Pharmacien d’officine </div> <div class="it">Farmacista in una
	 * farmacia d’officina</div>
	 */
	APOTHEKERINAPOTHEKER_IN_OFFIZINPHARMAZIE("50045", "Apothekerin/Apotheker in Offizinpharmazie "),
	/**
	 * <div class="de">Apothekerin/Apotheker in Spitalpharmazie</div> <div
	 * class="fr">Pharmacien d’officine en hôpital</div> <div
	 * class="it">Farmacista in una farmacia d'ospedale</div>
	 */
	 ...
	 * Analytiker</div> <div class="fr">Analyste biomédical</div> <div
	 * class="it">Tecnico in analisi biomediche </div>
	 */
	BIOMEDIZINISCHE_ANALYTIKERINBIOMEDIZINISCHER_ANALYTIKER("50056",
			"Biomedizinische Analytikerin/Biomedizinischer Analytiker"),
	/**
	 * <div class="de">Chiropraktorin/Chiropraktiker</div> <div
	 * class="fr">Chiropracteur</div> <div class="it">Chiropratico/a</div>
	 */
	 ...
	 * mit akademischem pflegefachlichem Abschluss (Bachelor)</div> <div
	 * class="fr">Infirmière diplômée / Infirmier diplômé avec un Bachelor de
	 * Science en soins infirmiers</div> <div class="it">Infermiere/a con titolo
	 * accademico (Bachelor)</div>
	 */
	...
	/**
	 * <div class="de">diplomierte Pflegefachfrau/diplomierter Pflegefachmann
	 * mit akademischem pflegefachlichem Abschluss (Master)</div> <div
	 * class="fr">Infirmière diplômée / Infirmier diplômé avec un Master de
	 * Science en soins infirmiers</div> <div class="it">Infermiere/a con titolo
	 * accademico (Master)</div>
	 */
	 ...
	 * diplômée / Infirmier diplômé avec un cours de spécialisation postgrades
	 * et des formation spéciale supplémentaires comme Conseiller/Conseillère
	 * aux diabétiques, conseiller/Coonseillère en cas d’allaitement</div> <div
	 * class="it">Infermiere/a diplomato/a con corso post-diploma di
	...
	DIPLOMIERTE_PFLEGEFACHFRAUDIPLOMIERTER_PFLEGEFACHMANN_MIT_FACHVERTIEFENDEM_NDK_UND_WEITEREN_ZUSATZAUSBILDUNGEN_WIE_DIABETESBERATERIN_STILLBERATERIN_ETC(
			"50066",
			"diplomierte Pflegefachfrau/diplomierter Pflegefachmann mit fachvertiefendem NDK und weiteren Zusatzausbildungen wie Diabetesberaterin, Stillberaterin etc."),
	/**
	 * <div class="de">diplomierte Pflegefachfrau/diplomierter Pflegefachmann
	 * mit Zusatz- oder Spezialfunktion, z.B. IPS, Anästhesie (NDS)</div> <div
	 * class="fr">Infirmière diplômée / Infirmier diplômé avec une function
	 * supplémentaire ou spécial, p.ex. soins intensiv, anesthésie</div> <div
	 * class="it">Infermiere/a diplomato/a con funzione supplementare o
	 * speciale, p. es. reparto cure intense (RCI), anestesia (SPD)</div>
	 */
	DIPLOMIERTE_PFLEGEFACHFRAUDIPLOMIERTER_PFLEGEFACHMANN_MIT_ZUSATZ_ODER_SPEZIALFUNKTION_Z_B_IPS_ANÄSTHESIE_NDS(
			"50065",
			"diplomierte Pflegefachfrau/diplomierter Pflegefachmann mit Zusatz- oder Spezialfunktion, z.B. IPS, Anästhesie (NDS)"),
	/**
	 * <div class="de">Diätologin/Diätologe</div> <div
	 * class="fr">Diabétologue</div> <div class="it">Dietologo/a</div>
	 */
	DIÄTOLOGINDIÄTOLOGE("50058", "Diätologin/Diätologe"),
	/**
	 * <div class="de">Ergotherapeutin/Ergotherapeut</div> <div
	 * class="fr">Ergothérapeute</div> <div class="it">Ergoterapista</div>
	 */
	ERGOTHERAPEUTINERGOTHERAPEUT("50059", "Ergotherapeutin/Ergotherapeut"),
	/**
	 * <div class="de">Ernährungsberaterin/Ernährungsberater</div> <div
	 * class="fr">Nutritionniste</div> <div class="it">Dietista</div>
	 */
	 ...
	 * santé communautaire (ASSC) avec certificat fédéral de capacité</div> <div
	 * class="it">Operatore/trice sociosanitario AFC con attestato federale di
	 * capacità</div>
	 */
	FACHFRAUFACHMANN_GESUNDHEIT_FAGE_MIT_EIDG_FÄHIGKEITSZEUGNIS("50068",
			"Fachfrau/Fachmann Gesundheit, FaGe mit eidg. Fähigkeitszeugnis"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Allergologie</div> <div
	 * class="fr">Médecin spécialiste en allergologie</div> <div
	 * class="it">Medico specializzato/a in allergologia</div>
	 */
	 ...
	 * e immunologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_ALLERGOLOGIE_UND_IMMUNOLOGIE("50073",
			"Fachärztin/Facharzt für Allergologie und Immunologie"),
	/**
	 ...
	 * <div class="it">Medico specializzato/a in medicina generale e
	 * interna</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_ALLGEMEINE_INNERE_MEDIZIN("50001",
			"Fachärztin/Facharzt für Allgemeine Innere Medizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Angiologie</div> <div
	 * class="fr">Médecin spécialiste en angiologie</div> <div class="it">Medico
	 * specializzato/a in angiologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_ANGIOLOGIE("50036", "Fachärztin/Facharzt für Angiologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Anästhesiologie</div> <div
	 * class="fr">Médecin spécialiste en anesthésiologie</div> <div
	 * class="it">Medico specializzato/a in anestesiologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_ANÄSTHESIOLOGIE("50002", "Fachärztin/Facharzt für Anästhesiologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Arbeitsmedizin</div> <div
	 * class="fr">Médecin spécialiste en médecine du travail</div> <div
	 * class="it">Medico specializzato/a in medicina del lavoro</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_ARBEITSMEDIZIN("50003", "Fachärztin/Facharzt für Arbeitsmedizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Chirurgie</div> <div
	 * class="fr">Médecin spécialiste en chirurgie</div> <div class="it">Medico
	 ...
	 * e venereologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_DERMATOLOGIE_UND_VENEROLOGIE("50005",
			"Fachärztin/Facharzt für Dermatologie und Venerologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Endokrinologie /
	 * Diabetologie</div> <div class="fr">Médecin spécialiste en endocrinologie
	 * / diabétologie</div> <div class="it">Medico specializzato/a in
	 * endocrinologia / diabetologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_ENDOKRINOLOGIE_DIABETOLOGIE("50006",
			"Fachärztin/Facharzt für Endokrinologie / Diabetologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Gastroenterologie</div> <div
	 * class="fr">Médecin spécialiste en gastroentérologie</div> <div
	 * class="it">Medico specializzato/a in gastroenterologia</div>
	 */
	 ...
	 * ostetricia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_GYNÄKOLOGIE_UND_GEBURTSHILFE("50008",
			"Fachärztin/Facharzt für Gynäkologie und Geburtshilfe"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Handchirurgie</div> <div
	 * class="fr">Médecin spécialiste en chirurgie de la main</div> <div
	 * class="it">Medico specializzato/a in chirurgia della mano</div>
	 */
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_HERZ_UND_THORAKALE_GEFÄSSCHIRURGIE("50010",
			"Fachärztin/Facharzt für Herz- und thorakale Gefässchirurgie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Hämatologie</div> <div
	 * class="fr">Médecin spécialiste en hématologie</div> <div
	 * class="it">Medico specializzato/a in ematologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_HÄMATOLOGIE("50009", "Fachärztin/Facharzt für Hämatologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Infektiologie</div> <div
	 * class="fr">Médecin spécialiste en infectiologie</div> <div
	 * class="it">Medico specializzato/a in infeziologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_INFEKTIOLOGIE("50011", "Fachärztin/Facharzt für Infektiologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Intensivmedizin</div> <div
	 * class="fr">Médecin spécialiste en médecine intensive</div> <div
	 * class="it">Medico specializzato/a in medicina intensiva</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_INTENSIVMEDIZIN("50037", "Fachärztin/Facharzt für Intensivmedizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Kardiologie</div> <div
	 * class="fr">Médecin spécialiste en cardiologie</div> <div
	 * class="it">Medico specializzato/a in cardiologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_KARDIOLOGIE("50012", "Fachärztin/Facharzt für Kardiologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Kinderchirurgie</div> <div
	 * class="fr">Médecin spécialiste en pédochirurgie</div> <div
	 * class="it">Medico specializzato/a in cardiologia pediatrica</div>
	 */
	 ...
	 * <div class="fr">Médecin spécialiste en pédiatrie</div> <div
	 * class="it">Medico specializzato/a in pediatria</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_KINDER_UND_JUGENDMEDIZIN("50013",
			"Fachärztin/Facharzt für Kinder- und Jugendmedizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Kinder- und Jugendpsychiatrie und
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_KINDER_UND_JUGENDPSYCHIATRIE_UND_PSYCHOTHERAPIE("50014",
	 ...
	 * clinique et toxicologie</div> <div class="it">Medico specializzato/a in
	 * farmacologia clinica e tossicologica</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_KLINISCHE_PHARMAKOLOGIE_UND_TOXIKOLOGIE("50016",
			"Fachärztin/Facharzt für Klinische Pharmakologie und Toxikologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Medizinische Genetik</div> <div
	 * class="fr">Médecin spécialiste en médecine génétique</div> <div
	 * class="it">Medico specializzato/a in genetica medica</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_MEDIZINISCHE_GENETIK("50038",
			"Fachärztin/Facharzt für Medizinische Genetik"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Medizinische Onkologie</div> <div
	 * class="fr">Médecin spécialiste en oncologie médicale</div> <div
	 * class="it">Medico specializzato/a in oncologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_MEDIZINISCHE_ONKOLOGIE("50039",
			"Fachärztin/Facharzt für Medizinische Onkologie"),
	/**
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_MUND_KIEFER_UND_GESICHTSCHIRURGIE("50017",
			"Fachärztin/Facharzt für Mund-, Kiefer- und Gesichtschirurgie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Nephrologie</div> <div
	 * class="fr">Médecin spécialiste en néphrologie</div> <div
	 * class="it">Medico specializzato/a in nefrologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_NEPHROLOGIE("50018", "Fachärztin/Facharzt für Nephrologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Neurochirurgie</div> <div
	 * class="fr">Médecin spécialiste en neurochirurgie</div> <div
	 * class="it">Medico specializzato/a in neurochirurgia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_NEUROCHIRURGIE("50019", "Fachärztin/Facharzt für Neurochirurgie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Neurologie</div> <div
	 * class="fr">Médecin spécialiste en neurologie</div> <div class="it">Medico
	 * specializzato/a in neurologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_NEUROLOGIE("50020", "Fachärztin/Facharzt für Neurologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Neuropathologie</div> <div
	 * class="fr">Médecin spécialiste en neuropathologie</div> <div
	 * class="it">Medico specializzato/a in neuropatologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_NEUROPATHOLOGIE("50043", "Fachärztin/Facharzt für Neuropathologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Nuklearmedizin</div> <div
	 * class="fr">Médecin spécialiste en médecine nucléaire</div> <div
	 * class="it">Medico specializzato/a in medicina nucleare</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_NUKLEARMEDIZIN("50021", "Fachärztin/Facharzt für Nuklearmedizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Ophthalmologie</div> <div
	 * class="fr">Médecin spécialiste en ophtalmologie</div> <div
	 * class="it">Medico specializzato/a in oftalmologia</div>
	 */
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_ORTHOPÄDISCHE_CHIRURGIE_UND_TRAUMATOLOGIE_DES_BEWEGUNGSAPPARATES(
			"50023",
			"Fachärztin/Facharzt für Orthopädische Chirurgie und Traumatologie des Bewegungsapparates"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Oto-Rhino-Laryngologie</div> <div
	 * class="fr">Médecin spécialiste en oto-rhino-laryngologie</div> <div
	 * class="it">Medico specializzato/a in otorinolaringoiatria</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_OTO_RHINO_LARYNGOLOGIE("50024",
			"Fachärztin/Facharzt für Oto-Rhino-Laryngologie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Pathologie</div> <div
	 * class="fr">Médecin spécialiste en pathologie</div> <div class="it">Medico
	 * specializzato/a in patologia</div>
	 */
	 ...
	 * <div class="fr">Médecin spécialiste en médecine pharmaceutique</div> <div
	 * class="it">Medico specializzato/a in medicina farmaceutica</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_PHARMAZEUTISCHE_MEDIZIN("50040",
			"Fachärztin/Facharzt für Pharmazeutische Medizin"),
	/**
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_PHYSIKALISCHE_MEDIZIN_UND_REHABILIATION("50026",
			"Fachärztin/Facharzt für Physikalische Medizin und Rehabiliation"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Plastische, Rekonstruktive und
	 * Ästhetische Chirurgie</div> <div class="fr">Médecin spécialiste en
	 * chirurgie plastique, reconstructrice et esthétique</div> <div
	 * class="it">Medico specializzato/a in chirurgia plastica, ricostruttiva ed
	 * estetica</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_PLASTISCHE_REKONSTRUKTIVE_UND_ÄSTHETISCHE_CHIRURGIE("50027",
			"Fachärztin/Facharzt für Plastische, Rekonstruktive und Ästhetische Chirurgie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Pneumologie</div> <div
	 * class="fr">Médecin spécialiste en pneumologie</div> <div
	 * class="it">Medico specializzato/a in pneumologia</div>
	 */
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_PRÄVENTION_UND_GESUNDHEITSWESEN("50029",
			"Fachärztin/Facharzt für Prävention und Gesundheitswesen"),
	/**
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_PSYCHIATRIE_UND_PSYCHOTHERAPIE("50030",
			"Fachärztin/Facharzt für Psychiatrie und Psychotherapie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Radiologie</div> <div
	 * class="fr">Médecin spécialiste en radiologie</div> <div class="it">Medico
	 * specializzato/a in radiologia</div>
	 */
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_RADIO_ONKOLOGIE_STRAHLENTHERAPIE("50032",
			"Fachärztin/Facharzt für Radio-Onkologie / Strahlentherapie"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Rechtsmedizin</div> <div
	 * class="fr">Médecin spécialiste en médecine légale</div> <div
	 * class="it">Medico specializzato/a in medicina legale</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_RECHTSMEDIZIN("50041", "Fachärztin/Facharzt für Rechtsmedizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Rheumatologie</div> <div
	 * class="fr">Médecin spécialiste en rhumatologie</div> <div
	 * class="it">Medico specializzato/a in reumatologia</div>
	 */
	 ...
	 */
	FACHÄRZTINFACHARZT_FÜR_TROPEN_UND_REISEMEDIZIN("50034",
			"Fachärztin/Facharzt für Tropen- und Reisemedizin"),
	/**
	 * <div class="de">Fachärztin/Facharzt für Urologie</div> <div
	 * class="fr">Médecin spécialiste en urologie</div> <div class="it">Medico
	 * specializzato/a in urologia</div>
	 */
	FACHÄRZTINFACHARZT_FÜR_UROLOGIE("50035", "Fachärztin/Facharzt für Urologie"),
	/**
	 * <div class="de">Gesundheitspsychologin/Gesundheitspsychologe</div> <div
	 * class="fr">Psychologue de la santé</div> <div class="it">Psicologo/a
	 * della salute</div>
	 */
	GESUNDHEITSPSYCHOLOGINGESUNDHEITSPSYCHOLOGE("50052",
			"Gesundheitspsychologin/Gesundheitspsychologe"),
	/**
	 * <div class="de">Gesundheits- und Sozialberatung</div> <div
	 * class="fr">Conseiller sanitaire et social</div> <div
	 * class="it">Consulenza sociosanitaria</div>
	 */
	GESUNDHEITS_UND_SOZIALBERATUNG("50071", "Gesundheits- und Sozialberatung"),
	/**
	 * <div class="de">Hebamme</div> <div class="fr">Sage-femme</div> <div
	 * class="it">Ostetrico/a / levatrice</div>
	 */
	...
	/**
	 * <div class="de">Hörgeräteakustiker/in</div> <div
	 * class="fr">Audioprothésiste</div> <div class="it">Specialista di
	 * apparecchi acustici</div>
	 */
	HÖRGERÄTEAKUSTIKERIN("50072", "Hörgeräteakustiker/in"),
	/**
	 * <div class="de">Kardiotechnikerin/Kardiotechniker</div> <div
	 * class="fr">Technicien en cardiologie</div> <div
	 * class="it">Cardiotecnico</div>
	 */
	KARDIOTECHNIKERINKARDIOTECHNIKER("50070", "Kardiotechnikerin/Kardiotechniker"),
	/**
	 * <div class="de">Klinischer Psychologe/Klinische Psychologin</div> <div
	 * class="fr">Psychologue clinicien</div> <div class="it">Psicologo/a
	 * clinico/a</div>
	 */
	KLINISCHER_PSYCHOLOGEKLINISCHE_PSYCHOLOGIN("50051",
			"Klinischer Psychologe/Klinische Psychologin"),
	/**
	 * <div class="de">Logopädin/Logopäde</div> <div
	 * class="fr">Orthophoniste</div> <div class="it">Logopedista</div>
	 */
	LOGOPÄDINLOGOPÄDE("50060", "Logopädin/Logopäde"),
	/**
	 * <div class="de">Musiktherapeutin/Musiktherapeut</div> <div
	 * class="fr">Musicothérapeute</div> <div class="it">Musicoterapeuta</div>
	 */
	MUSIKTHERAPEUTINMUSIKTHERAPEUT("50053", "Musiktherapeutin/Musiktherapeut"),
	/**
	 * <div class="de">Orthoptistin/Orthoptist</div> <div
	 * class="fr">Orthoptiste</div> <div class="it">Ortottista</div>
	 */
	 ...
	 * attestato</div>
	 */
	PFLEGEFACHFRAUPFLEGEFACHMANN_MIT_ATTESTABSCHLUSS("50067",
			"Pflegefachfrau/Pflegefachmann mit Attestabschluss"),
	/**
	 * <div class="de">Pharma-Assistentin / Pharma-Assistent</div> <div
	 * class="fr">Assistant en pharmacie</div> <div class="it">assistente di
	 * farmacia</div>
	 */
	PHARMA_ASSISTENTIN_PHARMA_ASSISTENT("50075", "Pharma-Assistentin / Pharma-Assistent"),
	/**
	 * <div class="de">Physiotherapeutin/Physiotherapeut</div> <div
	 * class="fr">Physiothérapeute</div> <div class="it">Psicoterapeuta</div>
	 */
	PHYSIOTHERAPEUTINPHYSIOTHERAPEUT("50055", "Physiotherapeutin/Physiotherapeut"),
	/**
	 * <div class="de">Psychotherapeutin/Psychotherapeut</div> <div
	 * class="fr">Psychothérapeute</div> <div class="it">Psicoterapeuta</div>
	 */
	PSYCHOTHERAPEUTINPSYCHOTHERAPEUT("50050", "Psychotherapeutin/Psychotherapeut"),
	/**
	 * <div class="de">Radiologietechnologin/Radiologietechnologe</div> <div
	 * class="fr">Technicien en radiologie</div> <div class="it">Tecnico in
	 * radiologia</div>
	 */
	RADIOLOGIETECHNOLOGINRADIOLOGIETECHNOLOGE("50057", "Radiologietechnologin/Radiologietechnologe"),
	/**
	 * <div class="de">Rettungssanitäterin/Rettungssanitäter</div> <div
	 * class="fr">Urgentiste</div> <div class="it">Soccorritore/trice</div>
	 */
	 ...
	 * <div class="fr">Code de Pharmacien d’officine en hôpital</div> <div
	 * class="it">Code per Farmacista in una farmacia d'ospedale</div>
	 */
	 ...
	 * Analytiker</div> <div class="fr">Code de Analyste biomédical</div> <div
	 * class="it">Code per Tecnico in analisi biomediche </div>
	 */
	public static final String BIOMEDIZINISCHE_ANALYTIKERINBIOMEDIZINISCHER_ANALYTIKER_CODE = "50056";

	/**
	 * <div class="de">Code für Chiropraktorin/Chiropraktiker</div> <div
	 * class="fr">Code de Chiropracteur</div> <div class="it">Code per
	 * Chiropratico/a</div>
	 */
	 ...
	 * diplômé avec un Bachelor de Science en soins infirmiers</div> <div
	 * class="it">Code per Infermiere/a con titolo accademico (Bachelor)</div>
	 */
	...
	/**
	 * <div class="de">Code für Ergotherapeutin/Ergotherapeut</div> <div
	 * class="fr">Code de Ergothérapeute</div> <div class="it">Code per
	 * Ergoterapista</div>
	 */
	public static final String ERGOTHERAPEUTINERGOTHERAPEUT_CODE = "50059";

	/**
	 * <div class="de">Code für Ernährungsberaterin/Ernährungsberater</div> <div
	 * class="fr">Code de Nutritionniste</div> <div class="it">Code per
	 * Dietista</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Allergologie</div> <div
	 * class="fr">Code de Médecin spécialiste en allergologie</div> <div
	 * class="it">Code per Medico specializzato/a in allergologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Angiologie</div> <div
	 * class="fr">Code de Médecin spécialiste en angiologie</div> <div
	 * class="it">Code per Medico specializzato/a in angiologia</div>
	 */
	 ...
	 * <div class="fr">Code de Médecin spécialiste en anesthésiologie</div> <div
	 * class="it">Code per Medico specializzato/a in anestesiologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Chirurgie</div> <div
	 * class="fr">Code de Médecin spécialiste en chirurgie</div> <div
	 * class="it">Code per Medico specializzato/a in chirurgia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Handchirurgie</div> <div
	 * class="fr">Code de Médecin spécialiste en chirurgie de la main</div> <div
	 * class="it">Code per Medico specializzato/a in chirurgia della mano</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Hämatologie</div> <div
	 * class="fr">Code de Médecin spécialiste en hématologie</div> <div
	 * class="it">Code per Medico specializzato/a in ematologia</div>
	 */
	public static final String FACHÄRZTINFACHARZT_FÜR_HÄMATOLOGIE_CODE = "50009";

	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Infektiologie</div> <div
	 * class="fr">Code de Médecin spécialiste en infectiologie</div> <div
	 * class="it">Code per Medico specializzato/a in infeziologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Kardiologie</div> <div
	 * class="fr">Code de Médecin spécialiste en cardiologie</div> <div
	 * class="it">Code per Medico specializzato/a in cardiologia</div>
	 */
	 ...
	 * <div class="fr">Code de Médecin spécialiste en pédochirurgie</div> <div
	 * class="it">Code per Medico specializzato/a in cardiologia
	 * pediatrica</div>
	 */
	 ...
	 * Médecin spécialiste en pédopsychiatrie et pédopsychothérapie</div> <div
	 * class="it">Code per Medico specializzato/a in pedopsichiatria e
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Nephrologie</div> <div
	 * class="fr">Code de Médecin spécialiste en néphrologie</div> <div
	 * class="it">Code per Medico specializzato/a in nefrologia</div>
	 */
	 ...
	 * <div class="fr">Code de Médecin spécialiste en neurochirurgie</div> <div
	 * class="it">Code per Medico specializzato/a in neurochirurgia</div>
	 */
	public static final String FACHÄRZTINFACHARZT_FÜR_NEUROCHIRURGIE_CODE = "50019";

	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Neurologie</div> <div
	 * class="fr">Code de Médecin spécialiste en neurologie</div> <div
	 * class="it">Code per Medico specializzato/a in neurologia</div>
	 */
	 ...
	 * <div class="fr">Code de Médecin spécialiste en neuropathologie</div> <div
	 * class="it">Code per Medico specializzato/a in neuropatologia</div>
	 */
	 ...
	 * <div class="fr">Code de Médecin spécialiste en ophtalmologie</div> <div
	 * class="it">Code per Medico specializzato/a in oftalmologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Pathologie</div> <div
	 * class="fr">Code de Médecin spécialiste en pathologie</div> <div
	 * class="it">Code per Medico specializzato/a in patologia</div>
	 */
	 ...
	 * Rekonstruktive und Ästhetische Chirurgie</div> <div class="fr">Code de
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Pneumologie</div> <div
	 * class="fr">Code de Médecin spécialiste en pneumologie</div> <div
	 * class="it">Code per Medico specializzato/a in pneumologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Radiologie</div> <div
	 * class="fr">Code de Médecin spécialiste en radiologie</div> <div
	 * class="it">Code per Medico specializzato/a in radiologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Rechtsmedizin</div> <div
	 * class="fr">Code de Médecin spécialiste en médecine légale</div> <div
	 * class="it">Code per Medico specializzato/a in medicina legale</div>
	 */
	public static final String FACHÄRZTINFACHARZT_FÜR_RECHTSMEDIZIN_CODE = "50041";

	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Rheumatologie</div> <div
	 * class="fr">Code de Médecin spécialiste en rhumatologie</div> <div
	 * class="it">Code per Medico specializzato/a in reumatologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Fachärztin/Facharzt für Urologie</div> <div
	 * class="fr">Code de Médecin spécialiste en urologie</div> <div
	 * class="it">Code per Medico specializzato/a in urologia</div>
	 */
	...
	/**
	 * <div class="de">Code für Gesundheits- und Sozialberatung</div> <div
	 * class="fr">Code de Conseiller sanitaire et social</div> <div
	 * class="it">Code per Consulenza sociosanitaria</div>
	 */
	...
	/**
	 * <div class="de">Code für Heilmasseurin/Heilmasseur</div> <div
	 * class="fr">Code de Masseur thérapeute</div> <div class="it">Code per
	...
	/**
	 * <div class="de">Code für Kardiotechnikerin/Kardiotechniker</div> <div
	 * class="fr">Code de Technicien en cardiologie</div> <div class="it">Code
	 * per Cardiotecnico</div>
	 */
	...
	/**
	 * <div class="de">Code für Musiktherapeutin/Musiktherapeut</div> <div
	 * class="fr">Code de Musicothérapeute</div> <div class="it">Code per
	 * Musicoterapeuta</div>
	 */
	public static final String MUSIKTHERAPEUTINMUSIKTHERAPEUT_CODE = "50053";

	/**
	 * <div class="de">Code für Orthoptistin/Orthoptist</div> <div
	 * class="fr">Code de Orthoptiste</div> <div class="it">Code per
	 * Ortottista</div>
	 */
	 ...
	 * Infirmier diplômé avec une attestation de formation</div> <div
	 * class="it">Code per Infermiere con attestato</div>
	 */
	public static final String PFLEGEFACHFRAUPFLEGEFACHMANN_MIT_ATTESTABSCHLUSS_CODE = "50067";

	/**
	 * <div class="de">Code für Pharma-Assistentin / Pharma-Assistent</div> <div
	 * class="fr">Code de Assistant en pharmacie</div> <div class="it">Code per
	 * assistente di farmacia</div>
	 */
	public static final String PHARMA_ASSISTENTIN_PHARMA_ASSISTENT_CODE = "50075";

	/**
	 * <div class="de">Code für Physiotherapeutin/Physiotherapeut</div> <div
	 * class="fr">Code de Physiothérapeute</div> <div class="it">Code per
	 * Psicoterapeuta</div>
	 */
	public static final String PHYSIOTHERAPEUTINPHYSIOTHERAPEUT_CODE = "50055";

	/**
	 * <div class="de">Code für Psychotherapeutin/Psychotherapeut</div> <div
	 * class="fr">Code de Psychothérapeute</div> <div class="it">Code per
	 * Psicoterapeuta</div>
	 */
	 ...
	 * <div class="fr">Code de Technicien en radiologie</div> <div
	 * class="it">Code per Tecnico in radiologia</div>
	 */
	public static final String RADIOLOGIETECHNOLOGINRADIOLOGIETECHNOLOGE_CODE = "50057";

	/**
	 * <div class="de">Code für Rettungssanitäterin/Rettungssanitäter</div> <div
	 * class="fr">Code de Urgentiste</div> <div class="it">Code per
