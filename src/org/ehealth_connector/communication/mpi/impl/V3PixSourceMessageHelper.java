...
public class V3PixSourceMessageHelper {
   ...
   * 
   * @param senderApplicationOID application oid of the sender
   * @param senderFacilityOID facility oid of the sender
   * @param receiverApplicationOID receiver oid the application
   * @param receiverFacilityOID receiver oid of the facility
   */
   ...
   * 
   * @param nationCode CWE:EmployeeOccupationCode
   */
  public void addEmployeeCode(String employeeOccupationCode) {
    if (v3RecordAddedMessage != null) {
      ...
      PRPAMT201301UV02Employee employee =
          V3Factory.eINSTANCE.createPRPAMT201301UV02Employee();
    ...
    if (v3RecordRevisedMessage != null) {
      ...
      PRPAMT201302UV02Employee employee =
          V3Factory.eINSTANCE.createPRPAMT201302UV02Employee();
      employee.setOccupationCode(PixPdqV3Utils.createCE(employeeOccupationCode));
      patientPerson.getAsEmployee().add(employee);
    }
    if (v3MergePatientsMessage != null) {
      PRPAMT201303UV02Person patientPerson = getPatientPerson(v3MergePatientsMessage);
      PRPAMT201303UV02Employee employee =
          V3Factory.eINSTANCE.createPRPAMT201303UV02Employee();
      employee.setOccupationCode(PixPdqV3Utils.createCE(employeeOccupationCode));
      patientPerson.getAsEmployee().add(employee);
    }
  }
   ...
   * 
   * @param languageCommunication the language communication {CWE:HumanLanguage}
   */
   ...
   * 
   * @param addressStreetAddress street
   * @param addressCity city
   * @param addressCounty county
   * @param addressState state
   * @param addressCountry country
   * @param addressZip zip
   * @param addressOtherDesignation streetline 2
   ...
   * 
   * @param code confidentiality Code {CWE:Confidentiality}
   */
   ...
   * 
   * @param code patient etnnic group code {CWE:Ethnicity}
   */
   ...
   * 
   * @param extension patient identifier
   * @param root oid of patient identifier domain
   * @param namespace namespace of patient identifier domain
   */
   ...
   * @param otherName other
   * @param prefixName prefix
   ...
   * adds a nation code
   * 
   * @param nationCode CWE:NationEntityType
   */
  public void addPatientNation(String nationCode) {
    if (v3RecordAddedMessage != null) {
      PRPAMT201301UV02Person patientPerson = getPatientPerson(v3RecordAddedMessage);
      PRPAMT201301UV02Citizen citizen =
          V3Factory.eINSTANCE.createPRPAMT201301UV02Citizen();
      PRPAMT201301UV02Nation citizenNation = 
          V3Factory.eINSTANCE.createPRPAMT201301UV02Nation();
    ...
    if (v3RecordRevisedMessage != null) {
      PRPAMT201302UV02PatientPatientPerson patientPerson = getPatientPerson(v3RecordRevisedMessage);
      PRPAMT201302UV02Citizen citizen =
          V3Factory.eINSTANCE.createPRPAMT201302UV02Citizen();
      PRPAMT201302UV02Nation citizenNation = 
          V3Factory.eINSTANCE.createPRPAMT201302UV02Nation();
      citizen.setPoliticalNation(citizenNation);
      citizenNation.setCode(PixPdqV3Utils.createCE(nationCode));
      patientPerson.getAsCitizen().add(citizen);
    }
    if (v3MergePatientsMessage != null) {
      PRPAMT201303UV02Person patientPerson = getPatientPerson(v3MergePatientsMessage);
      PRPAMT201303UV02Citizen citizen =
          V3Factory.eINSTANCE.createPRPAMT201303UV02Citizen();
      PRPAMT201303UV02Nation citizenNation = 
          V3Factory.eINSTANCE.createPRPAMT201303UV02Nation();
      citizen.setPoliticalNation(citizenNation);
      citizenNation.setCode(PixPdqV3Utils.createCE(nationCode));
      patientPerson.getAsCitizen().add(citizen);
    }
   ...
   * 
   * @param extension id for the patient which should be listed as otherId
   * @param root oid of the patient id domain
   */
   ...
   * 
   * @param code patient race code {CWE:Race}
   */
   ...
   * 
   * @param telecomValue value for the telecom 
   * @param useValue usage of telecom: "HP" or "WP" or "H" or "MC"
   */
   ...
   * 
   * @param addressBirthPlace the birth place address
   */
   ...
   * 
   * @param birthTime birthtime of the patient
   */
   ...
   * 
   * @param patientDeceased true if patient is deceased
   */
   ...
   * 
   * @param patientDeceasedTime deceased time of the patient
   */
   ...
   * 
   * @param gender gender values ("M", "F", or "U")
   */
   ...
   * 
   * @param maritalStatus marital status of the patient {CWE:MaritalStatus}
   */
   ...
   * 
   * @param family mothers maiden family
   * @param given mothers maiden given
   * @param other mothers maiden other
   * @param suffix mothers maiden suffix
   * @param prefix mothers maiden prefix
   */
   ...
   * 
   * @param birthIndicator true if multiple birth
   */
   ...
   * 
   * @param birthNumber birth order number
   */
   ...
   * 
   * @param code patient vip code CWE:PatientImportance}
   */
   ...
   * 
   * @param organizationOID oid of the organization
   * @param organizationName organization name
   * @param telecomValue contact telecom value of the organization
   */
