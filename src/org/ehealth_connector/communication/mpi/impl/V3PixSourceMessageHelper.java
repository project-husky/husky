...
public class V3PixSourceMessageHelper {
  ...
  public V3PixSourceMessageHelper(boolean addMessage, boolean revisedMessage, boolean mergeMessage,
    ...
    if (revisedMessage) {
      v3RecordRevisedMessage = new V3PixSourceRecordRevised(senderApplicationOid, senderFacilityOid,
          receiverApplicationOid, receiverFacilityOid);
    }
    if (mergeMessage) {
      v3MergePatientsMessage = new V3PixSourceMergePatients(senderApplicationOid, senderFacilityOid,
          receiverApplicationOid, receiverFacilityOid);
    }
  }
