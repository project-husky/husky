...
public class V3PixAdapterConfig {
	 ...
	 *            oid of id domains which are not medical ids
	 */
	public V3PixAdapterConfig(URI pixQueryUri, URI pixSourceUri,
			String senderApplicationOid, String senderFacilityOid,
			String receiverApplicationOid, String receiverFacilityOid,
			String homeCommunityOid, String homeCommunityNamespace,
			String domainToReturnOid, String domainToReturnNamespace,
			String auditRepositoryUri, String auditSourceId,
			String[] otherOidIds) {
		super();
