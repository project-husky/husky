...
public class DocumentSource {
	...
	// logger
	/** The Constant logger. */
	private static final Logger logger = Logger.getLogger(DocumentSource.class);
	 ...
	 * @throws Exception the exception
	 */
	public DocumentSource(String organizationalId, String repositoryUri, boolean auditorEnabled, @Nullable String log4jConfigPath) throws Exception {
	 ...
	 * @throws Exception the exception
	 */
	public DocumentSource(String organizationalId, String repositoryUri, boolean auditorEnabled, String keystorePath, String keystorePassword, String truststorePath, String truststorePassowrd, String log4jConfigPath) throws Exception {
