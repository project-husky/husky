...
public class FindDocumentsQuery implements StoredQueryInterface {
	 ...
	 * @param classCodes an array of codes, which classify the document (can be null)
	 * @param dateTimeRanges an array of DateTimeRange objects (can be null)
	 * @param practiceSettingCodes an array of codes, which classify the institution, where the document was created (can be null)
	 * @param healthCareFacilityCodes an array of codes, which classify the type of healthcare facility, where the document was created (can be null)
	 * @param confidentialityCodes an array of codes, which classify the confidentiality of the document (can be null)
