...
public class GetDocumentsQuery extends AbstractStoredQuery {
	...
	/**
	 * @param docIds list of ids of the documents (either uniqueId or entryUUID)
	 * @param isUUID isUUID set to true if docID is the entryUUID (internal registry identifier) of the document and set to false if it is the uniqueID (external to registry) of the document. In most user cases, this should be set to false
