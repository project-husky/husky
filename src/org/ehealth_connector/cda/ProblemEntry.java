...
public class ProblemEntry {
  ...
  /**
   * Erzeugt ein Objekt welches ein Problem repräsentiert. Dieses Objekt kann einem
   * ProblemConcernEntry hinzugefügt werden. Dieser Konstruktor wird verwendet, wenn ein leeres
   * Object initialisiert werden soll oder codiert werden soll, dass der Patient keine aktuellen
   * Probleme hat.
   * 
  ...
  /**
   * Erzeugt ein Objekt welches ein Problem repräsentiert. Dieses Objekt kann einem
   * ProblemConcernEntry hinzugefügt werden. Dieser Konstruktor wird verwendet, wenn für den
   * Patienten ein weiteres Problem (kein Komplikations- oder Expositionsrisiko) besteht und dieses
   * als Freitext angegeben wird.
   *
   * @param code <br>
   *        <div class="de">Code des Problems (z.B. SNOMED Code für eine Diagnose)</div> <div
   *        class="fr"></div> <div class="it"></div>
   * @param value <br>
   *        <div class="de">Beschreibung des Problems (z.B. Lungenentzündung)</div> <div
   *        class="fr"></div> <div class="it"></div>
   * @param start <br>
   *        <div class="de">Beginn des Problems</div> <div class="fr"></div> <div class="it"></div>
   * @param end <br>
   ...
   * ProblemConcernEntry hinzugefügt werden. Dieser Konstruktor wird verwendet, wenn für den
   * Patienten ein weiteres Problem (kein Komplikations- oder Expositionsrisiko) besteht und dieses
   * codiert angegeben wird.
   *
   * @param code <br>
   *        <div class="de">Code des Problems (z.B. SNOMED Code für eine Diagnose)</div> <div
   *        class="fr"></div> <div class="it"></div>
   * @param value <br>
   *        <div class="de">Wert des Problems (z.B. ICD Code für Lungenentzündung)</div> <div
   *        class="fr"></div> <div class="it"></div>
   * @param start <br>
   *        <div class="de">Beginn des Problems</div> <div class="fr"></div> <div class="it"></div>
   * @param end <br>
   ...
   * Erzeugt ein Objekt welches ein Problem repräsentiert. Dieses Objekt kann einem
   * ProblemConcernEntry hinzugefügt werden. Dieser Konstruktor wird verwendet, wenn für den
   * Patienten ein Komplikationsrisiko besteht.
   *
   * @param risc Komplikationsrisiko
   * @param start <br>
   *        <div class="de"> start</div> <div class="fr"> start</div> <div class="it"> start</div>
   * @param end <br>
   ...
   * Erzeugt ein Objekt welches ein Problem repräsentiert. Dieses Objekt kann einem
   * ProblemConcernEntry hinzugefügt werden. Dieser Konstruktor wird verwendet, wenn für den
   * Patienten ein Expositionsrisiko besteht.
   *
   ...
   *
   * @param text <br>
   *        <div class="de"> value</div> <div class="fr"> value</div> <div class="it"> value</div>
   */
  ...
  /**
   * <div class="de">Copy mdht problem entry.</div> <div class="fr"></div> <div class="it"></div>
   *
  ...
  /**
   * <div class="de">Gibt den Code des Problems zurück.</div> <div class="fr"></div> <div
   * class="it"></div>
   *
   * @return das codedProblem Objekt
   */
  public org.ehealth_connector.common.Code getCode() {
    org.ehealth_connector.common.Code code =
        new org.ehealth_connector.common.Code(mProblemEntry.getCode());
    return code;
  }

  /**
   * <div class="de">Gibt das Zeitpunkt zurück, seitdem das Problems beendet ist</div> <div
   * class="fr"></div> <div class="it"></div>
   *
  ...
  /**
   * <div class="de">Gibt zurück, ob das Problem nicht aufgetreten ist.</div> <div class="fr"></div>
   * <div class="it"></div>
   *
  ...
  /**
   * <div class="de">Gibt das Zeitpunkt zurück, seit das Problems angefangen hat</div> <div
   * class="fr"></div> <div class="it"></div>
   *
  ...
  /**
   * <div class="de">Setzt den Zeitpunkt, seitdem das Problems beendet ist</div> <div
   * class="fr"></div> <div class="it"></div>
   * 
  ...
  /**
   * <div class="de">Setzt eine interne (z.B. aus der Krankenakte bekannte) ID für das Problem. Wird
   * null angegeben, dann wird eine ID generiert.</div> <div class="fr"></div> <div
   * class="it"></div>
   *
   * @param id the new id
   */
  ...
  /**
   * <div class="de">Setzt den Zeitpunkt, an dem das Problems angefangen hat</div> <div
   * class="fr"></div> <div class="it"></div>
   * 
