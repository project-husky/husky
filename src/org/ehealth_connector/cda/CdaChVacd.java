...
public class CdaChVacd extends CdaCh<VACD> {
	...
	//
	// // create emf resource
	// final CDAResource resource = (CDAResource)
	// CDAResource.Factory.INSTANCE.createResource(URI
