...
public class AllergyProblem {
  ...
  /**
   * Erzeugt ein Objekt welches ein Allergie-Problem repräsentiert. Dieser Konstruktor wird
   * verwendet, wenn der Zeitraum in dem das Problem bestand unbekannt ist, das Problem als Code
   * angegeben werden soll. Dieses Objekt kann einem ProblemConcernEntry hinzugefügt werden.
   *
   * @param allergy <div class="de">Die Art der Allergie</div> <div class="fr"></div> <div
   *        class="it"></div>
   */
  ...
  /**
   * Erzeugt ein Objekt welches ein Allergie-Problem repräsentiert. Dieser Konstruktor wird
   * verwendet, wenn der Zeitraum in dem das Problem bestand bekannt ist und das Problem als Code
   * angegeben werden soll. Dieses Objekt kann einem ProblemConcernEntry hinzugefügt werden.
   *
   * @param kindOfAllergy <br>
   *        <div class="de"> kind of allergy</div> <div class="fr"></div> <div class="it"></div>
   * @param problem <div class="de">Code zu Komplikationsrisiken oder Expositionsrisiken.</div> <div
   *        class="fr"></div> <div class="it"></div>
   * @param startOfProblem <div class="de">Beginn des Problems</div> <div class="fr"></div> <div
   *        class="it"></div>
   * @param endOfProblem <div class="de">Ende des Problems</div> <div class="fr"></div> <div
   *        class="it"></div>
   */
   ...
   *
   * @param kindOfAllergy <br>
   *        <div class="de">Die Art der Allergie</div> <div class="fr"></div> <div class="it"></div>
   * @param problem <div class="de">Code zu Komplikationsrisiken oder Expositionsrisiken.</div> <div
   *        class="fr"></div> <div class="it"></div>
   * @param startOfProblem <div class="de">Beginn des Problems</div> <div class="fr"></div> <div
   *        class="it"></div>
   * @param endOfProblem <div class="de">Ende des Problems</div> <div class="fr"></div> <div
   *        class="it"></div>
   * @param internalProblemId <div class="de">Interne ID des Problems innerhalb der Akte. Steht eine
   *        solche nicht zur Verfügung dann kann ein anderer Konstruktor verwendet werden und es
   *        wird stattdesssen eine GUID durch die Convenience API generiert.</div> <div
   *        class="fr"></div> <div class="it"></div>
   */
  public AllergyProblem(AllergiesAndIntolerances kindOfAllergy,
      org.ehealth_connector.common.Code problem, Date startOfProblem, Date endOfProblem,
   ...
   *        <div class="de"> allergy intolerance</div> <div class="fr"></div> <div class="it"></div>
   */
  ...
  public org.ehealth_connector.common.Code getCode() {
    org.ehealth_connector.common.Code code =
        new org.ehealth_connector.common.Code(mAllergyProblem.getCode());
    return code;
  }
   ...
   *
   * @return das NotOccured Objekt. True, if the problem did not occur. false, otherwise.
   */
  ...
  public String getStart() {
    if (mAllergyProblem.getEffectiveTime() != null) {
      if (mAllergyProblem.getEffectiveTime().getLow() != null) {
        return Util.createEurDateStrFromTS(mAllergyProblem.getEffectiveTime().getLow().getValue());
      }
    }
    return null;
  }
   ...
   * </p>
   * <p>
   * If the value is uncoded, the convenience API will return the xml reference to the free text
   * description of the document for further processing.
   * </p>
   * 
  ...
  public void setEndOfProblem(Date endOfProblem) throws ParseException {
    mAllergyProblem.getEffectiveTime().setHigh(DateUtil.createIVXB_TSFromDate(endOfProblem));
  }
  ...
  public void setStart(Date startOfProblem) {
    ...
    try {
      mAllergyProblem.getEffectiveTime().setLow(DateUtil.createIVXB_TSFromDate(startOfProblem));
    }
    catch (ParseException e) {
      e.printStackTrace();
    }
