...
public enum RiscOfExposure {
	...
	*/
	BESCHÄFTIGTE_IM_GESUNDHEITSWESEN ("1", "Beschäftigte im Gesundheitswesen"),
	/** 
	*<div class="de">Enge Kontaktpersonen von Erkrankten</div>
	*<div class="fr">Personnes en contact étroit avec des malades</div>
	*/
	ENGE_KONTAKTPERSONEN_VON_ERKRANKTEN ("2", "Enge Kontaktpersonen von Erkrankten"),
	/** 
	...
	*/
	EXPONIERTE_TIERPFLEGER__HÄNDLER__SEUCHENPOLIZISTEN ("4", "Exponierte Tierpfleger, -händler, -seuchenpolizisten "),
	/** 
	...
	*/
	FAMILIENANGEHÖRIGE_VON_PERSONEN_MIT_EINEM_ERHÖHTEN_RISIKO ("5", "Familienangehörige von Personen mit einem erhöhten Risiko"),
	/** 
	...
	*/
	FLEDERMAUSFORSCHER_UND__SCHÜTZER ("6", "Fledermausforscher und -schützer"),
	/** 
	...
	*/
	HÄMODIALYSEPATIENTEN ("8", "Hämodialysepatienten"),
	/** 
	*<div class="de">Hämophile Personen</div>
	*<div class="fr">Personnes hémophiles</div>
	*/
	HÄMOPHILE_PERSONEN ("9", "Hämophile Personen"),
	/** 
	...
	*/
	KANALISATIONSARBEITER_UND_ANGESTELLTE_VON_KLÄRANLAGEN ("10", "Kanalisationsarbeiter und Angestellte von Kläranlagen"),
	/** 
	*<div class="de">Kinder aus Ländern mit mittlerer und hoher Endemizität, die in der Schweiz leben und für einen vorübergehenden Aufenthalt in ihr Herkunftsland zurückkehren</div>
	*<div class="fr">Enfants originaires de pays de moyenne et haute endémicité vivant en Suisse et retournant dans leurs pays pour des séjours temporaires</div>
	*/
	...
	*/
	MÄNNER_DIE_MIT_MÄNNERN_GESCHLECHTSVERKEHR_HABEN ("14", "Männer, die mit Männern Geschlechtsverkehr haben"),
	/** 
	*<div class="de">Patientinnen und Patienten in Pflegeheimen und in Einrichtungen für Personen mit chronischen Erkrankungen</div>
	*<div class="fr">Patients résidant dans une maison de soins ou dans un établissement pour malades chroniques</div>
	*/
	...
	*/
	PERSONEN_AUS_LÄNDERN_MIT_HOHER_ODER_INTERMEDIÄRER_HEPATITIS_B_ENDEMIZITÄT ("16", "Personen aus Ländern mit hoher oder intermediärer Hepatitis-B-Endemizität"),
	/** 
	...
	*/
	PERSONEN_MIT_EINER_SEXUELL_ÜBERTRAGBAREN_KRANKHEIT ("17", "Personen mit einer sexuell übertragbaren Krankheit"),
	/** 
	...
	*/
	PERSONEN_MIT_ENGEM_KONTAKT_ZU_PERSONEN_AUS_LÄNDERN_MIT_HOHER_ENDEMIZITÄT ("18", "Personen mit engem Kontakt zu Personen aus Ländern mit hoher Endemizität"),
	/** 
	...
	*/
	PERSONEN_MIT_HÄUFIG_WECHSELNDEN_SEXUALPARTNERN ("19", "Personen mit häufig wechselnden Sexualpartnern"),
	/** 
	*<div class="de">Personen mit regelmässigem Kontakt (beruflich/familiär) zu Säuglingen < 6 Monaten, schwangere Frauen</div>
	*<div class="fr">Personnes en contact professionnel ou familial régulier avec des nourrissons < 6 mois, femmes enceintes</div>
	*/
	PERSONEN_MIT_REGELMÄSSIGEM_KONTAKT_BERUFLICHFAMILIÄR_ZU_SÄUGLINGEN_kleiner_6_MONATEN_SCHWANGERE_FRAUEN ("20", "Personen mit regelmässigem Kontakt (beruflich/familiär) zu Säuglingen < 6 Monaten, schwangere Frauen"),
	/** 
	*<div class="de">Rekruten (Militär)</div>
	*<div class="fr">Recrues (militaires)</div>
	*/
	REKRUTEN_MILITÄR ("21", "Rekruten (Militär)"),
	/** 
	*<div class="de">Sozialarbeiter, Gefängnispersonal und Polizeiangestellte mit häufigem Kontakt zu Konsumenten von injizierbaren Drogen</div>
	*<div class="fr">Travailleurs sociaux, personnel des prisons et de la police en contact fréquent avec des consommateurs de drogues injectables</div>
	*/
	SOZIALARBEITER_GEFÄNGNISPERSONAL_UND_POLIZEIANGESTELLTE_MIT_HÄUFIGEM_KONTAKT_ZU_KONSUMENTEN_VON_INJIZIERBAREN_DROGEN ("22", "Sozialarbeiter, Gefängnispersonal und Polizeiangestellte mit häufigem Kontakt zu Konsumenten von injizierbaren Drogen"),
	/** 
	...
	*/
	TIERÄRZTE_INKL__STUDENTEN_PRAXISANGESTELLTE ("23", "Tierärzte (inkl. Studenten, Praxisangestellte)"),
	/** 
