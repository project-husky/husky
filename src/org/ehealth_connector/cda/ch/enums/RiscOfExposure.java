...
public enum RiscOfExposure {
	 ...
	 * d’animaux </div>
	 */
	EXPONIERTE_TIERPFLEGER__HÄNDLER__SEUCHENPOLIZISTEN("4",
			"Exponierte Tierpfleger, -händler, -seuchenpolizisten "),
	/**
	 ...
	 */
	FAMILIENANGEHÖRIGE_VON_PERSONEN_MIT_EINEM_ERHÖHTEN_RISIKO("5",
	 ...
	 */
	GEISTIG_BEHINDERTE_PERSONEN_IN_HEIMEN_UND_DEREN_BETREUERINNEN("7",
	 ...
	 * <div class="fr">Travailleurs des canalisations et des stations
	 * d’épuration</div>
	 */
	KANALISATIONSARBEITER_UND_ANGESTELLTE_VON_KLÄRANLAGEN("10",
	 ...
	 * et personnes à leur contact</div>
	 */
	KONSUMENTEN_VON_INJIZIERBAREN_DROGEN_UND_DEREN_KONTAKTPERSONEN("12",
	...
	/**
	 * <div class="de">Männer, die mit Männern Geschlechtsverkehr haben</div> <div
	 * class="fr">Hommes ayant des relations sexuelles avec d’autres hommes</div>
	 */
	MÄNNER_DIE_MIT_MÄNNERN_GESCHLECHTSVERKEHR_HABEN("14",
	 ...
	 */
	PERSONEN_AUS_LÄNDERN_MIT_HOHER_ODER_INTERMEDIÄRER_HEPATITIS_B_ENDEMIZITÄT("16",
	 ...
	 * transmissible</div>
	 */
	PERSONEN_MIT_EINER_SEXUELL_ÜBERTRAGBAREN_KRANKHEIT("17",
	 ...
	 */
	PERSONEN_MIT_ENGEM_KONTAKT_ZU_PERSONEN_AUS_LÄNDERN_MIT_HOHER_ENDEMIZITÄT("18",
	 ...
	 */
	PERSONEN_MIT_HÄUFIG_WECHSELNDEN_SEXUALPARTNERN("19",
	 ...
	 */
	PERSONEN_MIT_REGELMÄSSIGEM_KONTAKT_BERUFLICHFAMILIÄR_ZU_SÄUGLINGEN_kleiner_6_MONATEN_SCHWANGERE_FRAUEN(
			"20",
	 ...
	 * vétérinaires)</div>
	 */
	TIERÄRZTE_INKL__STUDENTEN_PRAXISANGESTELLTE("23",
