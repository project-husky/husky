...
public enum SectionsVACD {
  ...
  HISTORY_OF_PAST_ILLNESS(
      "11348-0", "hipi", "Bisherige Krankheiten", "Antécédants médicaux", "Storia medica", "History of Past Illness"), 
      ALLERGIES_REACTIONS("48765-2", "ar", "Allergien und Unverträglichkeiten", "Allergies et autres réactions indésirables",
      "Allergie e altre reazioni avverse", "Allergies and Other Adverse Reactions"), 
      ...
      "fr: TOTRANSLATE", "it: TOTRANSLATE", "Laboratory Specialty Section"), 
      HISTORY_OF_PREGNANCIES("10162-6", "hop", "Schwangerschaften", "Grossesses", "Gravidanze", "Pregnancy History"), 
      TREATMENT_PLAN("18776-5", "tp", "Impfplan", "fr: TOTRANSLATE",
      "it: TOTRANSLATE", "Immunization Recommendations"), 
