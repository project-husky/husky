...
public enum RiscOfComplications {
	 ...
	 * g)</div> <div class="fr">Prématurés (< 33 semaines ou poids à la
	 ...
	 * class="fr">Nouveau-nés et nourrissons < 12 mois originaires d’un pays à
	 * taux élevé de prévalence de la tuberculose et susceptibles d’y retourner
	 * (dans leur 1re année de vie)</div>
	 */
