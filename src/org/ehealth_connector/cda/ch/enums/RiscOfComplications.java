...
public enum RiscOfComplications {
	...
	/**
	 * <div class="de">Frühgeborene (&lt; 33 Wochen oder Geburtsgewicht &lt;
	 * 1500 g)</div> <div class="fr">Prématurés (&lt; 33 semaines ou poids à la
	 * naissance &lt; 1500 g)</div>
	 */
	 ...
	 * class="fr">Immunodéficiences de tous types (immunosuppression
	 * médicamenteuse, transplantation, maladies chroniques)</div>
	 */
	 ...
	 * class="fr">Immunodéficience congénitale (défaut de réponse aux
	 ...
	 * 40 )</div> <div class="fr">Maladies métaboliques chroniques affectant
	 * cœur, poumons, reins et/ou défenses immunitaires (diabète, obésité
	 * morbide IMC ? 40)</div>
	 */
	 ...
	 * class="fr">Nouveau-nés et nourrissons &lt; 12 mois originaires d’un pays
	 * à taux élevé de prévalence de la tuberculose et susceptibles d’y
	 * retourner (dans leur 1re année de vie)</div>
	 */
	 ...
	 */
	RiscOfComplications(String code, String displayName) {
		this.code = code;
