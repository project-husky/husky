...
public enum CodeSystems {
	...
	/**
	 * OID: 2.16.756.5.32 <div class="de">WHO ATC Code</div> <div class="fr">WHO
	 * ATC Code</div>
	 */
	 ...
	 */
	Komplikationsrisiken("2.16.756.5.30.1.127.3.3.2013.1",
	 ...
	 */
	HL7RouteOfAdministration("2.16.840.1.113883.5.112",
	 ...
	 */
	HL7ObservationInterpretation("2.16.840.1.113883.5.83",
	...
	// public String
	// getCodeSystem(org.ehealth_connector.cda.ch.enums.CodeSystems gln) {
	// switch (gln) {
