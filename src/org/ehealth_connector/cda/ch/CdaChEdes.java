...
public class CdaChEdes extends CdaCh {
	 ...
	 *
	 * @param doc
	 *            <div class="de">CdaChEdes</div> <div class="fr"></div>
	 */
	...
	// TODO Der Konstruktor sollte alle minimal benötigten Elemente enthalten
	// (also alle Sections), damit die Anwender wissen, was sie zuvor
	...
	public void addProblemConcern(
		...
		if (getDoc().getActiveProblemsSections() == null) {
			activeProblemsSection = IHEFactory.eINSTANCE
		...
		// set up the narrative (human-readable) text portion of the
		// ProblemConcern Section
		// section
		...
		org.openhealthtools.mdht.uml.cda.ihe.ProblemConcernEntry problemConcernEntryMdht = EcoreUtil
				.copy(problemConcern.copyMdhtProblemConcernEntry());
		activeProblemsSection.addAct(problemConcernEntryMdht);
	}

	public ProblemConcern getActiveProblemConcern(int leidenNr) {
		ProblemConcern problemConcernEntry = new ProblemConcern(
				(org.openhealthtools.mdht.uml.cda.ihe.ProblemConcernEntry) getDoc()
				.getActiveProblemsSections().get(0).getActs()
				.get(leidenNr));
	...
	public ArrayList<ProblemConcern> getProblemConcernEntries() {
		...
		org.openhealthtools.mdht.uml.cda.ihe.ActiveProblemsSection activeProblemsSection = (org.openhealthtools.mdht.uml.cda.ihe.ActiveProblemsSection) getDoc()
				.getSections().get(0);
		...
		for (Act act : activeProblemsSection.getActs()) {
			if (act instanceof org.openhealthtools.mdht.uml.cda.ihe.ProblemConcernEntry) {
				...
				System.out.println("List Item Code: "
						+ problemConcernEntry.getConcern());
			}
		}
