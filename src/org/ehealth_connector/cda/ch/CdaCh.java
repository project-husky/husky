...
import org.ehealth_connector.cda.ch.enums.EHealthConnectorVersions;
		...
		if (doc.getDataEnterer()!=null) {
			if (doc.getDataEnterer().getAssignedEntity()!=null) {
				if (doc.getDataEnterer().getAssignedEntity().getAssignedPerson()!=null) {
					org.ehealth_connector.common.Person person = new org.ehealth_connector.common.Person(doc.getDataEnterer().getAssignedEntity().getAssignedPerson());
					return person;
				}
			}
		}
