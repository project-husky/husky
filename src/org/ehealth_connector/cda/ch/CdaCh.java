...
public abstract class CdaCh {
  ...
  public CdaCh(CDACH doc) {
    ...
    FeatureMapUtil.addComment(docRoot.getMixed(), "Document based on CDA R2 generated by "+currentEhcVersion.getSystemVersionName()+", Release Date "+currentEhcVersion.getReleaseDate());
