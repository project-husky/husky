...
public class CdaChVacd extends CdaCh {
   ...
   *        lesbare Darstellung referenziert werden soll (z.B.
   *        '../../../../stylesheets/HL7.ch/CDA-CH/v1.2/cda-ch.xsl'). Bei Null wird das
   *        Standard-Stylesheet verwendet.
   * @param cascasingStylesheet Cascasing Stylesheet, welche Designinformationen für die menschlich
   *        lesbare Darstellung referenziert (z.B.
   *        '../../../../stylesheets/HL7.ch/CDA-CH/v1.2/cda-ch.xsl'). Bei Null werden keine
   *        zusätzlichen Designinformationen referenziert.
   */
  ...
  public LaboratoryObservation createLaboratoryObservation(SerologieForVACD serologieCode, Code laboratorySpecificCode, Date dateTimeOfResult, Performer performer, Value value, ObservationInterpretationForImmunization observationInterpretation) {
    LaboratoryObservation lo = createLaboratoryObservation(serologieCode, laboratorySpecificCode, dateTimeOfResult, performer, value);
   ...
   * 
   *
   * @eturn <div class="en"> the text of the human readable part of the cda document</div> <div
   *        class="de"> der text des menschlenlesbaren Teils des CDA-Dokuments</div>
   * 
   */
