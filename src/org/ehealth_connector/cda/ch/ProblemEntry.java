...
public class ProblemEntry extends MdhtFacade<org.openhealthtools.mdht.uml.cda.ihe.ProblemEntry> {
	 ...
	 * Instantiates a new problem entry.
	 */
	protected ProblemEntry(org.openhealthtools.mdht.uml.cda.ihe.ProblemEntry entry) {
		super(entry);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ProblemEntry)) {
			return false;
		}
		ProblemEntry other = (ProblemEntry) obj;

		Identificator id = this.getId();
