 ...
 * <div class="fr">Enum AddressUse.</div>\n
...
public enum AddressUse {
  ...
  /**
   * <div class="en">Gets the address use as telecommunication address use.</div>
   * <div class="de">Liefert address use as telecommunication address use.</div>
   *
   * @return <div class="en">the address use as telecommunication address use</div>
   */
