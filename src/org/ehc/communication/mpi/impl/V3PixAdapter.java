...
public class V3PixAdapter implements MpiAdapterInterface {
   ...
   * @see org.ehc.communication.mpi.MpiAdapterInterface#addPatient(org.ehc.
   ...
   * @param patient the patient
   * @return true, if successful
   * @see org.ehc.communication.mpi.MpiAdapterInterface#updatePatient(org.ehc.
   *      communication.mpi.FhirPatient)
   */
   ...
   * @return true, if successful
   * @see org.ehc.communication.mpi.MpiAdapterInterface#mergePatient(org.ehc.
   ...
   * @return the string[]
   * @see org.ehc.communication.mpi.MpiAdapterInterface#queryPatientId(org.ehc.
