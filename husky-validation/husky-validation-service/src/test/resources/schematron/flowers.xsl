...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Flowers</svrl:text>
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="title | shortdesc" priority="1005" mode="M1">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="title | shortdesc"/>
      <!--REPORT info-->
      <xsl:if test="b">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="b">
            <xsl:attribute name="role">info</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text> Bold is not allowed in <xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/>
        element.</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="ul" priority="1004" mode="M1">
   ...
   <!--RULE -->
   <xsl:template match="li" priority="1003" mode="M1">
   ...
   <!--RULE -->
   <xsl:template match="xref[@scope = 'external']" priority="1002" mode="M1">
   ...
   <!--RULE -->
   <xsl:template match="table" priority="1001" mode="M1">
   ...
   <!--RULE -->
   <xsl:template match="text()" priority="1000" mode="M1">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="text()"/>
      <!--REPORT info-->
