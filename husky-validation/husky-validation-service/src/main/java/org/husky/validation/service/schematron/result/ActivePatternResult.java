...
import org.husky.validation.service.schematron.bind.LangTextType;
...
public class ActivePatternResult {
	...
	public static String getLangText(
			org.husky.validation.service.schematron.bind.Text text, LanguageCode lang) {
	 ...
	 */
	public static String getLangText(
			org.husky.validation.service.schematron.bind.Text text,
