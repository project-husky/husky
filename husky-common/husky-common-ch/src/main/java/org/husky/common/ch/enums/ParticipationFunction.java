...
public enum ParticipationFunction implements ValueSetEnumInterface {
     ...
     */
    @Nullable
    public static ParticipationFunction getEnum(@Nullable final String code) {
     ...
     */
    ParticipationFunction(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
