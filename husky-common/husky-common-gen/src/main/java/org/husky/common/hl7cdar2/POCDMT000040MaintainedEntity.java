...
@XmlType(name = "POCD_MT000040.MaintainedEntity", propOrder = { "realmCode", "typeId", "templateId",
		"effectiveTime", "maintainingPerson" })
public class POCDMT000040MaintainedEntity {
	...
	/**
	 * Ruft den Wert der maintainingPerson-Eigenschaft ab.
	 *
	...
	/**
	 * Legt den Wert der maintainingPerson-Eigenschaft fest.
	 *
	 * @param value
