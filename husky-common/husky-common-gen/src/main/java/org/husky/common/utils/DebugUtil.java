...
public class DebugUtil {
    ...
    /**
     * Creates a debug string for the given list of codes (for debugging purposes only!)
     *
     * @param data the list of codes
     * @return the debug string <div class="en"></div> <div class="de"></div>
     * <div class="fr"></div>
     */
     ...
     *
     * @param docEntry <div class="en">the document metadata</div>
    ...
    /**
     * Creates a debug string for the given localized string (for debugging purposes only!)
     *
