...
public class NameBaseType implements Serializable {
    ...
    /**
     * Gets the name delimiter. A delimiter has no meaning other than being literally printed in this name
    ...
    /**
     * Sets the name delimiter. A delimiter has no meaning other than being literally printed in this name
     * representation. A delimiter has no implicit leading and trailing white space.
     *
    ...
    /**
     * Gets the family name. This is the name that links to the genealogy. In some cultures (e.g. Eritrea) the family
    ...
    /**
     * Sets the family name. This is the name that links to the genealogy. In some cultures (e.g. Eritrea) the family
     * name of a son is the first name of his father.
     *
    ...
    /**
     * Gets the whole name. By default, it gets assembled by the different name parts, but if there are none, you may
     * also set this directly.
     *
     * @return the name
     */
