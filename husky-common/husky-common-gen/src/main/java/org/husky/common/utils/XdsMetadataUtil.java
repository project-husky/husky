...
public class XdsMetadataUtil {
    ...
    /**
     * Method to convert the DTM string to a Date object. The String will be parsed using the formats int the following
     * definition and order: yyyyMMddHHmmss yyyyMMddHHmm yyyyMMddHH yyyyMMdd yyyyMM yyyy";
     *
    ...
    public static Author convertIpfAuthor(org.openehealth.ipf.commons.ihe.xds.core.metadata.Author at) {
        ...
        if (at != null) {
            ...
            // Role
            Code role = null;
			if (at.getAuthorRole() != null && !at.getAuthorRole().isEmpty() && at.getAuthorRole().get(0) != null) {
