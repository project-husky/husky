...
@XmlType(name = "POCD_MT000040.Authorization", propOrder = { "realmCode", "typeId", "templateId",
		"consent" })
public class POCDMT000040Authorization {
	...
	/**
	 * Ruft den Wert der consent-Eigenschaft ab.
	 *
	...
	/**
	 * Legt den Wert der consent-Eigenschaft fest.
	 *
	 * @param value
