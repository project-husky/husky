...
@XmlType(name = "POCD_MT000040.DocumentationOf", propOrder = { "realmCode", "typeId", "templateId",
        "serviceEvent" })
public class POCDMT000040DocumentationOf {
    ...
    /**
     * Ruft den Wert der serviceEvent-Eigenschaft ab.
     *
    ...
    /**
     * Legt den Wert der serviceEvent-Eigenschaft fest.
     *
     * @param value
