...
public class IdentificatorBaseType implements Serializable {
	...
	/**
	 * Sets the assigning authority name. See getter
	 * {@link IdentificatorBaseType#getAssigningAuthorityName} for more details.
	 *
	...
	/**
	 * Gets the extension. A character string as a unique identifier within the
	...
	/**
	 * Sets the extension. See getter {@link IdentificatorBaseType#getExtension} for
	 * more details.
	 *
	...
	/**
	 * Gets the OID or UUID of the domain. A unique identifier that guarantees the
	 * global uniqueness of the instance identifier. The root alone may be the
	 * entire instance identifier (e.g. UUID without further definition by the
	 * extension).
	 *
	 * @return the root
	 */
	...
	/**
	 * Sets the root. See getter {@link IdentificatorBaseType#getRoot} for more
	 * details.
	 *
	...
	/**
	 * Checks if is displayable. Specifies if the identifier is intended for human
	...
	/**
	 * Sets the displayable flag. See getter
	 * {@link IdentificatorBaseType#isDisplayable} for more details.
	 *
