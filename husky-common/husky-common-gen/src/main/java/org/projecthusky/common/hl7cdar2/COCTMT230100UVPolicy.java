...
@XmlType(name = "COCT_MT230100UV.Policy", namespace = "urn:ihe:pharm", propOrder = {"realmCode",
        "typeId", "templateId", "code", "text"})
public class COCTMT230100UVPolicy {
     ...
     *
     * @return possible object is {@link ActMoodDefinition }
     */
     ...
     *
     * @param value allowed object is {@link ActMoodDefinition }
     */
