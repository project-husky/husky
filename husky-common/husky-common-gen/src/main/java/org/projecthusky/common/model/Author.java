...
public class Author {
    ...
    public Author(boolean nullFlavored) {
        ...
        mAuthor.getNullFlavor().add(org.projecthusky.common.enums.NullFlavor.NOT_APPLICABLE_L1_CODE);
        mAuthor.getAssignedAuthor().getNullFlavor()
                .add(org.projecthusky.common.enums.NullFlavor.NOT_APPLICABLE_L1_CODE);
        final var ii = new II();
        ii.getNullFlavor().add(org.projecthusky.common.enums.NullFlavor.NOT_APPLICABLE_L1_CODE);
        mAuthor.getAssignedAuthor().getId().add(ii);
        final var tsTime = new TS();
        tsTime.getNullFlavor().add(org.projecthusky.common.enums.NullFlavor.NOT_APPLICABLE_L1_CODE);
     ...
     */
    public Author(org.projecthusky.common.model.Organization organizationAsAuthor) {
        mAuthor = new POCDMT000040Author();
    ...
    public Author(Patient patientAsAuthor) {
		...
		if (!patientAsAuthor.getHl7CdaPerson().getName().isEmpty()) {
            for (final org.projecthusky.common.model.Name name : patientAsAuthor.getNames()) {
