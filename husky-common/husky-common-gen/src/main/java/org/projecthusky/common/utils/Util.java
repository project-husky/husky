...
public class Util {
	 ...
	 */
	public static List<Identificator> convertIds(List<org.projecthusky.common.hl7cdar2.II> mII) {
		final List<Identificator> il = new ArrayList<>();
		for (final org.projecthusky.common.hl7cdar2.II mId : mII) {
	 ...
	 */
	public static POCDMT000040Authenticator createAuthenticatorFromAuthor(org.projecthusky.common.model.Author author) {
	...
	public static POCDMT000040LegalAuthenticator createLegalAuthenticatorFromAuthor(
			org.projecthusky.common.model.Author author) {
		final POCDMT000040Author a = author.getAuthorMdht();
	 ...
	 * @return the pn
	 */
	public static PN createPnFromOn(org.projecthusky.common.hl7cdar2.ON on) {
		final var pn = new org.projecthusky.common.hl7cdar2.PN();
