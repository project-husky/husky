 ...
 *
 */
package org.projecthusky.fhir.emed.ch.pmp.model.entry.padv;
...
import org.projecthusky.fhir.emed.ch.pmp.model.entry.EmedPadvEntryDigest;

import java.time.Instant;
import java.util.UUID;

/**
 * Represents the digest of an EMED PADV document Cancel item entry.
 *
 * @author Quentin Ligier
 */
public class EmedPadvCancelEntryDigest extends EmedPadvEntryDigest {
     ...
     */
    public EmedPadvCancelEntryDigest(final Instant pharmaceuticalAdviceTime,
