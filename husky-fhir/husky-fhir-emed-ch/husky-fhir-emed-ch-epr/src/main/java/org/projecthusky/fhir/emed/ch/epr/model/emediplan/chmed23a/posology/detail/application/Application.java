package org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.application;
...
public abstract class Application implements EMediplanObject {
    ...
    @Override
    public boolean hasExtensions(final boolean inDepth) {
        return inDepth && dose.hasExtensions(true);
    }
}
