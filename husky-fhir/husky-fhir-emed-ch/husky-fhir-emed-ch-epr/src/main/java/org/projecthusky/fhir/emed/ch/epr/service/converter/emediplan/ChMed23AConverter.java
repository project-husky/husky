...
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.*;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.enums.*;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.ChMed23APosology;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.CyclicDosage;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.DailyDosage;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.FreeTextDosage;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.SingleDosage;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.application.ApplicationInSegment;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.dose.EMediplanDose;
import org.projecthusky.fhir.emed.ch.epr.model.emediplan.chmed23a.posology.detail.dose.RangeDose;
 ...
 * <a href="https://github.com/ig-emediplan/specification/tree/main/chmed23a">CHMED23A specifications</a>.
 */
@Slf4j
public non-sealed class ChMed23AConverter implements EMediplanConverter {
    ...
    public ChMed23AEMediplan toEMediplan(final ChEmedEprDocumentPmlc pmlc) {
        final ChMed23AEMediplan emediplan = new ChMed23AEMediplan();

        emediplan.setPatient(ChMed23APatient.fromEprFhir(
                pmlc.resolvePatient(),
        ...
        if (emediplan.getPatient().getLanguageCode() == null || emediplan.getPatient().getLanguageCode().isBlank())
            emediplan.getPatient().setLanguageCode(
                    ChMed23APatient.fhirLanguageCodeToEMediplanLanguageCode(pmlc.resolveComposition().getLanguage()
                    )
            );
    ...
    /**
     * Converts the received PRE document to an eMediplan object according to the
     * <a href="https://github.com/ig-emediplan/specification/tree/main/chmed23a">CHMED23A specifications</a>.
     *
    ...
    protected ChMed23AMedicament toMedicament(final ChEmedEprMedicationStatementPmlc statement) {
        final var medicament = new ChMed23AMedicament();
     ...
     * to an {@link ChMed23APosology} object.
     *
     ...
     */
    protected ChMed23APosology toPosology(final ChEmedEprDosage baseDosage,
                                                 List<@NonNull ChEmedEprDosage> additionalDosages,
                                                 boolean setUnitIfAbsent
                                                  ) {
        boolean freeTextDosage = false;
        final var posology = new ChMed23APosology();
