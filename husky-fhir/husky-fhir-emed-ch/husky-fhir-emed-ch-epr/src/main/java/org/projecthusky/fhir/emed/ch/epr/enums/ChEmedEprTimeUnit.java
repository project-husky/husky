...
public enum ChEmedEprTimeUnit implements ValueSetEnumInterface {
     ...
     */
    @Nullable
    public static ChEmedEprTimeUnit getEnum(@Nullable final String code) {
        for (final ChEmedEprTimeUnit x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ChEmedEprTimeUnit.class,
                         enumName);
            return true;
     ...
     */
    ChEmedEprTimeUnit(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
