...
class CodeBaseTypeTest {
    ...
    void doAllTests() {
        ...
        org.ehealth_connector.common.basetypes.CodeBaseType codeBaseType1 = org.ehealth_connector.common.basetypes.CodeBaseType.builder().withCode(code)
        ...
        org.ehealth_connector.common.basetypes.CodeBaseType codeBaseTypeA = org.ehealth_connector.common.basetypes.CodeBaseType.builder().withCode(code)
                .withCodeSystem(codeSystem).withCodeSystemName(codeSystemName)
                .withCodeSystemVersion(codeSystemVersion).withDisplayName(displayName)
                .withOriginalText(originalText).build();
        ...
        org.ehealth_connector.common.basetypes.CodeBaseType codeBaseType2 = org.ehealth_connector.common.basetypes.CodeBaseType.builder().withCode(code2)
        ...
        org.ehealth_connector.common.basetypes.CodeBaseType codeBaseType3 = org.ehealth_connector.common.basetypes.CodeBaseType.builder().withCode(code3)
