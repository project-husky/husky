...
class CodeTest {
    ...
    void doAllTests() {
        ...
        org.ehealth_connector.common.Code code1 = new org.ehealth_connector.common.Code(codeBt);
        CD hl7CdaR2Type = code1.getHl7CdaR2Cd();
        org.ehealth_connector.common.Code code2 = new org.ehealth_connector.common.Code(hl7CdaR2Type);

        assertTrue(code1.equals(code2));

        // Null Flavor Tests
        CD nullHl7CdaR2Value = null;
        org.ehealth_connector.common.Code nullObj = new org.ehealth_connector.common.Code(nullHl7CdaR2Value);
