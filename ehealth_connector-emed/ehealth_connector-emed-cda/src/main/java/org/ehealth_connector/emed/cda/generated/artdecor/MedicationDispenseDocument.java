...
public class MedicationDispenseDocument extends POCDMT000040ClinicalDocument {

    public MedicationDispenseDocument() {
        ...
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.3.6.1.4.1.19376.1.9.1.1.3"));
        super.getTemplateId().add(createHl7TemplateIdFixedValue("2.16.756.5.30.1.1.10.1.5"));
