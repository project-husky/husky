...
import org.ehealth_connector.emed.cda.generated.hl7cdar2.ANY;
...
public class IhehealthStatusObservation extends POCDMT000040Observation {
     ...
     */
    private static org.ehealth_connector.emed.cda.generated.hl7cdar2.CE createHl7ValueFixedValue() {
        ObjectFactory factory = new ObjectFactory();
     ...
     * The &lt;value&gt; element contains the health status. It is always represented using the CE datatype (xsi:type='CE'). It shall contain a code from the following set of values from SNOMED CT.
     */
    public void setHl7Value(org.ehealth_connector.emed.cda.generated.hl7cdar2.CE value) {
        getValue().clear();
        getValue().add(value);
    }
}
