...
public class CdachOtherAddressInformationCompilationECh0010 {
     ...
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP additionalLocator;
     ...
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP city;

    /**
     * Two-digit, alphanumeric ISO country code according to [ISO 3166-1] of the country in which the address is located. The country defines the conventions for addressing.The country code MUST also be declared for Swiss postal addresses.Caution: Political changes or renaming of countries will result in adjustments to the ISO country list.The length of the feature is 2 characters.
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP country;

    /**
     * House number in postal addresses (including house number additives). With a maximum length of 30 characters.
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP houseNumber;

    /**
     * Number of the addressed post box in a maximum length of 8 characters.
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP postBox;
     ...
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP postalCode;
     ...
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP state;
     ...
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP streetAddressLine;
     ...
     */
    @XmlTransient()
    private org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP streetName;

    /**
     * Gets the hl7AdditionalLocator
     * Number of addressed apartment. This is occasionally necessary for larger buildings. With a maximum length of 30 characters.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7AdditionalLocator() {
     ...
     * Addressed city (in foreign addresses if necessary including province, etc.).When using the information according to the Swiss Post, the 27-digit city name must be used.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7City() {
        return city;
    }
     ...
     * Two-digit, alphanumeric ISO country code according to [ISO 3166-1] of the country in which the address is located. The country defines the conventions for addressing.The country code MUST also be declared for Swiss postal addresses.Caution: Political changes or renaming of countries will result in adjustments to the ISO country list.The length of the feature is 2 characters.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7Country() {
        return country;
    }
     ...
     * House number in postal addresses (including house number additives). With a maximum length of 30 characters.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7HouseNumber() {
        return houseNumber;
    }
     ...
     * Number of the addressed post box in a maximum length of 8 characters.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7PostBox() {
        return postBox;
    }
     ...
     * Postal code given by Swiss Post or postal code issued by a post office abroad, that can consist of numbers, letters or a combination of both, possibly even special characters.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7PostalCode() {
        return postalCode;
    }
     ...
     * Occasionally, additional geographic information must be provided in foreign addresses, in addition to city and country. This element can be used for such cases.It contains superordinate or subordinate information on a city, such as region, province, state or local district.Since it is difficult - especially with foreign addresses - to determine whether an indication is subordinate or subordinate, a separate mapping of superordinate and subordinate indication is omitted.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7State() {
        return state;
    }
     ...
     * Free additional lines for additional address information which can not be used in the other address fields (e.g. for c/o entries, etc.), with a maximum length of 150 characters.addressLine1 should be used for personalized addressing (e.g., c/o-Address).
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7StreetAddressLine() {
     ...
     * Street names in postal addresses. It can also be the name of a locality, a hamlet, etc. With a maximum length of 150 characters.
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP getHl7StreetName() {
        return streetName;
    }
     ...
     * Number of addressed apartment. This is occasionally necessary for larger buildings. With a maximum length of 30 characters.
     */
    public void setHl7AdditionalLocator(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
     ...
     * Addressed city (in foreign addresses if necessary including province, etc.).When using the information according to the Swiss Post, the 27-digit city name must be used.
     */
    public void setHl7City(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
        this.city = value;
    }
     ...
     * Two-digit, alphanumeric ISO country code according to [ISO 3166-1] of the country in which the address is located. The country defines the conventions for addressing.The country code MUST also be declared for Swiss postal addresses.Caution: Political changes or renaming of countries will result in adjustments to the ISO country list.The length of the feature is 2 characters.
     */
    public void setHl7Country(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
        this.country = value;
    }
     ...
     * House number in postal addresses (including house number additives). With a maximum length of 30 characters.
     */
    public void setHl7HouseNumber(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
     ...
     * Number of the addressed post box in a maximum length of 8 characters.
     */
    public void setHl7PostBox(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
        this.postBox = value;
    }
     ...
     * Postal code given by Swiss Post or postal code issued by a post office abroad, that can consist of numbers, letters or a combination of both, possibly even special characters.
     */
    public void setHl7PostalCode(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
     ...
     * Occasionally, additional geographic information must be provided in foreign addresses, in addition to city and country. This element can be used for such cases.It contains superordinate or subordinate information on a city, such as region, province, state or local district.Since it is difficult - especially with foreign addresses - to determine whether an indication is subordinate or subordinate, a separate mapping of superordinate and subordinate indication is omitted.
     */
    public void setHl7State(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
        this.state = value;
    }
     ...
     * Free additional lines for additional address information which can not be used in the other address fields (e.g. for c/o entries, etc.), with a maximum length of 150 characters.addressLine1 should be used for personalized addressing (e.g., c/o-Address).
     */
    public void setHl7StreetAddressLine(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
     ...
     * Street names in postal addresses. It can also be the name of a locality, a hamlet, etc. With a maximum length of 150 characters.
     */
    public void setHl7StreetName(org.ehealth_connector.emed.cda.generated.hl7cdar2.ADXP value) {
