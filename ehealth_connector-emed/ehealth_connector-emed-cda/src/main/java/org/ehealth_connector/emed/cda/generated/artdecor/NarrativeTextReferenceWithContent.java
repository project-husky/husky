...
import org.ehealth_connector.emed.cda.generated.hl7cdar2.ED;
...
public class NarrativeTextReferenceWithContent extends ED {
     ...
     */
    public org.ehealth_connector.emed.cda.generated.hl7cdar2.TEL getHl7Reference() {
        return reference;
    }
     ...
     * The reference to the corresponding text in the human readable part must be specified by reference to content[@ID]: reference[@value='#xxx']<span style="white-space:pre"/><br clear="none"/>
     */
    public void setHl7Reference(org.ehealth_connector.emed.cda.generated.hl7cdar2.TEL value) {
