...
import static org.projecthusky.xua.validation.ChEprAssertionValidationParameters.CH_EPR_ROLE;
...
class ChEprAudienceRestrictionConditionValidatorTest {
	 ...
	 */
	/*
	 * simple test function to compare results for various roles, no use
	 * reducing complexity
	 */
	@Test
	...
	private AudienceRestriction unmarshal(final String xml) throws Exception {
		final var bytes = ("<saml2:AudienceRestriction xmlns:saml2=\"urn:oasis:names:tc:SAML:2.0:assertion\">"
				+ xml + "</saml2:AudienceRestriction>").getBytes(StandardCharsets.UTF_8);
