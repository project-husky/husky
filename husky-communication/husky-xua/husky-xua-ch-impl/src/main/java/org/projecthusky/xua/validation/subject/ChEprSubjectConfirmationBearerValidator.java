...
import static org.projecthusky.xua.communication.xua.XUserAssertionConstants.OASIS_XACML_SUBJECTID;
import static org.projecthusky.xua.validation.ChEprAssertionValidationParameters.*;

/**
 * Validator that confirms the {@link org.opensaml.saml.saml2.core.Subject} of the issuer by evaluating the
 * {@link SubjectConfirmation}s within that subject.
 *
...
public class ChEprSubjectConfirmationBearerValidator implements SubjectConfirmationValidator {
     ...
     * @implNote The context validation failure message is lost in
     * {@link org.opensaml.saml.saml2.assertion.SAML20AssertionValidator}, it's useless to set it here.
     */
