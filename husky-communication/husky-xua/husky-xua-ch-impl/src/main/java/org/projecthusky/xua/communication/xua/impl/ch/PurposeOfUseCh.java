...
public interface PurposeOfUseCh {
	...
	private static CE createPurposeOfUse(org.projecthusky.communication.ch.enums.stable.PurposeOfUse code) {
	...
	public static CE auto() {
		return createPurposeOfUse(org.projecthusky.communication.ch.enums.stable.PurposeOfUse.AUTOMATIC_UPLOAD);
	}
	...
	public static CE emer() {
		return createPurposeOfUse(org.projecthusky.communication.ch.enums.stable.PurposeOfUse.EMERGENCY_ACCESS);
	}
	...
	public static CE norm() {
		return createPurposeOfUse(org.projecthusky.communication.ch.enums.stable.PurposeOfUse.NORMAL_ACCESS);
	}
