 ...
 */
package org.projecthusky.communication.responses;
...
/**
 * Baseclass for XML responses from the webservice. Essentially a copy of the {@link V3Response} and it was not reworked yet.
 * @author szalai
 */
public class BaseResponse {
	...
	protected List<String> receivingApplication = new ArrayList<>(0);
	protected List<String> receivingFacility = new ArrayList<>(0);
