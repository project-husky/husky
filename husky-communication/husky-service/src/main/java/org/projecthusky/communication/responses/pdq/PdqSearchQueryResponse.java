 ...
 */
package org.projecthusky.communication.responses.pdq;
...
/**
 * Response class that contains all XML elements which are needed for a SearchQuery response coming from the webservice and allows the setting of their values.<br/>
 * Moslty a copy of the {@link V3PdqConsumerResponse} and was not reworked.
 * @author szalai
 */
public class PdqSearchQueryResponse extends BaseResponse {
	 ...
	 */
	public PdqSearchQueryResponse(PRPAIN201306UV02Type pdqConsumerResponseElement) {
