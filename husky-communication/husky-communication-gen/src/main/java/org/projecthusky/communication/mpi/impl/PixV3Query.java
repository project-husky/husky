...
public class PixV3Query extends PixPdqV3QueryBase {
     ...
     *                              assertion
     * @param messageId             a id preset or null, if the id shall be generated
     *
    ...
    public List<String> queryPatientId(org.projecthusky.fhir.structures.gen.FhirPatient patient,
        ...
        // read the data source OIDs from method arguments or use the OIDs set in the constructor
        ...
        try {
            ...
            // TODO: this should throw an exception and not just an empty result set
            return domainToReturnOids;
        }
    ...
    private PixV3QueryResponse sendQuery(PixV3QueryRequest request, SecurityHeaderElement assertion, URI pdqDest,
		...
		final String endpoint = HuskyUtils.createEndpoint(HuskyUtils.PIXV3_ITI45, pdqDest, true,
