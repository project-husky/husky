...
class CHPixV3QueryTest {
	...
	// the Swiss unique patient identifier (required when requesting X-User Assertions)
	...
	final String communityPatientId = "IHE-12361761818786818818"; // adjust to value from community PIX Manager
