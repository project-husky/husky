...
public class DocumentMetadataTest extends TestUtils {
  ...
  public void testClassCode() {  
    d.setClassCode(new Code("1.3.6.1.4.1.21367.100.1", "DEMO-Consult", "Consultation")); //Just for the NIST-Repository: This code should also be optional, but the NIST repository prevents an automatic derivation from the typeCode
  ...
  public void testFormatCode() {  
    d.setFormatCode(new Code("1.3.6.1.4.1.19376.1.2.3", "urn:ihe:iti:xds-sd:pdf:2008", "1.3.6.1.4.1.19376.1.2.20 (Scanned Document)")); //Can be extracted from CDA   
  ...
  public void testHealthcareFacilityTypeCode() {  
    d.setHealthcareFacilityTypeCode(new Code("2.16.840.1.113883.5.11","AMB","Ambulance")); //The codes here are specific for the affinity domain
  ...
  public void testPatientId() {   
    d.setPatientId(new Identificator("1.3.6.1.4.1.21367.2005.13.20.3000", "b8a9a9ad17b5429")); //Can be extracted from CDA
  ...
  public void testPracticeSettingCode() {  
    d.setPracticeSettingCode(new Code("2.16.840.1.113883.6.96","394802001","General Medicine")); //The codes here are specific for the affinity domain
  ...
  public void testTypeCode() {  
    d.setTypeCode(new Code("2.16.840.1.113883.6.1", "34133-9", "Summarization of Episode Note")); //Can be extracted from CDA
