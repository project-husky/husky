...
public class XdsTestUtils {
	...
	public XdsTestUtils() {
		...
		try {
			dateTimeRange1 = new DateTimeRange(DocumentEntryConstants.CREATION_TIME,
					"201401012300", "201412310400");
			dateTimeRange2 = new DateTimeRange(DocumentEntryConstants.CREATION_TIME,
					"201501012300", "201502010400");
