...
public class FhirPatientTests {
	...
	private Organization getScopingOrganization() {
		return this.getScopingOrganization("2.16.840.1.113883.3.72.5.9.2",
				"OHT", null);
	}

	private Organization getScopingOrganization(String oid, String name,
			String tel) {
	...
	public void testConveniencePatient() {
		...
		assertEquals("2.16.840.1.113883.3.72.5.9.1", patient.getIds().get(0)
				.getRoot());
		...
		org.openhealthtools.mdht.uml.hl7.datatypes.II ii = patient
				.getMdhtPatientRole().getProviderOrganization().getIds().get(0);
		...
		assertEquals("2.16.840.1.113883.3.72.5.9.1", patientEquals.getIds()
				.get(0).getRoot());
		...
		ii = patientEquals.getMdhtPatientRole().getProviderOrganization()
				.getIds().get(0);
		assertEquals("2.16.840.1.113883.3.72.5.9.2", ii.getRoot());
	}
	...
	public void testConveniencePatientOrganization() {
		...
		Patient patient = fhirPatient.getPatient();
		assertEquals("Test", patient.getMdhtPatientRole()
				.getProviderOrganization().getNames().get(0).getText());
		assertEquals("1234", patient.getMdhtPatientRole()
				.getProviderOrganization().getIds().get(0).getRoot());
		assertEquals("tel:+417600000000", patient.getMdhtPatientRole()
				.getProviderOrganization().getTelecoms().get(0).getValue());
	...
	public void testConveniencePatientTelecom() {
		...
		assertEquals(ContactPointUseEnum.HOME, fhirPatient2.getTelecom().get(0)
				.getUseElement().getValueAsEnum());
		assertEquals(ContactPointSystemEnum.PHONE, fhirPatient2.getTelecom()
				.get(0).getSystemElement().getValueAsEnum());
		assertEquals("+4144000000000", fhirPatient2.getTelecom().get(0)
				.getValue());

		assertEquals(ContactPointUseEnum.WORK, fhirPatient2.getTelecom().get(1)
				.getUseElement().getValueAsEnum());
		assertEquals(ContactPointSystemEnum.PHONE, fhirPatient2.getTelecom()
				.get(1).getSystemElement().getValueAsEnum());
		assertEquals("+4188000000000", fhirPatient2.getTelecom().get(1)
				.getValue());

		assertEquals(ContactPointUseEnum.MOBILE,
				fhirPatient2.getTelecom().get(2).getUseElement()
						.getValueAsEnum());
		assertEquals(ContactPointSystemEnum.PHONE, fhirPatient2.getTelecom()
				.get(2).getSystemElement().getValueAsEnum());
		assertEquals("+4176000000000", fhirPatient2.getTelecom().get(2)
				.getValue());

		assertEquals(ContactPointUseEnum.WORK, fhirPatient2.getTelecom().get(3)
				.getUseElement().getValueAsEnum());
		assertEquals(ContactPointSystemEnum.EMAIL, fhirPatient2.getTelecom()
				.get(3).getSystemElement().getValueAsEnum());
	...
	public void testFhirSerializeDeserialize() {
		...
		FhirPatient fhirPatientDeserialized = parser.parseResource(
				FhirPatient.class, stringPatient);
