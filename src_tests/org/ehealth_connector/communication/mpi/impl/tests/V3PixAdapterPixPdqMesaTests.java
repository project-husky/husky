 ...
 * 
 * Mesa Tools require Java6 as a base, to run it locally in a docker containter
 * make the following steps
 * 
 * unzip mesatools pixpdq.zip to a directory /hostdirectory
 * 
 * docker pull dockerfile/java docker run -it -p 8100:8080 -v
 * ~/hostdirectory:/pixdq dockerfile/java:oracle-java6 in docker container cd
 * /pipxdq chmod +x start.cmd ./start.cmd on host if maxos
 * 
 ...
 * 
 * This tools is used to valisate pix/pdq actors againts IHE TF from october
 * 2008. The services with instructions are accessible from
 * http://<serverAdr>:<port>/mesa/test.
 * 
 * Please use firefox. IE also works but messages are not displayed in
 * real-time.
 * 
