...
public class Performer {
	...
	public Performer(Author author) {
		...
		for (org.ehealth_connector.common.model.Identificator id : author.getIds()) {
	 ...
	 */
	public Performer(org.ehealth_connector.common.model.Organization organization) {
		mPerfomer = new POCDMT000040Performer2();
		mAsEntity = new POCDMT000040AssignedEntity();
		mPerfomer.setAssignedEntity(mAsEntity);
		...
		for (IdentificatorBaseType idBaseType : organization.getIdentificatorList()) {
			if (idBaseType != null) {
				mAsEntity.getId().add(new org.ehealth_connector.common.model.Identificator(idBaseType).getHl7CdaR2Ii());
			}
		}
	 ...
	 *            Domäne
	 */
	public void addId(org.ehealth_connector.common.model.Identificator identificator) {
	 ...
	 */
	public org.ehealth_connector.common.model.Identificator getGlnAsIdentificator() {
		final var ii = mAsEntity.getId().get(0);
		return new org.ehealth_connector.common.model.Identificator(ii);
	}
	 ...
	 */
	public List<org.ehealth_connector.common.model.Identificator> getIds() {
	...
	public void setGln(String gln) {
		addId(new org.ehealth_connector.common.model.Identificator(CodeSystems.GLN.getCodeSystemId(), gln));
	}
	 ...
	 *            <div class="it"></div>
	 */
	public void setOrganization(org.ehealth_connector.common.model.Organization organization) {
