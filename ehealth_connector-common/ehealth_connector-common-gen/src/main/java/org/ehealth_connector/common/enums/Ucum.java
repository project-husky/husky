...
public enum Ucum {
	...
	Descriptive("Code",
			"Descriptive Name"), /**
									 * <div class="en">Percent [Most Common
	...
	Per100("/100",
			"Per100 [Entitic Number Units]"), /**
												 * <div
												 * class="en">Per100Spermatozoa
												 * [Entitic Number Units]</div>
												 */
	...
	Inch("[in_i]",
			"Inch [English Length Units]"), /**
											 * <div class="en">Feet [English
											 * Length Units]</div>
											 */
	Feet("[ft_i]",
			"Feet [English Length Units]"), /**
											 * <div class="en">Yard [English
											 * Length Units]</div>
											 */
	Yard("[yd_i]",
			"Yard [English Length Units]"), /**
											 * <div class="en">Fathom [English
											 * Length Units]</div>
											 */
	Fathom("[fth_i]",
			"Fathom [English Length Units]"), /**
												 * <div class="en">StatuteMile
												 * [English Length Units]</div>
												 */
	StatuteMile("[mi_i]",
			"StatuteMile [English Length Units]"), /**
													 * <div
													 * class="en">NauticalMile
													 * [English Length
													 * Units]</div>
													 */
	NauticalMile("[nmi_i]",
	...
	French("[Ch]",
			"French [English Length Units]"), /**
												 * <div class="en">FemtoMeter
												 * [SI Length Units]</div>
												 */
	FemtoMeter("fm",
			"FemtoMeter [SI Length Units]"), /**
												 * <div class="en">PicoMeter [SI
												 * Length Units]</div>
												 */
	PicoMeter("pm", "PicoMeter [SI Length Units]"), /**
													 * <div class="en">NanoMeter
													 * [SI Length Units]</div>
													 */
	NanoMeter("nm",
			"NanoMeter [SI Length Units]"), /**
											 * <div class="en">MicroMeter [SI
											 * Length Units]</div>
											 */
	MicroMeter("um",
			"MicroMeter [SI Length Units]"), /**
												 * <div class="en">MilliMeter
												 * [SI Length Units]</div>
												 */
	MilliMeter("mm",
			"MilliMeter [SI Length Units]"), /**
												 * <div class="en">CentiMeter
												 * [SI Length Units]</div>
												 */
	CentiMeter("cm",
			"CentiMeter [SI Length Units]"), /**
												 * <div class="en">DeciMeter [SI
												 * Length Units]</div>
												 */
	DeciMeter("dm", "DeciMeter [SI Length Units]"), /**
													 * <div class="en">Meter [SI
													 * Length Units]</div>
													 */
	Meter("m", "Meter [SI Length Units]"), /**
											 * <div class="en">KiloMeter [SI
											 * Length Units]</div>
											 */
	KiloMeter("km",
			"KiloMeter [SI Length Units]"), /**
											 * <div class="en">Grain [English
											 * Mass Units]</div>
											 */
	Grain("[gr]",
			"Grain [English Mass Units]"), /**
											 * <div class="en">Ounce [English
											 * Mass Units]</div>
											 */
	Ounce("[oz_av]",
			"Ounce [English Mass Units]"), /**
											 * <div class="en">TroyOunce
											 * [English Mass Units]</div>
											 */
	TroyOunce("[oz_tr]",
	...
	DegreesKelvin("K",
			"DegreesKelvin [Temperature Units]"), /**
													 * <div
													 * class="en">DegreesCelsius
													 * [Temperature Units]</div>
													 */
	DegreesCelsius("Cel",
	...
	PicoSecond("ps",
			"PicoSecond [Time Units]"), /**
										 * <div class="en">NanoSecond [Time
										 * Units]</div>
										 */
	NanoSecond("ns",
			"NanoSecond [Time Units]"), /**
										 * <div class="en">MicroSecond [Time
										 * Units]</div>
										 */
	MicroSecond("us",
			"MicroSecond [Time Units]"), /**
											 * <div class="en">MilliSecond [Time
											 * Units]</div>
											 */
	...
	Second("s", "Second [Time Units]"), /**
										 * <div class="en">KiloSecond [Time
										 * Units]</div>
										 */
	KiloSecond("ks",
			"KiloSecond [Time Units]"), /**
										 * <div class="en">Megasecond [Time
										 * Units]</div>
										 */
	...
	Year("a", "Year [Time Units]"), /**
									 * <div class="en">Equivalent [Substance
									 * Units]</div>
									 */
	Equivalent("eq",
			"Equivalent [Substance Units]"), /**
												 * <div
												 * class="en">MicroEquivalent
												 * [Substance Units]</div>
												 */
	MicroEquivalent("ueq",
	...
	Femtomole("fmol",
			"Femtomole [Substance Units]"), /**
											 * <div class="en">PicoMole
											 * [Substance Units]</div>
											 */
	PicoMole("pmol", "PicoMole [Substance Units]"), /**
													 * <div class="en">MicroMole
													 * [Substance Units]</div>
													 */
	MicroMole("umol",
			"MicroMole [Substance Units]"), /**
											 * <div class="en">NanoMole
											 * [Substance Units]</div>
											 */
	NanoMole("nmol",
			"NanoMole [Substance Units]"), /**
											 * <div class="en">MilliOsmole
											 * [Substance Units]</div>
											 */
	MilliOsmole("mosm",
	...
	Cup("[cup_us]",
			"Cup [English Volume Units]"), /**
											 * <div class="en">Pint [English
											 * Volume Units]</div>
											 */
	Pint("[pt_us]",
			"Pint [English Volume Units]"), /**
											 * <div class="en">Quart [English
											 * Volume Units]</div>
											 */
	Quart("[qt_us]",
	...
	Liter("L", "Liter [SI Volume Units]"), /**
											 * <div class="en">DeciLiter [SI
											 * Volume Units]</div>
											 */
	DeciLiter("dL",
			"DeciLiter [SI Volume Units]"), /**
											 * <div class="en">CentiLiter [SI
											 * Volume Units]</div>
											 */
	CentiLiter("cL",
			"CentiLiter [SI Volume Units]"), /**
												 * <div class="en">KiloLiter [SI
												 * Volume Units]</div>
												 */
	KiloLiter("kL",
			"KiloLiter [SI Volume Units]"), /**
											 * <div class="en">HectoLiter [SI
											 * Volume Units]</div>
											 */
	HectoLiter("hL",
	...
	PerGram("/g",
			"PerGram [Number Content Units]"), /**
												 * <div
												 * class="en">PerGramCreatinine
												 * [Number Content Units]</div>
												 */
