...
public enum Ucum {
	...
	Cup("[cup_us]", "Cup [English Volume Units]"), /**
													 * <div class="en">Day [Time
													 * Units]</div>
													 */
	Day("d", "Day [Time Units]"), /**
									 * <div class="en">DeciGram [SI Mass
									 * Units]</div>
									 */
	...
	DeciLiter("dL", "DeciLiter [SI Volume Units]"), /**
													 * <div class="en">DeciMeter
													 * [SI Length Units]</div>
													 */
	DeciMeter("dm",
			"DeciMeter [SI Length Units]"), /**
											 * <div class="en">DegreesCelsius
	...
	EquivalentsPerMicroMole("eq/umol",
			"EquivalentsPerMicroMole [Substance Ratio Or Substance Fraction Units]"), /**
																						 ...
																						 * </div>
																						 */
	EquivalentsPerMilliLiter("eq/mL",
	...
	FemtoGram("fg",
			"FemtoGram [SI Mass Units]"), /**
											 * <div class="en">FemtoLiter [Most
											 * Common Healthcare Units]</div>
											 */
	FemtoLiter("fL",
	...
	FemtoMeter("fm",
			"FemtoMeter [SI Length Units]"), /**
												 * <div class="en">Femtomole
												 * [Substance Units]</div>
												 */
	Femtomole("fmol",
			"Femtomole [Substance Units]"), /**
											 * <div class="en">FemtoMolesPerGram
											 * [Substance Content Units]</div>
											 */
	...
	Grain("[gr]", "Grain [English Mass Units]"), /**
													 * <div class="en">Gram [SI
													 * Mass Units]</div>
													 */
	Gram("g", "Gram [SI Mass Units]"), /**
										 * <div class="en">GramMeter [Massive
										 * Distance Units]</div>
										 */
	...
	Hour("h", "Hour [Time Units]"), /**
									 ...
									 * [Arbitrary Concentration Units]</div>
									 */
	...
	Inch("[in_i]",
			"Inch [English Length Units]"), /**
											 * <div class="en">InternationalUnit
											 * [Arbitrary Units]</div>
											 */
	...
	KiloLiter("kL", "KiloLiter [SI Volume Units]"), /**
													 * <div class="en">KiloMeter
													 * [SI Length Units]</div>
													 */
	KiloMeter("km",
			"KiloMeter [SI Length Units]"), /**
											 * <div class="en">KiloPascal [Most
											 * Common Healthcare Units]</div>
											 */
	KiloPascal("kPa",
	...
	KiloSecond("ks",
			"KiloSecond [Time Units]"), /**
										 * <div class="en">KiloUnitsPerGram
										 * [Substance Rate Content Units]</div>
										 */
	...
	Liter("L", "Liter [SI Volume Units]"), /**
											 * <div class="en">LitersPerKilogram
											 * [Volume Content Units]</div>
											 */
	...
	MicroEquivalent("ueq",
			"MicroEquivalent [Substance Units]"), /**
													 ...
													 * Units]</div>
													 */
	MicroEquivalentsPerLiter("ueq/L",
	...
	MicroGram("ug", "MicroGram [SI Mass Units]"), /**
													 * <div class="en">
													 * MicroGramPer100Gram [Mass
													 * Ratio Or Mass Fraction Or
	...
	MicroMole("umol",
			"MicroMole [Substance Units]"), /**
											 * <div class="en">
											 * MicroMolesPerDeciLiter [Substance
											 * Concentration Units]</div>
											 */
	...
	MilliGram("mg",
			"MilliGram [SI Mass Units]"), /**
											 * <div class="en">
											 * MilliGramPerGramCreatinine [Mass
											 * Ratio Or Mass Fraction Or Mass
											 * Content Units]</div>
											 */
	...
	MilliMole("mmol",
			"MilliMole [Substance Units]"), /**
											 * <div class="en">
											 * MilliMolesPerDeciLiter [Substance
											 * Concentration Units]</div>
											 */
	...
	Million("10*6", "Million [Unity]"), /**
										 ...
										 * [Substance Concentration Units]</div>
										 */
	...
	MilliSecond("ms",
			"MilliSecond [Time Units]"), /**
											 * <div class="en">MilliUnitsPerGram
											 * [Substance Rate Content
											 * Units]</div>
											 */
	...
	Minute("min", "Minute [Time Units]"), /**
											 * <div class="en">Mole [Substance
											 * Units]</div>
											 */
	Mole("mol",
			"Mole [Substance Units]"), /**
										 * <div class="en">MolesPerCubicMeter
										 * [Substance Concentration Units]</div>
										 */
	...
	Month("mo", "Month [Time Units]"), /**
										 * <div class="en">NanoGram [SI Mass
										 * Units]</div>
										 */
	NanoGram("ng", "NanoGram [SI Mass Units]"), /**
												 * <div class="en">
												 * NanoGramsPerDeciLiter [Mass
												 * Concentration Units]</div>
												 */
	...
	NanoMole("nmol",
			"NanoMole [Substance Units]"), /**
											 * <div class="en">
											 * NanoMolesPerDeciLiter [Substance
											 * Concentration Units]</div>
											 */
	...
	NanoSecond("ns",
			"NanoSecond [Time Units]"), /**
										 * <div class="en">NauticalMile [English
										 * Length Units]</div>
										 */
	NauticalMile("[nmi_i]",
	...
	Ounce("[oz_av]",
			"Ounce [English Mass Units]"), /**
											 * <div class="en">Per100 [Entitic
											 * Number Units]</div>
											 */
	Per100("/100",
			"Per100 [Entitic Number Units]"), /**
												 * <div class="en">
												 * Per100Spermatozoa [Entitic
												 * Number Units]</div>
												 */
	...
	PerMillion("/10*6",
			"PerMillion [Number Fraction Units]"), /**
													 * <div class="en">PerMinute
													 * [Number Events]</div>
													 */
	PerMinute("/min", "PerMinute [Number Events]"), /**
													 * <div class="en">PerSecond
													 * [Number Events]</div>
													 */
	PerSecond("/s",
			"PerSecond [Number Events]"), /**
											 * <div class="en">PerSquareMeter
											 * [Areic Number Units]</div>
											 */
	PerSquareMeter("/m2",
	...
	PerTotalCount("/{tot}",
			"PerTotalCount [Unity]"), /**
										 * <div class="en">PerTrillion [Number
										 * Fraction Units]</div>
										 */
	PerTrillion("/10*12",
	...
	PerTrillionRedBloodCells("/10*12{rbc}",
			"PerTrillionRedBloodCells [Entitic Number Units]"), /**
																 ...
																 */
	pH("[pH]", "pH [pH Units]"), /**
									 * <div class="en">PicoGram [SI Mass
									 * Units]</div>
									 */
	PicoGram("pg",
			"PicoGram [SI Mass Units]"), /**
											 * <div class="en">PicoGrams [Most
											 * Common Healthcare Units]</div>
											 */
	PicoGrams("pg",
	...
	PicoMole("pmol",
			"PicoMole [Substance Units]"), /**
											 * <div class="en">
											 * PicoMolesPerDeciLiter [Substance
											 * Concentration Units]</div>
											 */
	...
	PicoSecond("ps",
			"PicoSecond [Time Units]"), /**
										 * <div class="en">Pint [English Volume
										 * Units]</div>
										 */
	Pint("[pt_us]",
			"Pint [English Volume Units]"), /**
											 * <div class="en">Pound [English
											 * Mass Units]</div>
											 */
	Pound("[lb_av]",
	...
	Second("s",
			"Second [Time Units]"), /**
									 * <div class="en">SpermatozoaPerMilliLiter
									 * [Number Concentration Units]</div>
									 */
	...
	Thousand("10*3",
			"Thousand [Unity]"), /**
									 * <div class="en">
									 * ThousandCopiesPerMilliLiter [Number
									 * Concentration Units]</div>
									 */
	...
	Week("wk", "Week [Time Units]"), /**
										 * <div class="en">Yard [English Length
										 * Units]</div>
										 */
