...
/**
 * <div class="de">Die Codes beschreiben ob und wie ein Teilnehmer das Dokument
 * unterschreibt</div> <div class="fr"></div>
 */
public enum Signature {
	...
	INTENDED("I", "intended"), /**
								 ...
								 * erfolgt</div> <div class="fr"></div>
								 */
	SIGNED("S", "signed"), /**
							 * <div class="de">Eine Unterschrift ist für diesen
							 * Akteur erforderlich</div> <div class="fr"></div>
							 */
	REQUIRED("X", "required");
