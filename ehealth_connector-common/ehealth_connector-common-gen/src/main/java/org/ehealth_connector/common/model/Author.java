...
public class Author {
	 ...
	 */
	public Author(org.ehealth_connector.common.model.Organization organizationAsAuthor) {
		mAuthor = new POCDMT000040Author();
	...
	public Author(Patient patientAsAuthor) {
		...
		if (patientAsAuthor.getHl7CdaPerson().getName() != null) {
			for (final org.ehealth_connector.common.model.Name name : patientAsAuthor.getNames()) {
