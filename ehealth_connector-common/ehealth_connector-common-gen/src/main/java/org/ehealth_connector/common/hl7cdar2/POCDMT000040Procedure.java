...
@XmlType(name = "POCD_MT000040.Procedure", propOrder = { "realmCode", "typeId", "templateId", "id",
		"code", "text", "statusCode", "effectiveTime", "priorityCode", "languageCode", "methodCode",
		"approachSiteCode", "targetSiteCode", "subject", "specimen", "performer", "author",
