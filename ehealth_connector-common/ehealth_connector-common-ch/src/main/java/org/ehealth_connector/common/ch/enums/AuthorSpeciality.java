 ...
 * <p>
 * EN: Speciality of the author as per Annex 3.<br>
 * DE: Spezialisierung des Autors gemäss Anhang 3.<br>
...
public enum AuthorSpeciality implements ValueSetEnumInterface {
	 ...
	 * IT: Attivazione<br>
	 */
	ACTIVATION("5002", "2.16.756.5.30.1.127.3.6", "Activation", "Activation", "Aktivierung", "Activation", "Attivazione"),
	/**
	...
	/**
	 * EN: Biomedical analysis<br>
	 * DE: Biomedizinische Analytik<br>
	 * FR: Analyses biomédicales<br>
	 * IT: Analisi biomediche<br>
	 */
	BIOMEDICAL_ANALYSIS("5003", "2.16.756.5.30.1.127.3.6", "Biomedical analysis", "Biomedical analysis", "Biomedizinische Analytik", "Analyses biomédicales", "Analisi biomediche"),
	/**
	 ...
	 * DE: Dentalhygiene<br>
	 * FR: Hygiène dentaire<br>
	 * IT: Igiene dentale<br>
	 */
	DENTAL_HYGIENE("5004", "2.16.756.5.30.1.127.3.6", "Dental hygiene", "Dental hygiene", "Dentalhygiene", "Hygiène dentaire", "Igiene dentale"),
	/**
	...
	/**
	 * EN: Massage Therapy<br>
	 * DE: Medizinische Massage<br>
	 * FR: Massage médical<br>
	 * IT: Massaggio medico<br>
	 */
	MASSAGE_THERAPY("5012", "2.16.756.5.30.1.127.3.6", "Massage Therapy", "Massage Therapy", "Medizinische Massage", "Massage médical", "Massaggio medico"),
	/**
	 ...
	 * IT: Ostetricia<br>
	 */
	MIDWIFERY("5010", "2.16.756.5.30.1.127.3.6", "Midwifery", "Midwifery", "Geburtshilfe - Hebamme", "Sage-femme", "Ostetricia"),
	/**
	 ...
	 */
	NATUROPATHY_AYURVEDA_MEDICINE("5021", "2.16.756.5.30.1.127.3.6", "Naturopathy Ayurveda Medicine", "Naturopathy Ayurveda Medicine", "Naturheilpraktiker/-in Ayurveda-Medizin", "Naturopathe médecine ayurvédique", "Naturopata medicina ayurvedica"),
	/**
	 ...
	 */
	NATUROPATHY_EUROPEAN_TRADITIONAL_MEDICINE("5024", "2.16.756.5.30.1.127.3.6", "Naturopathy European Traditional Medicine", "Naturopathy European Traditional Medicine", "Naturheilpraktiker/-in Trad. Europäische Naturheilkunde", "Naturopathe médecine naturelle trad. européenne", "Naturopata medicina naturale trad. europea"),
	/**
	 ...
	 */
	NATUROPATHY_HOMEOPATHY("5022", "2.16.756.5.30.1.127.3.6", "Naturopathy Homeopathy", "Naturopathy Homeopathy", "Naturheilpraktiker/-in Homöopathie", "Naturopathe homéopathie", "Naturopata omeopatia"),
	/**
	 ...
	 */
	NATUROPATHY_TRADITIONAL_CHINESE_MEDICINE("5023", "2.16.756.5.30.1.127.3.6", "Naturopathy Traditional Chinese Medicine", "Naturopathy Traditional Chinese Medicine", "Naturheilpraktiker/-in Trad. Chinesische Medizin", "Naturopathe médecine trad. chinoise", "Naturopata medicina trad. cinese"),
	/**
	 * EN: Nephrology<br>
	 * DE: Nephrologie<br>
	 * FR: Néphrologie<br>
	 ...
	 * EN: Nursing<br>
	 * DE: Pflege<br>
	 * FR: Soins infirmiers<br>
	 * IT: Cure infermieristiche<br>
	 */
	NURSING("5015", "2.16.756.5.30.1.127.3.6", "Nursing", "Nursing", "Pflege", "Soins infirmiers", "Cure infermieristiche"),
	/**
	 ...
	 */
	NUTRITION_AND_DIETETICS("5007", "2.16.756.5.30.1.127.3.6", "Nutrition and Dietetics", "Nutrition and Dietetics", "Ernährungsberatung", "Diététique", "Consulenza alimentare"),
	/**
	 ...
	 * IT: Ergoterapia<br>
	 */
	OCCUPATIONAL_THERAPY("5006", "2.16.756.5.30.1.127.3.6", "Occupational Therapy", "Occupational Therapy", "Ergotherapie", "Ergothérapie", "Ergoterapia"),
	/**
	 ...
	 */
	OFFIZINPHARMAZIE("1052", "2.16.756.5.30.1.127.3.5", "Offizinpharmazie", "Offizinpharmazie", "Offizinpharmazie", "Pharmacie d’officine", "Farmacia d’officina"),
	/**
	 * EN: Ophthalmology<br>
	 ...
	 * IT: Ottica<br>
	 */
	OPTICS("5001", "2.16.756.5.30.1.127.3.6", "Optics", "Optics", "Augenoptik", "Optique", "Ottica"),
	/**
	 * EN: Optometry<br>
	 * DE: Optometrie<br>
	 * FR: Optométrie<br>
	 * IT: Optometria<br>
	 */
	OPTOMETRY("5019", "2.16.756.5.30.1.127.3.6", "Optometry", "Optometry", "Optometrie", "Optométrie", "Optometria"),
	/**
	 ...
	 * IT: Ortottica<br>
	 */
	ORTHOPTICS("5013", "2.16.756.5.30.1.127.3.6", "Orthoptics", "Orthoptics", "Orthoptik", "Orthoptique", "Ortottica"),
	/**
	 * EN: Osteopathy<br>
	 * DE: Osteopathie<br>
	 * FR: Ostéopathie<br>
	 * IT: Osteopatia<br>
	 */
	OSTEOPATHY("5014", "2.16.756.5.30.1.127.3.6", "Osteopathy", "Osteopathy", "Osteopathie", "Ostéopathie", "Osteopatia"),
	/**
	 * EN: Other<br>
	 * DE: Andere<br>
	 * FR: Autre<br>
	...
	/**
	 * EN: Paramedics<br>
	 * DE: Rettungssanität<br>
	 * FR: Sauvetage<br>
	 * IT: Soccorso sanitario<br>
	 */
	PARAMEDICS("5018", "2.16.756.5.30.1.127.3.6", "Paramedics", "Paramedics", "Rettungssanität", "Sauvetage", "Soccorso sanitario"),
	/**
	 * EN: Pathology<br>
	 * DE: Pathologie<br>
	 * FR: Pathologie<br>
	...
	/**
	 * EN: Pharmaceutical<br>
	 * DE: Drogist/Drogistin<br>
	 * FR: Droguiste<br>
	 * IT: Droghiere/Droghiera<br>
	 */
	PHARMACEUTICAL("5005", "2.16.756.5.30.1.127.3.6", "Pharmaceutical", "Pharmaceutical", "Drogist/Drogistin", "Droguiste", "Droghiere/Droghiera"),
	/**
	 ...
	 * IT: Fisioterapia<br>
	 */
	PHYSIOTHERAPY("5016", "2.16.756.5.30.1.127.3.6", "Physiotherapy", "Physiotherapy", "Physiotherapie", "Physiothérapie", "Fisioterapia"),
	/**
	 ...
	 * IT: Podologia<br>
	 */
	PODIATRY("5017", "2.16.756.5.30.1.127.3.6", "Podiatry", "Podiatry", "Podologie", "Podologie", "Podologia"),
	/**
	 ...
	 */
	RADIOLOGIC_TECHNOLOGY("5008", "2.16.756.5.30.1.127.3.6", "Radiologic Technology", "Radiologic Technology", "Medizinisch-technische Radiologie", "Technique en radiologie médicale", "Tecniche di radiologia medica"),
	/**
	 * EN: Radiology<br>
	 * DE: Radiologie<br>
	 * FR: Radiologie<br>
	 ...
	 * IT: Logopedia<br>
	 */
	SPEECH_AND_LANGUAGE_THERAPY("5011", "2.16.756.5.30.1.127.3.6", "Speech and Language Therapy", "Speech and Language Therapy", "Logopädie", "Logopédie", "Logopedia"),
	/**
	 ...
	 */
	SPITALPHARMAZIE("1053", "2.16.756.5.30.1.127.3.5", "Spitalpharmazie", "Spitalpharmazie", "Spitalpharmazie", "Pharmacie hospitalière", "Farmacia d’ospedale"),
	/**
	 * EN: Surgery<br>
	 * DE: Chirurgie<br>
	 * FR: Chirurgie<br>
	 ...
	 */
	SURGICAL_TECHNOLOGY("5009", "2.16.756.5.30.1.127.3.6", "Surgical Technology", "Surgical Technology", "Operationstechnik", "Technique opératoire", "Tecnica operatoria"),
	/**
	...
	/**
	 * EN: Code for Activation<br>
	 * DE: Code für Aktivierung<br>
	 * FR: Code de Activation<br>
	 * IT: Code per Attivazione<br>
	 */
	...
	/**
	 * EN: Code for Biomedical analysis<br>
	 * DE: Code für Biomedizinische Analytik<br>
	 * FR: Code de Analyses biomédicales<br>
	 * IT: Code per Analisi biomediche<br>
	 */
	 ...
	 * DE: Code für Dentalhygiene<br>
	 * FR: Code de Hygiène dentaire<br>
	 * IT: Code per Igiene dentale<br>
	 */
	...
	/**
	 * EN: Code for Massage Therapy<br>
	 * DE: Code für Medizinische Massage<br>
	 * FR: Code de Massage médical<br>
	 * IT: Code per Massaggio medico<br>
	 */
	 ...
	 * FR: Code de Soins infirmiers<br>
	...
	/**
	 * EN: Code for Optics<br>
	 * DE: Code für Augenoptik<br>
	 * FR: Code de Optique<br>
	 * IT: Code per Ottica<br>
	 */
	public static final String OPTICS_CODE = "5001";

	/**
	 * EN: Code for Optometry<br>
	 * DE: Code für Optometrie<br>
	 * FR: Code de Optométrie<br>
	 * IT: Code per Optometria<br>
	 */
	...
	/**
	 * EN: Code for Orthoptics<br>
	 * DE: Code für Orthoptik<br>
	 * FR: Code de Orthoptique<br>
	 * IT: Code per Ortottica<br>
	 */
	public static final String ORTHOPTICS_CODE = "5013";

	/**
	 * EN: Code for Osteopathy<br>
	...
	/**
	 * EN: Code for Paramedics<br>
	 * DE: Code für Rettungssanität<br>
	 * FR: Code de Sauvetage<br>
	 * IT: Code per Soccorso sanitario<br>
	 */
	...
	/**
	 * EN: Code for Pharmaceutical<br>
	 * DE: Code für Drogist/Drogistin<br>
	 * FR: Code de Droguiste<br>
	 * IT: Code per Droghiere/Droghiera<br>
	 */
	 ...
	 */
	AuthorSpeciality(final String code, final String codeSystem, final String displayName, final String displayNameEn, final String displayNameDe, final String displayNameFr, final String displayNameIt) {
		this.code = code;
