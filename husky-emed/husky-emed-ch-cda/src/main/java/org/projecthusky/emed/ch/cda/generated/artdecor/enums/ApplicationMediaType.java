...
/**
 * Enumeration of ApplicationMediaType values
 * <p>
 * EN: <p> <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>Application specific media type.</p>.<br>
 * DE: No designation found.<br>
 * FR: No designation found.<br>
 * IT: No designation found.<br>
 * <p>
 * Identifier: 2.16.840.1.113883.1.11.14832<br>
...
public enum ApplicationMediaType implements ValueSetEnumInterface {
     ...
     */
    @Nullable
    public static ApplicationMediaType getEnum(@Nullable final String code) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ApplicationMediaType.class,
                         enumName);
            return true;
     ...
     */
    ApplicationMediaType(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
