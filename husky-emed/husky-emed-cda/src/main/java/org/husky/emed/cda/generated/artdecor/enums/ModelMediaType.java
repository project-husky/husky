...
public enum ModelMediaType implements ValueSetEnumInterface {
     ...
     */
    public static ModelMediaType getEnum(final String code) {
     ...
     */
    ModelMediaType(final String code, final String codeSystem, final String displayName, final String displayNameEn, final String displayNameDe, final String displayNameFr, final String displayNameIt) {
        this.code = code;
