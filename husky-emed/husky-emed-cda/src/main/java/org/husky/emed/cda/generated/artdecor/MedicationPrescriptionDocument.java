...
public class MedicationPrescriptionDocument extends POCDMT000040ClinicalDocument {
    ...
    /**
     * Sets the hl7Title/<div>The German title shall be "Rezept".</div><div>The French title shall be "Ordonnance".</div><div>The Italian title shall be "Ricetta".</div><div>The English title shall be "Prescription".</div><div>Titles in other languages are allowed and unrestricted.</div>
     */
