...
public enum VideoMediaType implements ValueSetEnumInterface {
     ...
     */
    public static VideoMediaType getEnum(final String code) {
     ...
     */
    VideoMediaType(final String code, final String codeSystem, final String displayName, final String displayNameEn, final String displayNameDe, final String displayNameFr, final String displayNameIt) {
        this.code = code;
