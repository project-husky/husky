...
public class NarrativeTextReferenceWithContent extends ED {
    ...
    /**
     * Gets the hl7Reference/The reference to the corresponding text in the human readable part must be specified by reference to content[@ID]: reference[@value='#xxx']<span style="white-space:pre"/><br clear="none"/>
     */
    ...
    /**
     * Sets the hl7Reference/The reference to the corresponding text in the human readable part must be specified by reference to content[@ID]: reference[@value='#xxx']<span style="white-space:pre"/><br clear="none"/>
     */
