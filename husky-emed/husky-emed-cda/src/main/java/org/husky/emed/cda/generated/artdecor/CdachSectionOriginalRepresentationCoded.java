...
public class CdachSectionOriginalRepresentationCoded extends POCDMT000040Section {
    ...
    /**
     * Sets the hl7Text/MUST contain the reference (renderMultiMedia/@referencedObject) to the corrsponding observationMedia (embedded PDF) that shows the original representation signed by the legal authenticator.
     */
    ...
    /**
     * Sets the hl7Title/Fixed human readable title of this section.
     * - [de]: 'Original Darstellung'
     * - [fr]: 'Représentation originale'
     * - [it]: 'Rappresentazione originale'
     * - [en]: 'Original representation'
