...
public class MedicationListSectionContentModule extends POCDMT000040Section {
    ...
    /**
     * Sets the hl7Code/IHE Pharm PML 6.3.3.10.S1.1<br clear="none"/>
     */
    ...
    /**
     * Sets the hl7Title/<div>The German title shall be "Medikamentenliste".</div><div>The French title shall be "Liste de médicaments".</div><div>The Italian title shall be "Lista farmaci".</div><div>The English title shall be "Medication List".</div><div>Titles in other languages are allowed and unrestricted.</div>
     */
