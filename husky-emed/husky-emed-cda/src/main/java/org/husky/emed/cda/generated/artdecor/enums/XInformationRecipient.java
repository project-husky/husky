...
public enum XInformationRecipient implements ValueSetEnumInterface {
     ...
     */
    XInformationRecipient(final String code, final String codeSystem, final String displayName, final String displayNameEn, final String displayNameDe, final String displayNameFr, final String displayNameIt) {
        this.code = code;
