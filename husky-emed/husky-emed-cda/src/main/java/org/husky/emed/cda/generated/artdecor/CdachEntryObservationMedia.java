...
public class CdachEntryObservationMedia extends POCDMT000040ObservationMedia {
    ...
    /**
     * Sets the hl7LanguageCode/The RFC 1766 (ISO-639-1 and ISO 3166) based language in which the multimedia object is written. If it isn't known or not available (e.g. for pictures), use nullFlavor instead.
     */
    ...
    /**
     * Sets the hl7Value/This template defines only the embedding of multimedia objects in the CDA document.
     */
