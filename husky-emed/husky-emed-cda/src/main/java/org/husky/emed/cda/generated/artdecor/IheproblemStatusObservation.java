...
public class IheproblemStatusObservation extends POCDMT000040Observation {
    ...
    /**
     * Sets the hl7Code/This observation is of clinical status, as indicated by the &lt;code&gt; element. This element must be present.
     */
    ...
    /**
     * Sets the hl7Value/The &lt;value&gt; element contains the clinical status. It is always represented using the CE datatype (xsi:type='CE'). It shall contain a code from the following set of values from SNOMED CT.
     */
