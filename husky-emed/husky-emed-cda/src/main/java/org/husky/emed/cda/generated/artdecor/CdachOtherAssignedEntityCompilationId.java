...
public class CdachOtherAssignedEntityCompilationId extends POCDMT000040AssignedEntity {
    ...
    /**
     * Sets the hl7Code/The human-readable text MUST be generated automatically from the structured information of this element. The text element MUST contain the reference to the corresponding text in the human readable part, ONLY.
     */
