...
public class MedicationDispenseDocument extends POCDMT000040ClinicalDocument {
    ...
    /**
     * Gets the hl7Title/<div>The German title shall be "Abgabe".</div><div>The French title shall be "Remise".</div><div>The Italian title shall be "Dispensazione".</div><div>The English title shall be "Dispense".</div><div>Titles in other languages are allowed and unrestricted.</div>
     */
    ...
    /**
     * Sets the hl7Title/<div>The German title shall be "Abgabe".</div><div>The French title shall be "Remise".</div><div>The Italian title shall be "Dispensazione".</div><div>The English title shall be "Dispense".</div><div>Titles in other languages are allowed and unrestricted.</div>
     */
