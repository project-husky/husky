 ...
 * <p>
 * Template description: TheMedication Dispense document(IPAG report: eDispense) describes the direct dispensation of a (1) drug to a patient or legitimized third party with regard to a later application of the product by a qualified health professional.Relation to IHE PharmacyThe Medication Dispense document is based on the<a href="http://www.ihe.net/uploadedFiles/Documents/Pharmacy/IHE_Pharmacy_Suppl_DIS.pdf">IHE Pharmacy Technical Framework Supplement – Pharmacy Dispense (DIS)</a>.<br>
 * <p>
