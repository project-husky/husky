...
public class ReportBuilder {
	 ...
	 * @throws RuleSetDetectionException
	 */
	public void checkRuleSet(Source source, RuleSet ruleSet) throws RuleSetDetectionException {
		if (ruleSet.getTemplateId() != null) {
	...
	public byte[] createHTMLReport(RuleSet[] ruleSetList, byte[] input, Properties parameters)
			throws RuleSetDetectionException, TransformationException, InterruptedException {
		ByteArrayInputStream in = new ByteArrayInputStream(input);
