...
public class Configurator {
	 ...
	 *             if the configuration file cannot be opened for reading, is
	 *             not valid, or if any unexpected errors occur while
	 *             unmarshalling and when an I/O error occurs, when constructing
	 *             the canonical pathname of the application's home directory.
	...
	/**
	 * Returns the parser used to process the application's XML configuration
	 * file.
	 *
	 ...
	 * directory where the configuration file resides. If this directory is not
	 * available, then the current working directory is used instead.
	 * </p>
	 * <p>
	 * The application's home directory is set accordingly to the value of the
	 * <tt>baseDir</tt> attribute of the <tt>&lt;configuration&gt;</tt> element.
	 * If this attribute is not present, then the default location is used. If
	 * the path denoted by the value of the <tt>baseDir</tt> attribute is not
	 * absolute, then it will be relative to the default location.
	 * </p>
	 *
	 * @param configurationType
	 *            the unmarshalled <tt>&lt;configuration&gt;</tt> element.
	 * @throws ConfigurationException
	 *             If an I/O error occurs, when constructing the canonical
	 *             pathname.
	 */
	protected void setupHomeDirectory(ConfigurationType configurationType)
		...
		if (defaultDir == null)
			defaultDir = new File(".");
		System.setProperty("configuration.dir", defaultDir.getPath());
