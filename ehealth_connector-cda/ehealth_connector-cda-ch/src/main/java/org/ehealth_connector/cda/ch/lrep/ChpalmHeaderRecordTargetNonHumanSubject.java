...
public class ChpalmHeaderRecordTargetNonHumanSubject
	 ...
	 */
	public static ChpalmHeaderRecordTargetNonHumanSubject loadFromFile(File inputFile)
			throws JAXBException, IOException {
		ChpalmHeaderRecordTargetNonHumanSubject retVal;
		JAXBContext context = JAXBContext
				.newInstance(ChpalmHeaderRecordTargetNonHumanSubject.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<ChpalmHeaderRecordTargetNonHumanSubject> root = mar.unmarshal(source,
				ChpalmHeaderRecordTargetNonHumanSubject.class);
	 ...
	 */
	public static ChpalmHeaderRecordTargetNonHumanSubject loadFromFile(String inputFileName)
			throws JAXBException, IOException {
		return loadFromFile(new File(inputFileName));
	}

	public ChpalmHeaderRecordTargetNonHumanSubject() {
		setHl7TemplateIdFixedValue("1.3.6.1.4.1.19376.1.3.3.1.2");
		setHl7TemplateIdFixedValue("2.16.756.5.30.1.1.10.2.26");
	}
