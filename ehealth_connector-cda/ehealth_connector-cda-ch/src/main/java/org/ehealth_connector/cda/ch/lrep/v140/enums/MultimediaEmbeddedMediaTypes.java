...
public enum MultimediaEmbeddedMediaTypes implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for BMP Image</div>
	 * <!-- @formatter:on -->
	 */
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "1.3.6.1.4.1.19376.1.3.11.5";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "MultimediaEmbeddedMediaTypes";
	 ...
	 */
	public static MultimediaEmbeddedMediaTypes getEnum(String code) {
		for (final MultimediaEmbeddedMediaTypes x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(MultimediaEmbeddedMediaTypes.class, enumName);
			return true;
