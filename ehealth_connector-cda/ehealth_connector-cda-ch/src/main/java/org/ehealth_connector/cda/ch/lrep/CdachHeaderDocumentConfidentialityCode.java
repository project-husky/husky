...
public class CdachHeaderDocumentConfidentialityCode
	 ...
	 */
	public static CdachHeaderDocumentConfidentialityCode loadFromFile(File inputFile)
		...
		JAXBElement<CdachHeaderDocumentConfidentialityCode> root = mar.unmarshal(source,
				CdachHeaderDocumentConfidentialityCode.class);
	 ...
	 */
	public static CdachHeaderDocumentConfidentialityCode loadFromFile(String inputFileName)
			throws JAXBException, IOException {
