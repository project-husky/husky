...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.3.50 Template
 * description: Chapter (CDA Body Section) containing the history of past
 * illness according to IHE PCC Technical Framework Revision 11.0 - November 11,
 * 2016.This section contains the anamnesis of the patient. The section MUST
 * contain at least one Problem entry. In case of no problems, one of the
 * 'special case' codes MUST be used.In the context of immunizations, only the
 * diseases should be mentioned which lead to a natural immunization.
 *
 * Element description: Chapter (CDA Body Section) containing the history of
 * past illness according to IHE PCC Technical Framework Revision 11.0 -
 * November 11, 2016.This section contains the anamnesis of the patient. The
 * section MUST contain at least one Problem entry. In case of no problems, one
 * of the 'special case' codes MUST be used.In the context of immunizations,
 * only the diseases should be mentioned which lead to a natural immunization.
 */
