...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.3.48 Template
 * description: Chapter (CDA Body Section) containing immunization
 * recommendations according to IHE PCC Technical Framework Revision 11.0 -
 * November 11, 2016.This section MAY contain the the recommended immunization
 * plan for a patient. The section MUST contain at least one Immunization
 * Recommendation entry. In case of no recommendations, one of the 'special
 * case' codes MUST be used.
 *
 * Element description: Chapter (CDA Body Section) containing immunization
 * recommendations according to IHE PCC Technical Framework Revision 11.0 -
 * November 11, 2016.This section MAY contain the the recommended immunization
 * plan for a patient. The section MUST contain at least one Immunization
 * Recommendation entry. In case of no recommendations, one of the 'special
 * case' codes MUST be used.
 */
public class ChpccSectionImmunizationRecommendationsCoded
	...
	public ChpccSectionImmunizationRecommendationsCoded() {
		super.getTemplateId().add(createHl7TemplateIdFixedValue("2.16.756.5.30.1.1.10.3.48"));
		super.getTemplateId()
				.add(createHl7TemplateIdFixedValue("1.3.6.1.4.1.19376.1.5.3.1.1.18.3.1"));
		super.setCode(createHl7CodeFixedValue("18776-5", "2.16.840.1.113883.6.1", "LOINC",
				"TREATMENT PLAN"));
