...
public class MedicationPrescriptionDocument extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ClinicalDocument {
	...
	// MedicationPrescriptionDocument/hl7:typeId:uid root = "2.16.840.1.113883.1.3";
	// MedicationPrescriptionDocument/hl7:typeId:st extension = "POCD_HD000040";
	// MedicationPrescriptionDocument/hl7:templateId:uid root = "2.16.756.5.30.1.127.1.4";
	 ...
	 */
	public static MedicationPrescriptionDocument loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static MedicationPrescriptionDocument loadFromFile(File inputFile) throws JAXBException, IOException {
		...
		JAXBElement<MedicationPrescriptionDocument> root = mar.unmarshal(source, MedicationPrescriptionDocument.class);
