...
public class ChpalmHeaderDocumentationOfLaboratoryPerformer
	 ...
	 */
	public static ChpalmHeaderDocumentationOfLaboratoryPerformer loadFromFile(File inputFile)
			throws JAXBException, IOException {
		ChpalmHeaderDocumentationOfLaboratoryPerformer retVal;
		JAXBContext context = JAXBContext
				.newInstance(ChpalmHeaderDocumentationOfLaboratoryPerformer.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<ChpalmHeaderDocumentationOfLaboratoryPerformer> root = mar.unmarshal(source,
				ChpalmHeaderDocumentationOfLaboratoryPerformer.class);
	 ...
	 */
	public static ChpalmHeaderDocumentationOfLaboratoryPerformer loadFromFile(String inputFileName)
			throws JAXBException, IOException {
