...
public class PrescribedQuantityEntryContentModule extends org.ehealth_connector.common.hl7cdar2.POCDMT000040Supply {
	...
	// PrescribedQuantityEntryContentModule/hl7:supply:cs classCode = "SPLY";
	// PrescribedQuantityEntryContentModule/hl7:supply:cs moodCode = "RQO";
	// PrescribedQuantityEntryContentModule/hl7:templateId:uid root = "1.3.6.1.4.1.19376.1.9.1.3.8";
	// PrescribedQuantityEntryContentModule/hl7:independentInd:null value = "false";
