 ...
 */
public class CdachOtherAuthorCompilationWithName extends org.ehealth_connector.common.hl7cdar2.POCDMT000040Author {
	...
	// cdach_other_AuthorCompilationWithName/hl7:functionCode:cs valueSet = valueSet("2.16.756.5.30.1.127.3.10.1.1.3"); --> org.ehealth_connector.cda.ch.lrep.v133.enums.DocumentEntryAuthorRole
	// cdach_other_AuthorCompilationWithName/hl7:functionCode:st nullFlavor = "NAV";
	// cdach_other_AuthorCompilationWithName/hl7:functionCode:oid codeSystem = "2.16.840.1.113883.6.96";
	// cdach_other_AuthorCompilationWithName/hl7:functionCode:st codeSystemName = "SNOMED CT";
	}
