...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.3.47 Template
 * description: Chapter (CDA Body Section) containing immunizations according to
 * IHE PCC Technical Framework Revision 11.0 - November 11, 2016.This section
 * contains administered immunizations and explicitly undesired immunizations.
 *
 * Element description: Chapter (CDA Body Section) containing immunizations
 * according to IHE PCC Technical Framework Revision 11.0 - November 11,
 * 2016.This section contains administered immunizations and explicitly
 * undesired immunizations.
 */
