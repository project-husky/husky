...
/**
 * <!-- @formatter:off -->
 * <div class="en"><p>    <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>Potential values for observations of severity.</p></div>
...
public enum SeverityObservation implements ValueSetEnumInterface {
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "2.16.840.1.113883.1.11.16643";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "SeverityObservation";
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(SeverityObservation.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	SeverityObservation(String code, String codeSystem, String displayName, String displayNameEn,
