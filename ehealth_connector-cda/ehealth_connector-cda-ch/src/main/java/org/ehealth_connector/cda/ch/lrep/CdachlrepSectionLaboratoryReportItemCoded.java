...
public class CdachlrepSectionLaboratoryReportItemCoded
	 ...
	 */
	public static CdachlrepSectionLaboratoryReportItemCoded loadFromFile(File inputFile)
			throws JAXBException, IOException {
		CdachlrepSectionLaboratoryReportItemCoded retVal;
		JAXBContext context = JAXBContext
				.newInstance(CdachlrepSectionLaboratoryReportItemCoded.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachlrepSectionLaboratoryReportItemCoded> root = mar.unmarshal(source,
				CdachlrepSectionLaboratoryReportItemCoded.class);
	 ...
	 */
	public static CdachlrepSectionLaboratoryReportItemCoded loadFromFile(String inputFileName)
			throws JAXBException, IOException {
