...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.4.95 Template
 * description: Target of the immunization. All immunizations targets (diseases)
 * SHALL be recorded with an immunization entry. This element allows structured
 * information for immunizations with combinded vaccines (e.g. Di-Te-Per vaccine
 * contains three different vaccines. They will result in three different
 * entries of this template).
 *
 * Element description: Target of the immunization. All immunizations targets
 * (diseases) SHALL be recorded with an immunization entry. This element allows
 * structured information for immunizations with combinded vaccines (e.g.
 * Di-Te-Per vaccine contains three different vaccines. They will result in
 * three different entries of this template).
 */
