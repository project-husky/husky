...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.4.100 Template
 * description: Any problem or allergy observation may reference a problem
 * status observation.
 *
 * Element description: Any problem or allergy observation may reference a
...
public class ChpccEntryProblemStatusObservation
	...
	/**
	 * Gets the hl7Value The<value>element contains the clinical status. It is
	 * always represented using the CE datatype (xsi:type='CE'). It shall
	 * contain a code from the following set of values from SNOMED CT.</value>
	 */
	...
	/**
	 * Sets the hl7Value The<value>element contains the clinical status. It is
	 * always represented using the CE datatype (xsi:type='CE'). It shall
	 * contain a code from the following set of values from SNOMED CT.</value>
	 */
