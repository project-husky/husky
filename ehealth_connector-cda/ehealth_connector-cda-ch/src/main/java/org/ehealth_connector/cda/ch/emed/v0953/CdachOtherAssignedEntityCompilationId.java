 ...
 */
public class CdachOtherAssignedEntityCompilationId extends org.ehealth_connector.common.hl7cdar2.POCDMT000040AssignedEntity {

	public CdachOtherAssignedEntityCompilationId() {
	// cdach_other_AssignedEntityCompilationId/hl7:code:cs valueSet = valueSet("2.16.756.5.30.1.127.3.10.1.1.3"); --> org.ehealth_connector.cda.ch.emed.v0953.enums.DocumentEntryAuthorRole
