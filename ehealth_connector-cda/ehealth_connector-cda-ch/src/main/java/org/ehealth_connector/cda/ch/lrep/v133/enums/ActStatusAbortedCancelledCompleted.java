...
/**
 * <!-- @formatter:off -->
 * <div class="en"><p>    <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>    <b>Description:</b> The status of an assessment for indications of an abnormal condition.</p></div>
...
public enum ActStatusAbortedCancelledCompleted implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for aborted</div>
	 * <!-- @formatter:on -->
	 */
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "2.16.840.1.113883.1.11.20309";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "ActStatusAbortedCancelledCompleted";
	 ...
	 */
	public static ActStatusAbortedCancelledCompleted getEnum(String code) {
		for (final ActStatusAbortedCancelledCompleted x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(ActStatusAbortedCancelledCompleted.class, enumName);
			return true;
