...
public class CdachlrepEntryLaboratoryBatteryOrganizerAntibiogram
	 ...
	 */
	public static CdachlrepEntryLaboratoryBatteryOrganizerAntibiogram loadFromFile(File inputFile)
			throws JAXBException, IOException {
		CdachlrepEntryLaboratoryBatteryOrganizerAntibiogram retVal;
		JAXBContext context = JAXBContext
				.newInstance(CdachlrepEntryLaboratoryBatteryOrganizerAntibiogram.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachlrepEntryLaboratoryBatteryOrganizerAntibiogram> root = mar
				.unmarshal(source, CdachlrepEntryLaboratoryBatteryOrganizerAntibiogram.class);
