 ...
 *
 * Element description: CDA-CH v2.0 specification. This is an informational
 * reference, only.
 */
public class CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody
	 ...
	 */
	public static CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody loadFromFile(File inputFile)
			throws JAXBException, IOException {
		CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody retVal;
		JAXBContext context = JAXBContext
				.newInstance(CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody> root = mar
				.unmarshal(source, CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody.class);
	 ...
	 */
	public static CdachHeaderDocumentTemplateIdsCdaChv20StructuredBody loadFromFile(
