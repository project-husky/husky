...
/**
 * Original ART-DECOR template id: 1.3.6.1.4.1.19376.1.5.3.1.4.1.1
 * Template description: Any problem or allergy observation may reference a problem status observation. This structure isÂ <span style="line-height: 1.22;">included in the target observation using the &lt;entryRelationship&gt; element defined in the CDAÂ </span><span style="line-height: 1.22;">Schema. The clinical status observation records information about the current status of theÂ </span><span style="line-height: 1.22;">problem or allergy, for example, whether it is active, in remission, resolved, et cetera. TheÂ </span><span style="line-height: 1.22;">example below shows the recording of clinical status of a condition or allergy, and is used as theÂ </span><span style="line-height: 1.22;">context for the following sections.</span>
 */
public class IheproblemStatusObservation extends org.ehealth_connector.common.hl7cdar2.POCDMT000040Observation {
