...
public class CdachHeaderOrderReference extends org.ehealth_connector.common.hl7cdar2.POCDMT000040InFulfillmentOf {
	 ...
	 */
	public static CdachHeaderOrderReference loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static CdachHeaderOrderReference loadFromFile(File inputFile) throws JAXBException, IOException {
		...
		JAXBElement<CdachHeaderOrderReference> root = mar.unmarshal(source, CdachHeaderOrderReference.class);
