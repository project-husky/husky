...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.18 Template
 ...
 * ResponseConformity rules that are not further modelled in ART-DECOR: - XML
...
public class CdaChVacdRspV21
	...
	/**
	 * Gets the hl7TemplateId CDA-CH-VACD / Immunization Recommendation Response
	 * ART-DECOR model.
	 */
	 ...
	 * Recommendation' - [de]: 'Impfempfehlung' - [fr]: 'Recommandation
	 * vaccinale' - [it]: 'Raccomandazione di vaccinazione'
	 */
	 ...
	 *         occurred.
	 */
	public static CdaChVacdRspV21 loadFromFile(String inputFileName)
	 ...
	 */
	public static CdaChVacdRspV21 loadFromFile(File inputFile) throws JAXBException, IOException {
		CdaChVacdRspV21 retVal;
		JAXBContext context = JAXBContext.newInstance(CdaChVacdRspV21.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdaChVacdRspV21> root = mar.unmarshal(source, CdaChVacdRspV21.class);
	...
	/**
	 * Sets the hl7TemplateId CDA-CH-VACD / Immunization Recommendation Response
	 * ART-DECOR model.
	 */
