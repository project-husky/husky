...
@XmlType(name = "POCD_MT000040.ClinicalDocument", propOrder = { "hl7RealmCode", "hl7TypeId",
		"hl7TemplateId", "hl7TemplateId1", "hl7TemplateId2", "hl7TemplateId3", "hl7TemplateId4",
		"hl7TemplateId5", "hl7TemplateId6", "hl7Id", "hl7Code", "hl7Title", "hl7EffectiveTime",
		"hl7ConfidentialityCode", "hl7LanguageCode", "hl7SetId", "hl7VersionNumber",
		"hl7RecordTarget", "hl7RecordTarget1", "hl7RecordTarget2", "hl7Author", "hl7DataEnterer",
		"hl7Custodian", "hl7InformationRecipient", "hl7LegalAuthenticator", "hl7Authenticator",
		"hl7Participant", "hl7Participant1", "hl7InFulfillmentOf", "hl7DocumentationOf",
		"hl7DocumentationOf1", "hl7RelatedDocument", "hl7Component" })
public class CdaChLrepGrV1
	...
	/**
	 * Information about an authenticator of a CDA document. An authenticator
	 * MUST be a person.
	 */
	@XmlElement(name = "hl7:authenticator")
	private ArrayList<org.ehealth_connector.common.hl7cdar2.POCDMT000040Authenticator> hl7Authenticator;

	/**
	 * Information about the author of the document. The author MAY be a person
	 * or a device. At least one author MUST be declared.
	 */
	 ...
	 * translation to the Swiss EPR XDS.b metadata. - Multidisciplinary
	 ...
	 * discipline:The LOINC code of the document MUST be taken from the
	...
	/**
	 * Swiss Realm of Confidentiality Code according to the Swiss EPR
	 * regulation.
	 */
	@XmlElement(name = "hl7:confidentialityCode")
	private org.ehealth_connector.common.hl7cdar2.CE hl7ConfidentialityCode;

	@XmlElement(name = "hl7:custodian")
	private org.ehealth_connector.common.hl7cdar2.POCDMT000040Custodian hl7Custodian;

	/**
	 * Information about the person that entered information in this CDA
	 * document. It SHALL be declared, when data recorded in this document has
	 * been entered by a person other than the author but only when this is
	 * relevant for some reason.
	 */
	@XmlElement(name = "hl7:dataEnterer")
	private org.ehealth_connector.common.hl7cdar2.POCDMT000040DataEnterer hl7DataEnterer;

	/**
	 * Information about a health service describing the context of this CDA
	 * document.
	 */
	@XmlElement(name = "hl7:documentationOf")
	...
	/**
	 * Human Patient with Non-Human Subject: The laboratory report contains test
	 * results from samples taken from a non-human material that is related to a
	 * human patient (e.g., food eaten by the patient or animal that has bitten
	 * the patient).
	 */
	...
	/**
	 * Reference to one or more orders which led to the creation of this CDA
	 * document. It SHALL be declared, when the order reference is relevant for
	 * some reason.
	 */
	@XmlElement(name = "hl7:inFulfillmentOf")
	 ...
	 * Legal authenticator.
	 */
	@XmlElement(name = "hl7:legalAuthenticator")
	...
	/**
	 * Relationship to another CDA-CH V2 based document that is replaced by the
	 * current one.Notes:For correction of wrong information, a new document
	 * that replaces the earlier document MUST be created. The new document
	 * corrects previously incorrect information. This also applies to the case
	 * where information in the CDA header has been corrected (e.g., if the
	 * original document has been issued to the wrong patient). While processing
	 * the new document at the recipient, all values from the previous document
	 * MUST be interpreted as deprecated (deleted/marked as deleted/deprecated)
	 * and all values in the new document MUST be marked as valid: - Values that
	 * were only contained in the previous document have to be treated as
	 * deleted. - Values that are present in both documents are overwritten with
	 * the contents of the new document. - Values that are only contained in the
	 * new document are to be added.
	 */
	@XmlElement(name = "hl7:relatedDocument")
	private ArrayList<org.ehealth_connector.common.hl7cdar2.POCDMT000040RelatedDocument> hl7RelatedDocument;

	/**
	 * The setId element MUST match the document id of the very first version of
	 * that document. It MUST remain the same for all document versions.
	 */
	@XmlElement(name = "hl7:setId")
	...
	/**
	 * CDA-CH-LREP / Laboratory Reports V1 specification. This is an
	 ...
	 * Framework Revision Revision 8.0 - June 21, 2017.
	 */
	@XmlElement(name = "hl7:templateId")
	...
	/**
	 * The document title must follow the following text format where &lt;human
	 * readable code&gt; is the local translation of the document LOINC code: -
	 * [de]: 'Laborbefund - &lt;human readable code&gt;' - [fr]: 'Rapport de
	 * laboratoire - &lt;human readable code&gt;' - [it]: 'Referto di
	 * laboratorio - &lt;human readable code&gt;' - [en]: 'Laboratory report -
	 * &lt;human readable code&gt;'
	 */
	@XmlElement(name = "hl7:title")
	private org.ehealth_connector.common.hl7cdar2.ST hl7Title;

	@XmlElement(name = "hl7:typeId")
	 ...
	 * version of that document. For later versions, the version number MUST be
	 * increased by 1 each.
	 */
	@XmlElement(name = "hl7:versionNumber")
	 ...
	 */
	public void addHl7DocumentationOf1(
			org.ehealth_connector.common.hl7cdar2.POCDMT000040DocumentationOf value) {
	...
	/**
	 * Adds a hl7Participant1 Information on a patient's insurance.
	 */
	public void addHl7Participant1(
			org.ehealth_connector.common.hl7cdar2.POCDMT000040Participant1 value) {
	...
	/**
	 * Adds a hl7RecordTarget1 Non-Human Subject.
	 */
	public void addHl7RecordTarget1(
			org.ehealth_connector.common.hl7cdar2.POCDMT000040RecordTarget value) {
	...
	/**
	 * Adds a hl7RecordTarget2 Human Patient with Non-Human Subject.
	 */
	public void addHl7RecordTarget2(
			org.ehealth_connector.common.hl7cdar2.POCDMT000040RecordTarget value) {
	...
	/**
	 * Gets the hl7TemplateId1 HL7 CDA R2 (2005); contains
	 * ClinicalDocument.component as structuredBody.
	 */
	...
	/**
	 * Gets the hl7TemplateId2 HL7 CDA R2 (2005).
	 */
	...
	/**
	 * Gets the hl7TemplateId3 CDA-CH-LREP / Laboratory Reports V1
	 * specification. This is an informational reference, only.
	 */
	...
	/**
	 * Gets the hl7TemplateId4 Exchange format according to the Swiss EPR
	 */
	...
	/**
	 * Gets the hl7TemplateId5 Sharing Laboratory Reports (XD-LAB) Content
	 * Module, IHE PaLM Technical Framework Revision Revision 8.0 - June 21,
	 * 2017.
	 */
	...
	/**
	 * Gets the hl7TemplateId6 CDA-CH-LREP / Laboratory Reports V1 ART-DECOR
	...
	/**
	 * Sets the hl7TemplateId1 HL7 CDA R2 (2005); contains
	 * ClinicalDocument.component as structuredBody.
	 */
	...
	/**
	 * Sets the hl7TemplateId2 HL7 CDA R2 (2005).
	 */
	...
	/**
	 * Sets the hl7TemplateId3 CDA-CH-LREP / Laboratory Reports V1
	 * specification. This is an informational reference, only.
	 */
	...
	/**
	 * Sets the hl7TemplateId4 Exchange format according to the Swiss EPR
	 */
	...
	/**
	 * Sets the hl7TemplateId5 Sharing Laboratory Reports (XD-LAB) Content
	 * Module, IHE PaLM Technical Framework Revision Revision 8.0 - June 21,
	 * 2017.
	 */
	...
	/**
	 * Sets the hl7TemplateId6 CDA-CH-LREP / Laboratory Reports V1 ART-DECOR
	 * model for General Report.
	 */
