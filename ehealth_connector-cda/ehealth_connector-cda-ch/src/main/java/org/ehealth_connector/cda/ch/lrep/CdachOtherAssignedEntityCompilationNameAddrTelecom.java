 ...
 *
 * Element description: The human-readable text MUST be generated automatically
 * from the structured information of this element. The text element MUST
 * contain the reference to the corresponding text in the human readable part,
 * ONLY.
 */
public class CdachOtherAssignedEntityCompilationNameAddrTelecom
	 ...
	 */
	public static CdachOtherAssignedEntityCompilationNameAddrTelecom loadFromFile(File inputFile)
			throws JAXBException, IOException {
		CdachOtherAssignedEntityCompilationNameAddrTelecom retVal;
		JAXBContext context = JAXBContext
				.newInstance(CdachOtherAssignedEntityCompilationNameAddrTelecom.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachOtherAssignedEntityCompilationNameAddrTelecom> root = mar.unmarshal(source,
				CdachOtherAssignedEntityCompilationNameAddrTelecom.class);
	 ...
	 */
	public static CdachOtherAssignedEntityCompilationNameAddrTelecom loadFromFile(
