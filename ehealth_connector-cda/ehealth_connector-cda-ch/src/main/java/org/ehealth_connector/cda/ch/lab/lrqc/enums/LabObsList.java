 ...
 */
/*
 * <div class="en">List of laboratory observations for the external obligatory
 * quality control</div> <div class="de">Liste der Laborbeobachtungen für die
 * externe obligatorische Qualitätskontrolle</div>
 */
public enum LabObsList {
	...
	/**
	 * <div class="en">Code for Amitriptyline+Nortriptyline [Mass/volume] in
	 * Serum or Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Blood group antibody screen [Presence] in Serum
	 * or Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Calcidiol [Moles/volume] in Serum or
	 * Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for CD3+CD4+ (T4 helper) cells/CD3+CD8+ (T8
	 * suppressor cells) cells [# Ratio] in Blood</div>.
	 */
	public static final String CD3_CD4_T4_HELPER_CELLSCD3_CD8_T8_SUPPRESSOR_CELLS_CELLS_RATIO_IN_BLOOD_CODE = "54218-3";

	/**
	 * <div class="en">Code for CD3+CD8+ (T8 suppressor cells) cells [#/volume]
	 * in Blood</div>.
	 */
	public static final String CD3_CD8_T8_SUPPRESSOR_CELLS_CELLS_VOLUME_IN_BLOOD_CODE = "14135-8";

	/**
	 * <div class="en">Code for CD3+CD8+ (T8 suppressor cells) cells/100 cells
	 * in Blood</div>.
	 */
	...
	/**
	 * <div class="en">Code for Cholecalciferol (Vit D3) [Moles/?volume] in
	 * Serum or Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Cholesterol [Mass/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Choriogonadotropin.beta subunit [Units/?volume]
	 * in Serum or Plasma</div>
	 */
	...
	/**
	 * <div class="en">Code for Chromosome analysis.interphase [interpretation]
	 * in Unspecified specimen by Fluorescent in situ hybridization (FISH)
	 * Narrative</div>
	 */
	...
	/**
	 * <div class="en">Code for Creatinine [Mass/volume] in Serum or
	 * Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Crystals.amorphous [Presence] in Urine sediment
	...
	/**
	 * <div class="en">Code for Cyclic citrullinated peptide Ab [Units/?volume]
	...
	/**
	 * <div class="en">Code for Cytomegalovirus IgG Ab [Units/?volume] in Serum
	 * by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Cytomegalovirus IgM Ab [Units/?volume] in Serum
	 * by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Desipramine [Mass/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Enterovirus RNA [Presence] in Unspecified
	 * specimen by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for Epstein Barr virus DNA [#/?volume] (viral load)
	...
	/**
	 * <div class="en">Code for Epstein Barr virus early IgG Ab [Units/?volume]
	 * in Serum</div>.
	 */
	...
	/**
	 * <div class="en">Code for Epstein Barr virus nuclear IgG Ab
	 * [Units/?volume] in Serum by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Erythrocytes [Presence] in Urine sediment by
	 * Light microscopy</div>.
	 */
	...
	/**
	 * <div class="en">Code for Erythrocytes [#/volume] in Urine by Automated
	 * test strip</div>.
	 */
	...
	/**
	 * <div class="en">Code for Ethambutol 10 ug/mL [Susceptibility] by Method
	...
	/**
	 * <div class="en">Code for Ethambutol 2 ug/mL [Susceptibility] by Method
	 * for Slow-growing mycobacteria</div>.
	 */
	public static final String ETHAMBUTOL_2_UGML_SUSCEPTIBILITY_BY_METHOD_FOR_SLOW_GROWING_MYCOBACTERIA_CODE = "55674-6";

	/**
	 * <div class="en">Code for Ethambutol 5 ug/mL [Susceptibility] by Method
	 * for Slow-growing mycobacteria</div>.
	 */
	...
	/**
	 * <div class="en">Code for Ethambutol 8 ug/mL [Susceptibility] by Method
	 * for Slow-growing mycobacteria</div>.
	 */
	public static final String ETHAMBUTOL_8_UGML_SUSCEPTIBILITY_BY_METHOD_FOR_SLOW_GROWING_MYCOBACTERIA_CODE = "56025-0";

	/**
	 * <div class="en">Code for Ethambutol+Rifampin [Susceptibility] by Method
	 * for Slow-growing mycobacteria</div>.
	 */
	...
	/**
	 * <div class="en">Code for Fibrin D-dimer FEU [Mass/volume] in Platelet
	 * poor plasma by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Fine Granular Casts [#/area] in Urine sediment
	 * by Automated count</div>.
	 */
	...
	/**
	 * <div class="en">Code for Fluoxetine [Mass/volume] in Serum or
	 * Plasma</div>.
	 */
	public static final String FLUOXETINE_MASSVOLUME_IN_SERUM_OR_PLASMA_CODE = "3644-2";

	/**
	 * <div class="en">Code for Fluoxetine [Moles/volume] in Serum or
	 * Plasma</div> .
	 */
	public static final String FLUOXETINE_MOLESVOLUME_IN_SERUM_OR_PLASMA_CODE = "14728-0";

	/**
	 * <div class="en">Code for Fluoxetine+Norfluoxetine [Mass/volume] in Serum
	 * or Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hemoglobin [Presence] in Urine by Test
	 * strip</div> .
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis A virus IgG Ab [Presence] in
	 * Serum</div> .
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis A virus IgM Ab [Presence] in
	 * Serum</div> .
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis B virus DNA [Units/?volume] (viral
	 * load) in Serum or Plasma by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis B virus DNA [#/?volume] (viral load)
	 * in Serum or Plasma by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis B virus e Ab [Units/?volume] in Serum
	 * by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis B virus e Ag [Units/?volume] in Serum
	 * by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis B virus e IgG Ab [Presence] in Serum
	 * by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis C virus Ab [Presence] in Serum or
	 * Plasma by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis C virus IgG Ab [Presence] in
	 * Serum</div> .
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis C virus RNA [Units/volume] (viral
	 * load) in Serum or Plasma by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for Hepatitis C virus RNA [#/?volume] (viral load)
	 * in Serum or Plasma by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for HIV 1+?2 Ab+?HIV1 p24 Ag [Units/?volume] in
	 * Serum by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for HIV 1+?2 Ab [Presence] in Unspecified specimen
	 * by Rapid immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for HIV 1 RNA [Units/?volume] (viral load) in Serum
	 * or Plasma by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for Isoniazid 10 ug/mL [Susceptibility] by Method
	 * for Slow-growing mycobacteria</div>.
	 */
	...
	/**
	 * <div class="en">Code for Lactate dehydrogenase [Enzymatic
	 * activity/volume] in Serum or Plasma by Pyruvate to lactate reaction</div>
	 * .
	 */
	...
	/**
	 * <div class="en">Code for Leukocytes [#/area] in Urine sediment by
	 * Automated count</div>.
	 */
	...
	/**
	 * <div class="en">Code for Leukocytes [#/volume] in Urine by Test
	 * strip</div> .
	 */
	...
	/**
	 * <div class="en">Code for Metamyelocytes/?100 leukocytes in Blood by
	 * Manual count</div>.
	 */
	 ...
	 * (MRSA) DNA [Presence] by Probe and target amplification method</div>.
	 */
	...
	/**
	 * <div class="en">Code for Mianserin [Moles/volume] in Serum or
	 * Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Mirtazapine [Mass/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Mirtazapine+Normirtazapine [Mass/volume] in
	 * Serum or Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Mixed cellular casts [Presence] in Urine
	 * sediment by Light microscopy</div>.
	 */
	public static final String MIXED_CELLULAR_CASTS_PRESENCE_IN_URINE_SEDIMENT_BY_LIGHT_MICROSCOPY_CODE = "34173-5";

	/**
	 * <div class="en">Code for Moclobemide [Mass/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Mycobacterium tuberculosis complex DNA
	...
	/**
	 * <div class="en">Code for Mycobacterium tuberculosis complex rRNA
	 * [Presence] in Unspecified specimen by DNA probe</div>.
	 */
	...
	/**
	 * <div class="en">Code for Myoglobin [Moles/volume] in Serum or
	 * Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Neutrophil cytoplasmic Ab pattern
	 * [interpretation] in Serum by Immunofluorescence</div>.
	 */
	public static final String NEUTROPHIL_CYTOPLASMIC_AB_PATTERN_INTERPRETATION_IN_SERUM_BY_IMMUNOFLUORESCENCE_CODE = "21419-7";

	/**
	 * <div class="en">Code for Neutrophil cytoplasmic Ab pattern
	 * [interpretation] in Serum by Immunofluorescence Narrative</div>.
	 */
	...
	/**
	 * <div class="en">Code for Neutrophils.segmented/?100 leukocytes in Blood
	 * by Manual count</div>
	 */
	...
	/**
	 * <div class="en">Code for Opiates [Presence] in Urine by Screen
	 * method</div> .
	 */
	...
	/**
	 * <div class="en">Code for Paroxetine [Mass/volume] in Serum or
	 * Plasma</div>.
	 */
	public static final String PAROXETINE_MASSVOLUME_IN_SERUM_OR_PLASMA_CODE = "9699-0";

	/**
	 * <div class="en">Code for Paroxetine [Moles/volume] in Serum or
	 * Plasma</div> .
	 */
	public static final String PAROXETINE_MOLESVOLUME_IN_SERUM_OR_PLASMA_CODE = "14867-6";

	/**
	 * <div class="en">Code for Peanut IgE Ab RAST class [Presence] in
	 * Serum</div> .
	 */
	...
	/**
	 * <div class="en">Code for Phosphate crystals amorphous [#/?volume] in
	 * Urine sediment</div>.
	 */
	...
	/**
	 * <div class="en">Code for Procalcitonin [Mass/volume] in Serum or Plasma
	 * by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Prolactin [Units/volume] in Serum or
	 * Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Pyrazinamide 100 ug/mL [Susceptibility] by
	 * Method for Slow-growing mycobacteria</div>.
	 */
	public static final String PYRAZINAMIDE_100_UGML_SUSCEPTIBILITY_BY_METHOD_FOR_SLOW_GROWING_MYCOBACTERIA_CODE = "25229-6";

	/**
	 * <div class="en">Code for Pyrazinamide 200 ug/mL [Susceptibility] by
	 * Method for Slow-growing mycobacteria</div>.
	 */
	...
	/**
	 * <div class="en">Code for Pyrazinamide 300 ug/mL [Susceptibility] by
	 * Method for Slow-growing mycobacteria</div>.
	 */
	...
	/**
	 * <div class="en">Code for Reboxetine [Moles/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Rubella virus IgG Ab [Units/volume] in
	 * Serum</div> .
	 */
	...
	/**
	 * <div class="en">Code for Sertraline [Mass/volume] in Serum or
	 * Plasma</div>.
	 */
	public static final String SERTRALINE_MASSVOLUME_IN_SERUM_OR_PLASMA_CODE = "6906-2";

	/**
	 * <div class="en">Code for Sertraline [Moles/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Silver Birch IgE Ab [Units/volume] in
	 * Serum</div>.
	 */
	...
	/**
	 * <div class="en">Code for Thyroperoxidase IgG Ab [Units/?volume] in Serum
	 * or Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Tissue transglutaminase IgA Ab [Units/?volume]
	 * in Serum by Immunoassay</div>.
	 */
	...
	/**
	 * <div class="en">Code for Toxoplasma gondii Ab [Units/volume] in
	 * Serum</div> .
	 */
	...
	/**
	 * <div class="en">Code for Trazodone [Moles/volume] in Serum or
	 * Plasma</div>.
	 */
	...
	/**
	 * <div class="en">Code for Treponema pallidum Ab [Units/?volume] in Serum
	 * by Latex agglutination</div>.
	 */
	...
	/**
	 * <div class="en">Code for Unidentified crystals [Presence] in Urine
	 * sediment by Light microscopy</div>.
	 */
	...
	/**
	 * <div class="en">Code for Urobilinogen [Presence] in Urine by Automated
	 * test strip</div>.
	 */
	...
	/**
	 * <div class="en">Code for Venlafaxine [Mass/volume] in Serum or
	 * Plasma</div> .
	 */
	...
	/**
	 * <div class="en">Code for Venlafaxine+Norvenlafaxine [Mass/volume] in
	 * Serum or Plasma</div>.
	 */
	public static final String VENLAFAXINE_NORVENLAFAXINE_MASSVOLUME_IN_SERUM_OR_PLASMA_CODE = "62849-5";

	/**
	 * <div class="en">Code for Venlafaxine+Norvenlafaxine [Moles/volume] in
	 * Serum or Plasma</div>.
	 */
