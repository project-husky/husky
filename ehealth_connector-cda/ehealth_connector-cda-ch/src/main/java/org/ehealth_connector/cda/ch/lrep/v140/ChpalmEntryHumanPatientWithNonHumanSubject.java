 ...
 * declared using this element in the CDA body.The non-human subject SHALL also
 * be represented in the CDA header by using the IHE template "Non-Human
 * Subject" (1.3.6.1.4.1.19376.1.3.3.1.2).Other parts of the document may
 * contain laboratory observations that base on other samples (including samples
 * taken from the patient).In addition, the IHE recordTarget template "Human
 * Patient with Non-Human Subject" (1.3.6.1.4.1.19376.1.3.3.1.3) MUST be used in
 * the CDA header.
 */
public class ChpalmEntryHumanPatientWithNonHumanSubject
	...
	public ChpalmEntryHumanPatientWithNonHumanSubject() {
		super.getTemplateId().add(createHl7TemplateIdFixedValue("2.16.756.5.30.1.1.10.4.6"));
