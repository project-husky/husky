...
public class ChpalmEntryHumanPatientWithNonHumanSubject
	 ...
	 */
	public static ChpalmEntryHumanPatientWithNonHumanSubject loadFromFile(File inputFile)
			throws JAXBException, IOException {
		ChpalmEntryHumanPatientWithNonHumanSubject retVal;
		JAXBContext context = JAXBContext
				.newInstance(ChpalmEntryHumanPatientWithNonHumanSubject.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<ChpalmEntryHumanPatientWithNonHumanSubject> root = mar.unmarshal(source,
				ChpalmEntryHumanPatientWithNonHumanSubject.class);
	 ...
	 */
	public static ChpalmEntryHumanPatientWithNonHumanSubject loadFromFile(String inputFileName)
			throws JAXBException, IOException {
