...
/**
 * <!-- @formatter:off -->
 * <div class="en"><p>    <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>Hypersensitivity resulting in an adverse reaction upon exposure to an agent.</p></div>
...
public enum ObservationIntoleranceType implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for intolerance</div>
	 * <!-- @formatter:on -->
	 */
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "2.16.840.1.113883.1.11.19700";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "ObservationIntoleranceType";
	 ...
	 */
	public static ObservationIntoleranceType getEnum(String code) {
		for (final ObservationIntoleranceType x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(ObservationIntoleranceType.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	ObservationIntoleranceType(String code, String codeSystem, String displayName,
