...
public class ChpalmEntryLaboratoryPerformer extends org.ehealth_connector.common.hl7cdar2.II {
	 ...
	 */
	public static ChpalmEntryLaboratoryPerformer loadFromFile(File inputFile)
		...
		JAXBElement<ChpalmEntryLaboratoryPerformer> root = mar.unmarshal(source,
				ChpalmEntryLaboratoryPerformer.class);
	 ...
	 */
	public static ChpalmEntryLaboratoryPerformer loadFromFile(String inputFileName)
			throws JAXBException, IOException {
