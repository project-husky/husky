...
public class CdaChMtpsPadv
		extends AbstractCdaChV1<org.openhealthtools.mdht.uml.cda.ch.CdaChMtpsV1Padv> {
	 ...
	 *            the MDHT document
	 */
	public CdaChMtpsPadv(org.openhealthtools.mdht.uml.cda.ch.CdaChMtpsV1Padv doc) {
		super(doc);
	}
