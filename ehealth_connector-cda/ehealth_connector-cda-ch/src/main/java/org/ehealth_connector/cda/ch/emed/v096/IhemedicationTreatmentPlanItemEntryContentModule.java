...
/**
 * Original ART-DECOR template id: 1.3.6.1.4.1.19376.1.9.1.3.7 Template
 * description: <div>A Medication Treatment Plan Item belongs to one medication
 * treatment plan and represents one medication. It may be associated with one
 * or more observations. A Medication Treatment Plan Item describes the medicine
 * and dosage information as well as other information such as patient and
 * optionally fulfillment instructions.</div>
 *
...
public class IhemedicationTreatmentPlanItemEntryContentModule
	...
	/**
	 * Sets the hl7EntryRelationship Reason
	 */
