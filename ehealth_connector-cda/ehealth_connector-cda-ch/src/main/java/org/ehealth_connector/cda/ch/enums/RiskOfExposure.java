...
public enum RiskOfExposure {
	 ...
	 */
	ENGE_KONTAKTPERSONEN_VON_MENINGOKOKKEN_ERKRANKTEN("213028",
			"enge Kontaktpersonen von Meningokokken-Erkrankten", "Méningocoques dans l'entourage",
			"Meningococco nell'entourage", "20150101", ""),
	/**
	 ...
	 * territoires endémiques</div> <div class="it">Adulti e bambini a partire
	 * dai 6 anni che risiedono o soggiornano in regioni endemiche</div>
	 */
	 ...
	 * Kläranlagen</div> <div class="fr">Travailleurs des canalisationset des
	 ...
	 */
	KINDERKRIPPE_HORT_VOR_5_MONATEN("213031", "Kinderkrippe/Hort vor 5 Monaten",
			"Crèche/garderie avant 5 mois", "Asilo nido prima di 5 mesi", "20150101", ""),
	/**
	 * <div class="de">Konsumenten von injizierbaren Drogen und deren
	 * Kontaktpersonen</div> <div class="fr">Consommateurs de drogues
	 * injectables et personnes à leur contact</div> <div class="it">Consumatori
	 * di droghe iniettabili e persone a loro contatto</div>
	 */
	 ...
	 */
	KONTAKTPERSONEN_VON_EINER_SCHWANGEREN_FRAU("213032",
			"Kontaktpersonen von einer schwangeren Frau", "Entourage d'une femme enceinte",
			"Entourage di una donna incinta", "20150101", ""),
	/**
	 * <div class="de">Kontaktpersonen von Hepatitis-A-Erkrankten</div>
	 * <div class="fr">Hépatite A dans l'entourage</div> <div class="it">Epatite
	 * A nell'entourage </div>
	 */
	KONTAKTPERSONEN_VON_HEPATITIS_A_ERKRANKTEN("213027",
			"Kontaktpersonen von Hepatitis-A-Erkrankten", "Hépatite A dans l'entourage",
			"Epatite A nell'entourage", "20150101", ""),
	/**
	 * <div class="de">Kontaktpersonen von Hepatitis-B-Erkrankten</div>
	 * <div class="fr">Hépatite B dans l'entourage</div> <div class="it">Epatite
	 * B nell'entourage </div>
	 */
	KONTAKTPERSONEN_VON_HEPATITIS_B_ERKRANKTEN("213026",
			"Kontaktpersonen von Hepatitis-B-Erkrankten", "Hépatite B dans l'entourage",
			"Epatite B nell'entourage", "20150101", ""),
	/**
	 ...
	 */
	LABORPERSONAL_MIT_BAKTERIEN_EXPOSITIONSRISIKO("213030",
			"Laborpersonal mit Bakterien-Expositionsrisiko",
			"Personnel de laboratoire exposé aux bactéries",
			"Personale di laboratorio esposto ai batteri", "20150101", ""),
	/**
	 ...
	 */
	LABORPERSONAL_MIT_VIRUS_EXPOSITIONSRISIKO("213029", "Laborpersonal mit Virus-Expositionsrisiko",
			"Personnel de laboratoire exposé aux virus",
			"Personale di laboratorio esposto ai virus", "20150101", ""),
	/**
	 ...
	 */
	MITARBEITENDE_VON_KINDERKRIPPEN("213033", "Mitarbeitende von Kinderkrippen",
			"Professionnels de la petite enfance", "Professionisti della prima infanzia",
			"20150101", ""),
	/**
	 ...
	 * zurückkehren (in ihrem ersten Lebensjahr ) </div> <div class="fr">Nouveau
	 * - nés ou nourrissons &lt; 12 mois originaire d’un pays à haute endémie et
	 ...
	 */
	NEUGEBORENE_VON_HBSAG_POSITIVEN_MUETTERN("213025", "Neugeborene von HBsAg-positiven Müttern",
			"Nouveau-nés de mères HBsAg positives", "Neonati di madri HBsAg positive", "20150101",
			""),
	/**
	 ...
	 */
	PERSONEN_MIT_EINER_SEXUELL_UEBERTRAGBAREN_KRANKHEIT("213017",
	 ...
	 */
	PERSONEN_MIT_HAEUFIG_WECHSELNDEN_SEXUALPARTNERN("213019",
	 ...
	 */
	REKRUTEN_MILITAER("213021", "Rekruten (Militär)", "Recrues (militaires)", "Reclute (militari)",
			"20130101", ""),
	/**
	 ...
	 * injectables</div> <div class="it">Lavoratori nel campo socio - educativo
	 * o della sicurezza (carceri, polizia) a contatto frequente con dei
	 ...
	 */
	TIERAERZTE_INKL_STUDENTEN_PRAXISANGESTELLTE("213023",
	 ...
	 *
	 * @param languageCode
	 *            the language code to get the display name for @return returns
	 *            the display name in the desired language. if language not
