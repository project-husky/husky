...
public enum RiskOfExposure {
	 ...
	 */
	BESCHAEFTIGTE_IM_GESUNDHEITSWESEN("213001", "Beschäftigte im Gesundheitswesen",
	 ...
	 * <div class="it">Adulti e bambini a partire dai 6 anni che risiedono o soggiornano in regioni endemiche</div>
	 */
	ERWACHSENE_UND_KINDER_AB_6_JAHREN_DIE_IN_ENDEMIEGEBIET_WOHNEN_ODER_SICH_TEILWEISE_DORT_AUFHALTEN(
			...
			"20130101", ""),
	/**
	 * <div class="de">Familienangehörige von Personen mit einem erhöhten Risiko</div>
	 * <div class="fr">Entourage familial des personnes à risque accru de complications</div>
	 * <div class="it">Entourage famigliare di persone a maggiore rischio di complicazioni</div>
	 */
	 ...
	 * <div class="it">Ricercatori che svolgono ricerche sui chirotteri, protettori o appassionati di pipistrelli</div>
	 */
	FLEDERMAUSFORSCHER_UND_SCHUETZER("213006", "Fledermausforscher und -schützer",
	 ...
	 * <div class="it">Persone disabili mentali e personale degli istituti per disabili mentali</div>
	 */
	GEISTIG_BEHINDERTE_PERSONEN_IN_HEIMEN_UND_DEREN_BETREUERINNEN("213007",
			...
			"Persone disabili mentali e personale degli istituti per disabili mentali",
			"20130101", ""),
	/**
	 * <div class="de">Kanalisationsarbeiter und Angestellte von Kläranlagen</div>
	 * <div class="fr">Travailleurs des canalisationset des stations d’épuration</div>
	 * <div class="it">Personale addetto alla manutenzione delle fognature e delle stazioni di depurazione</div>
	 */
	KANALISATIONSARBEITER_UND_ANGESTELLTE_VON_KLAERANLAGEN("213010",
	 ...
	 * <div class="it">Bambini originari di paesi di media ed elevata endemicità che vivono in Svizzera e che ritornano nel loro
	 * paese per dei soggiorni temporanei</div>
	 */
	 ...
	 * <div class="it">Consumatori di droghe iniettabili e persone a loro contatto</div>
	 */
	KONSUMENTEN_VON_INJIZIERBAREN_DROGEN_UND_DEREN_KONTAKTPERSONEN(
			...
			"Consumatori di droghe iniettabili e persone a loro contatto",
			"20130101", ""),
	/**
	 ...
	 * <div class="it">Uomini che hanno rapporti sessuali con altri uomini</div>
	 */
	MAENNER_DIE_MIT_MAENNERN_GESCHLECHTSVERKEHR_HABEN("213014",
			"Männer, die mit Männern Geschlechtsverkehr haben",
			"Hommes ayant des relations sexuelles avec d’autres hommes",
			"Uomini che hanno rapporti sessuali con altri uomini",
			"20130101", ""),
	/**
	 * <div class="de">Patientinnen und Patienten in Pflegeheimen und in Einrichtungen für Personen mit chronischen
	 * Erkrankungen </div>
	 * <div class="fr">Patients résidant dans une maison de soins ou dans un établissement pour malades
	 * chroniques</div>
	 * <div class="it">Ospiti di una casa di cura o di un istituto per malati cronici</div>
	 */
	PATIENTINNEN_UND_PATIENTEN_IN_PFLEGEHEIMEN_UND_IN_EINRICHTUNGEN_FUER_PERSONEN_MIT_CHRONISCHEN_ERKRANKUNGEN(
			...
			"Ospiti di una casa di cura o di un istituto per malati cronici",
			"20130101", ""),
	/**
	 ...
	 * <div class="it">Persone provenienti da zone di endemicità elevata o intermedia per l’ epatite B</div>
	 */
	 ...
	 * <div class="it">Persone che consultano per una malattia sessualmente trasmissibile</div>
	 */
	PERSONEN_MIT_EINER_SEXUELL_UEBERTRAGBAREN_KRANKHEIT(
			...
			"Persone che consultano per una malattia sessualmente trasmissibile",
			"20130101", ""),
	/**
	 * <div class="de">Personen mit engem Kontakt zu Personen aus Ländern mit hoher Endemizität</div>
	 * <div class="fr">Personnes en contact étroit avec des personnes en provenance de pays de haute
	 * endémicité</div>
	 * <div class="it">Persone a stretto contatto con delle persone provenienti da paesi di endemicità
	 * elevata</div>
	 */
	...
	PERSONEN_MIT_HAEUFIG_WECHSELNDEN_SEXUALPARTNERN(
			...
			"Persone che cambiano spesso partner sessuale",
			"20130101", ""),
	/**
	 * <div class="de">Personen mit regelmässigem Kontakt (beruflich / familiär) zu Säuglingen
	 * &lt; 6 Monaten, schwangere Frauen </div>
	 * <div class="fr">Personnes en contact professionnel ou familial régulier avec des
	 * nourrissons &lt; 6 mois, femmes
	 * enceintes </div>
	 * <div class="it">Personale in contatto professionale o famigliare con dei lattanti di meno
	 * di 6 mesi o con donne incinte </div>
	 */
	 ...
	 * <div class="it">Reclute (militari)</div>
	 */
	REKRUTEN_MILITAER("213021",
			"Rekruten (Militär)",
			"Recrues (militaires)",
			"Reclute (militari)", "20130101",
			""),
	/**
	 * <div class="de">Sozialarbeiter, Gefängnispersonal und Polizeiangestellte mit
	 * häufigem Kontakt zu Konsumenten von injizierbaren Drogen</div>
	 * <div class="fr">Travailleurs sociaux, personnel des prisons et de la police en
	...
	TIERAERZTE_INKL_STUDENTEN_PRAXISANGESTELLTE(
			...
			"Veterinari (studenti, assistenti veterinari)",
			"20130101", ""),
	/**
	 * <div class="de">Neugeborene und Säuglinge unter 12 Monaten aus Ländern
	 * mit hoher Tuberkulose prävalenz, die wahrscheinlich wieder
	 * dorthin zurückkehren (in ihrem ersten Lebensjahr ) </div>
	 * <div class="fr">Nouveau - nés ou nourrissons &lt; 12 mois originaire d’un
	 * pays à haute endémie et susceptibles d’y retourner dans leur 1ère
	 * année de vie </div>
	 * <div class="it">Neonati o lattanti &lt; 12 mesi originari di un paese a
	 * elevata endemia e suscettibili di ritornarci nel loro primo anno di vita
	 * </div>
	 */
	...
	NEUGEBORENE_VON_HBSAG_POSITIVEN_MUETTERN(
			...
			"Neonati di madri HBsAg positive",
			"20150101", ""),
	/**
	 * <div class="de">Kontaktpersonen von Hepatitis-B-Erkrankten</div>
	 * <div class="fr">Hépatite B dans l'entourage</div>
	 * <div class="it">Epatite B nell'entourage </div>
	 */
	KONTAKTPERSONEN_VON_HEPATITIS_B_ERKRANKTEN(
			"213026",
			"Kontaktpersonen von Hepatitis-B-Erkrankten",
			"Hépatite B dans l'entourage",
			"Epatite B nell'entourage",
			"20150101",
			""),
	/**
	 * <div class="de">Kontaktpersonen von Hepatitis-A-Erkrankten</div>
	 * <div class="fr">Hépatite A dans l'entourage</div>
	 * <div class="it">Epatite A nell'entourage </div>
	 */
	KONTAKTPERSONEN_VON_HEPATITIS_A_ERKRANKTEN(
			"213027",
			"Kontaktpersonen von Hepatitis-A-Erkrankten",
			"Hépatite A dans l'entourage",
			"Epatite A nell'entourage",
			"20150101",
			""),
	/**
	...
	ENGE_KONTAKTPERSONEN_VON_MENINGOKOKKEN_ERKRANKTEN(
			"213028",
			"enge Kontaktpersonen von Meningokokken-Erkrankten",
			"Méningocoques dans l'entourage",
			"Meningococco nell'entourage",
			"20150101",
			""),
	/**
	...
	LABORPERSONAL_MIT_VIRUS_EXPOSITIONSRISIKO(
			"213029",
			"Laborpersonal mit Virus-Expositionsrisiko",
			"Personnel de laboratoire exposé aux virus",
			"Personale di laboratorio esposto ai virus",
			"20150101",
			""),
	/**
	...
	LABORPERSONAL_MIT_BAKTERIEN_EXPOSITIONSRISIKO(
			"213030",
			"Laborpersonal mit Bakterien-Expositionsrisiko",
			"Personnel de laboratoire exposé aux bactéries",
			"Personale di laboratorio esposto ai batteri",
			"20150101",
			""),
	/**
	 * <div class="de">Kinderkrippe / Hort vor 5 Monaten</div>
	 * <div class="fr">Crèche / garderie avant 5 mois </div>
	 * <div class="it">Asilo nido prima di 5 mesi</div>
	 */
	KINDERKRIPPE_HORT_VOR_5_MONATEN(
			"213031",
			"Kinderkrippe/Hort vor 5 Monaten",
			"Crèche/garderie avant 5 mois",
			"Asilo nido prima di 5 mesi",
			"20150101",
			""),
	/**
	...
	KONTAKTPERSONEN_VON_EINER_SCHWANGEREN_FRAU(
			"213032",
			"Kontaktpersonen von einer schwangeren Frau",
			"Entourage d'une femme enceinte",
			"Entourage di una donna incinta",
			"20150101",
			""),
	/**
	 ...
	 */
	MITARBEITENDE_VON_KINDERKRIPPEN(
			"213033",
			"Mitarbeitende von Kinderkrippen",
	 ...
	 *
	 * @param code <br><div class="de">code</div>
	...
	/**
	 * <div class="en">Gets the display name defined by the language param. If language is unknow, german name is returned</div>
	 * <div class="de">Liefert display name gemäss Parameter, falls die Sprache unbekannt ist, wird standartmässig deutsch geliefert.</div>@param <div class="en">The language
	 * code.</div>
	 * 
	 * 
	 * @param languageCode the language code to get the display name for @return returns the display name in the desired language. if language not
