...
public class CdachvacdSectionOtherRelevantObservationsCoded
	 ...
	 */
	public static CdachvacdSectionOtherRelevantObservationsCoded loadFromFile(File inputFile)
			throws JAXBException, IOException {
		CdachvacdSectionOtherRelevantObservationsCoded retVal;
		JAXBContext context = JAXBContext
				.newInstance(CdachvacdSectionOtherRelevantObservationsCoded.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachvacdSectionOtherRelevantObservationsCoded> root = mar.unmarshal(source,
				CdachvacdSectionOtherRelevantObservationsCoded.class);
	 ...
	 */
	public static CdachvacdSectionOtherRelevantObservationsCoded loadFromFile(String inputFileName)
			throws JAXBException, IOException {
		return loadFromFile(new File(inputFileName));
	}

	public CdachvacdSectionOtherRelevantObservationsCoded() {
		setHl7TemplateIdFixedValue("2.16.756.5.30.1.1.10.3.46");
		setHl7TemplateIdFixedValue("1.3.6.1.4.1.19376.1.5.3.1.3.27");
		setHl7TemplateIdFixedValue("1.3.6.1.4.1.19376.1.5.3.1.3.28");
		setHl7CodeFixedValue("30954-2", "2.16.840.1.113883.6.1", "LOINC",
