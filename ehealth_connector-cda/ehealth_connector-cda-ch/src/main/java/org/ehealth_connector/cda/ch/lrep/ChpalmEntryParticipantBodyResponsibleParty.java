...
public class ChpalmEntryParticipantBodyResponsibleParty extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ParticipantRole {
	 ...
	 */
	public static ChpalmEntryParticipantBodyResponsibleParty loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static ChpalmEntryParticipantBodyResponsibleParty loadFromFile(File inputFile) throws JAXBException, IOException {
		ChpalmEntryParticipantBodyResponsibleParty retVal;
		JAXBContext context = JAXBContext.newInstance(ChpalmEntryParticipantBodyResponsibleParty.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<ChpalmEntryParticipantBodyResponsibleParty> root = mar.unmarshal(source, ChpalmEntryParticipantBodyResponsibleParty.class);
