...
public class CdachOtherOrganizationCompilationWithNameAddrTelecom
	 ...
	 */
	public static CdachOtherOrganizationCompilationWithNameAddrTelecom loadFromFile(File inputFile)
			throws JAXBException, IOException {
		CdachOtherOrganizationCompilationWithNameAddrTelecom retVal;
		JAXBContext context = JAXBContext
				.newInstance(CdachOtherOrganizationCompilationWithNameAddrTelecom.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachOtherOrganizationCompilationWithNameAddrTelecom> root = mar
				.unmarshal(source, CdachOtherOrganizationCompilationWithNameAddrTelecom.class);
	 ...
	 */
	public static CdachOtherOrganizationCompilationWithNameAddrTelecom loadFromFile(
