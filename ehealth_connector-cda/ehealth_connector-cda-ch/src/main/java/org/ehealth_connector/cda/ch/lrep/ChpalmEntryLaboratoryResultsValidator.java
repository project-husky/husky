...
public class ChpalmEntryLaboratoryResultsValidator
	 ...
	 */
	public static ChpalmEntryLaboratoryResultsValidator loadFromFile(File inputFile)
		...
		JAXBElement<ChpalmEntryLaboratoryResultsValidator> root = mar.unmarshal(source,
				ChpalmEntryLaboratoryResultsValidator.class);
	 ...
	 */
	public static ChpalmEntryLaboratoryResultsValidator loadFromFile(String inputFileName)
			throws JAXBException, IOException {
