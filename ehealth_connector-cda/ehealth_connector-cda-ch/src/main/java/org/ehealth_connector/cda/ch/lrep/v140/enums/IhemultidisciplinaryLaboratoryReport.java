...
public enum IhemultidisciplinaryLaboratoryReport implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for LABORATORY REPORT.TOTAL</div>
	 * <!-- @formatter:on -->
	 */
	public static final String LABORATORY_REPORT_TOTAL_CODE = "11502-2";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "1.3.6.1.4.1.19376.1.3.11.6";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "IHEMultidisciplinaryLaboratoryReport";
	 ...
	 */
	public static IhemultidisciplinaryLaboratoryReport getEnum(String code) {
		for (final IhemultidisciplinaryLaboratoryReport x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(IhemultidisciplinaryLaboratoryReport.class, enumName);
			return true;
