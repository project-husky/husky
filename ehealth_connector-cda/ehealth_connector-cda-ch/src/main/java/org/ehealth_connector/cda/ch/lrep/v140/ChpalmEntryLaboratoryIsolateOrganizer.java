...
public class ChpalmEntryLaboratoryIsolateOrganizer
	...
	/**
	 * Gets the hl7EffectiveTime Time of results on this isolate (for all
	 * results in this result group).
	 */
	...
	/**
	 * Sets the hl7EffectiveTime Time of results on this isolate (for all
	 * results in this result group).
	 */
