...
public class ActiveProblemConcern extends ProblemConcern {
	 ...
	 * 
	 */
	public ActiveProblemConcern(org.openhealthtools.mdht.uml.cda.ihe.ProblemConcernEntry problemConcernEntry) {
	 ...
	 */
	public ActiveProblemConcern(String concern, Date begin, Date end, AbstractProblemEntry problemEntry,
	 ...
	 */
	public ActiveProblemConcern(String concern, Date date, AbstractProblemEntry problemEntry, ProblemConcernStatusCode problemStatusCode) {
	 ...
	 *            <div class="it"> problem status code</div>
	 */
	public ActiveProblemConcern(String concern, AbstractProblemEntry problemEntry, ProblemConcernStatusCode concernStatus) {
