...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.13
...
public class MedicationListDocument extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ClinicalDocument {
	...
	// MedicationListDocument/hl7:typeId:uid root = "2.16.840.1.113883.1.3";
	// MedicationListDocument/hl7:typeId:st extension = "POCD_HD000040";
	// MedicationListDocument/hl7:templateId:uid root = "2.16.756.5.30.1.127.1.4";
	 ...
	 */
	public static MedicationListDocument loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static MedicationListDocument loadFromFile(File inputFile) throws JAXBException, IOException {
		MedicationListDocument retVal;
		JAXBContext context = JAXBContext.newInstance(MedicationListDocument.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<MedicationListDocument> root = mar.unmarshal(source, MedicationListDocument.class);
