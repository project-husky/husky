...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.5
...
public class MedicationDispenseDocument extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ClinicalDocument {
	...
	// MedicationDispenseDocument/hl7:typeId:uid root = "2.16.840.1.113883.1.3";
	// MedicationDispenseDocument/hl7:typeId:st extension = "POCD_HD000040";
	// MedicationDispenseDocument/hl7:templateId:uid root = "2.16.756.5.30.1.127.1.4";
	// MedicationDispenseDocument/hl7:templateId:uid root = "1.3.6.1.4.1.19376.1.5.3.1.1.1";
	// MedicationDispenseDocument/hl7:templateId:uid root = "1.3.6.1.4.1.19376.1.9.1.1.3";
	// MedicationDispenseDocument/hl7:templateId:uid root = "2.16.756.5.30.1.1.10.1.5";
	 ...
	 */
	public static MedicationDispenseDocument loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static MedicationDispenseDocument loadFromFile(File inputFile) throws JAXBException, IOException {
		MedicationDispenseDocument retVal;
		JAXBContext context = JAXBContext.newInstance(MedicationDispenseDocument.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<MedicationDispenseDocument> root = mar.unmarshal(source, MedicationDispenseDocument.class);
