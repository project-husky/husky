...
public class ChpalmEntrySpecimenType extends org.ehealth_connector.common.hl7cdar2.CE {
	 ...
	 */
	public static ChpalmEntrySpecimenType loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static ChpalmEntrySpecimenType loadFromFile(File inputFile) throws JAXBException, IOException {
		ChpalmEntrySpecimenType retVal;
		JAXBContext context = JAXBContext.newInstance(ChpalmEntrySpecimenType.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<ChpalmEntrySpecimenType> root = mar.unmarshal(source, ChpalmEntrySpecimenType.class);
