...
public class ChpccEntryPregnancyObservation extends org.ehealth_connector.common.hl7cdar2.POCDMT000040Observation {
	 ...
	 */
	public static ChpccEntryPregnancyObservation loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static ChpccEntryPregnancyObservation loadFromFile(File inputFile) throws JAXBException, IOException {
		...
		JAXBElement<ChpccEntryPregnancyObservation> root = mar.unmarshal(source, ChpccEntryPregnancyObservation.class);
