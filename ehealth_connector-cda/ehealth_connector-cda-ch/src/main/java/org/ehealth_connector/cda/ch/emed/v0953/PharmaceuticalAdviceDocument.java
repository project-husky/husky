...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.6
...
public class PharmaceuticalAdviceDocument extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ClinicalDocument {
	...
	// PharmaceuticalAdviceDocument/hl7:typeId:st extension = "POCD_HD000040";
	// PharmaceuticalAdviceDocument/hl7:templateId:uid root = "2.16.756.5.30.1.127.1.4";
	 ...
	 */
	public static PharmaceuticalAdviceDocument loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static PharmaceuticalAdviceDocument loadFromFile(File inputFile) throws JAXBException, IOException {
		PharmaceuticalAdviceDocument retVal;
		JAXBContext context = JAXBContext.newInstance(PharmaceuticalAdviceDocument.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<PharmaceuticalAdviceDocument> root = mar.unmarshal(source, PharmaceuticalAdviceDocument.class);
