...
public enum XdsTypeCo implements ValueSetEnumInterface {
	 ...
	 * <!-- @formatter:on -->
	 */
	IMAGING_ORDER("2161000195103", "2.16.756.5.30.1.127.3.4", "Imaging Order (record articact)", "Imaging Order", "TODO", "TODO", "TODO"),
	/**
	 * <!-- @formatter:off -->
	 ...
	 * <!-- @formatter:on -->
	 */
	IMAGING_REPORT("4201000179104", "2.16.840.1.113883.6.96", "Imaging report (record artifact)", "Imaging report", "TODO", "TODO", "TODO"),
	/**
	 * <!-- @formatter:off -->
	 ...
	 */
	public static XdsTypeCo getEnum(String code) {
		for (final XdsTypeCo x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(XdsTypeCo.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	XdsTypeCo(String code, String codeSystem, String displayName, String displayNameEn, String displayNameDe, String displayNameFr, String displayNameIt) {
		this.code = code;
