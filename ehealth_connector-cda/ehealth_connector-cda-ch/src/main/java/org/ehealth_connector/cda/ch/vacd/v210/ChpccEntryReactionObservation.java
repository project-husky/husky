...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.4.120 Template
...
public class ChpccEntryReactionObservation
	...
	public ChpccEntryReactionObservation() {
		...
		super.getTemplateId().add(createHl7TemplateIdFixedValue("2.16.756.5.30.1.1.10.4.120"));
	...
	/**
	 * Adds a hl7EntryRelationship Antigen doses applicable.
	 */
	...
	/**
	 * Adds a hl7Id Each adverse reaction SHALL have an identifier.
	 */
