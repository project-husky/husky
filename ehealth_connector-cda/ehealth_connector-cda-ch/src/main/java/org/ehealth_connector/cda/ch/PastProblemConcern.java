...
public class PastProblemConcern extends ProblemConcern {
	 ...
	 * 
	 */
	public PastProblemConcern(org.openhealthtools.mdht.uml.cda.ihe.ProblemConcernEntry problemConcernEntry) {
	 ...
	 */
	public PastProblemConcern(String concern, AbstractProblemEntry problemEntry, ProblemConcernStatusCode concernStatus) {
	 ...
	 */
	public PastProblemConcern(String concern, AbstractProblemEntry problemEntry, ProblemConcernStatusCode concernStatus, Date begin, Date end) {
