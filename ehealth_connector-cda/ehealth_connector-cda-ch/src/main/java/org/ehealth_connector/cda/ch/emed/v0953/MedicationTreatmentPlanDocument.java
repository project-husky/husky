...
public class MedicationTreatmentPlanDocument extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ClinicalDocument {
	...
	// MedicationTreatmentPlanDocument/hl7:typeId:uid root = "2.16.840.1.113883.1.3";
	// MedicationTreatmentPlanDocument/hl7:typeId:st extension = "POCD_HD000040";
	// MedicationTreatmentPlanDocument/hl7:templateId:uid root = "2.16.756.5.30.1.127.1.4";
	// MedicationTreatmentPlanDocument/hl7:templateId:uid root = "1.3.6.1.4.1.19376.1.5.3.1.1.1";
	// MedicationTreatmentPlanDocument/hl7:templateId:uid root = "1.3.6.1.4.1.19376.1.9.1.1.6";
	// MedicationTreatmentPlanDocument/hl7:templateId:uid root = "2.16.756.5.30.1.1.10.1.7";
	}
	 ...
	 */
	public void addHl7Authorization(org.ehealth_connector.common.hl7cdar2.POCDMT000040Authorization value) {
	 ...
	 * Adds a hl7Informant
	 */
	public void addHl7Informant(org.ehealth_connector.common.hl7cdar2.POCDMT000040Informant12 value) {
	 ...
	 */
	public org.ehealth_connector.common.hl7cdar2.POCDMT000040Component1 getHl7ComponentOf() {
		return componentOf;
	}
	 ...
	 */
	public static MedicationTreatmentPlanDocument loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static MedicationTreatmentPlanDocument loadFromFile(File inputFile) throws JAXBException, IOException {
		...
		JAXBElement<MedicationTreatmentPlanDocument> root = mar.unmarshal(source, MedicationTreatmentPlanDocument.class);
	 ...
	 */
	public void setHl7ComponentOf(org.ehealth_connector.common.hl7cdar2.POCDMT000040Component1 value) {
	 ...
	 * - PseudonymizingIn special cases, the demographic data of the patient are not allowed to be transmitted or they have to be pseudonymized.While HL7 CDA or its derivatives like CDA-CH or Swiss exchange formats nevertheless require these elements in the XML structure, the affected values MUST be replaced by a nullFlavor of type "MSK" (masked), in order to support the required data format structure and simultaneously to shield the real data.
	 */
	public void setHl7RecordTarget(org.ehealth_connector.common.hl7cdar2.POCDMT000040RecordTarget value) {
