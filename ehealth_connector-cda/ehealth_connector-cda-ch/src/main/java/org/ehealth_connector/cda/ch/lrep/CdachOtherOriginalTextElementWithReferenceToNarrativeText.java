...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.9.49
...
public class CdachOtherOriginalTextElementWithReferenceToNarrativeText extends org.ehealth_connector.common.hl7cdar2.ED {
	 ...
	 */
	public static CdachOtherOriginalTextElementWithReferenceToNarrativeText loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static CdachOtherOriginalTextElementWithReferenceToNarrativeText loadFromFile(File inputFile) throws JAXBException, IOException {
		CdachOtherOriginalTextElementWithReferenceToNarrativeText retVal;
		JAXBContext context = JAXBContext.newInstance(CdachOtherOriginalTextElementWithReferenceToNarrativeText.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachOtherOriginalTextElementWithReferenceToNarrativeText> root = mar.unmarshal(source, CdachOtherOriginalTextElementWithReferenceToNarrativeText.class);
