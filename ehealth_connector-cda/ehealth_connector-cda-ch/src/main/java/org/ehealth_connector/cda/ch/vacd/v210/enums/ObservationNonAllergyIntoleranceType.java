...
/**
 * <!-- @formatter:off -->
 * <div class="en"><p>    <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>Hypersensitivity to an agent caused by a mechanism other than an immunologic response to an initial exposure</p></div>
...
public enum ObservationNonAllergyIntoleranceType implements ValueSetEnumInterface {
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String NON_ALLERGY_INTOLERANCE_CODE = "NAINT";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "2.16.840.1.113883.1.11.19702";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "ObservationNonAllergyIntoleranceType";
	 ...
	 */
	public static ObservationNonAllergyIntoleranceType getEnum(String code) {
		for (final ObservationNonAllergyIntoleranceType x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(ObservationNonAllergyIntoleranceType.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	ObservationNonAllergyIntoleranceType(String code, String codeSystem, String displayName,
