...
public class Participant extends MdhtFacade<Participant1> {
	...
	/**
	 * Instantiates the class with the required elements. Use this constructor, if
	 * you don´t want to get refunds from the OKP. The GLN will be added under
	...
	/**
	 * Instantiates the class with the required elements. Use this constructor, if
	 * you want to get refunds from the OKP. The GLN (of your laboratory) will be
	 * added under participant/associatedEntity/id. The zsr will be added under
	 * the same element (participant/associatedEntity/id).
	 *
	 * @param gln
	 *          the GLN id (extension)
	 * @param zsr
