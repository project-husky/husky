...
public class ChpalmHeaderLaboratoryResultsValidator
	 ...
	 */
	public static ChpalmHeaderLaboratoryResultsValidator loadFromFile(File inputFile)
		...
		JAXBElement<ChpalmHeaderLaboratoryResultsValidator> root = mar.unmarshal(source,
				ChpalmHeaderLaboratoryResultsValidator.class);
	 ...
	 */
	public static ChpalmHeaderLaboratoryResultsValidator loadFromFile(String inputFileName)
			throws JAXBException, IOException {
