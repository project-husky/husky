...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.3
...
public class MedicationCardDocument extends org.ehealth_connector.common.hl7cdar2.POCDMT000040ClinicalDocument {
	...
	// MedicationCardDocument/hl7:typeId:uid root = "2.16.840.1.113883.1.3";
	// MedicationCardDocument/hl7:typeId:st extension = "POCD_HD000040";
	// MedicationCardDocument/hl7:templateId:uid root = "2.16.756.5.30.1.127.1.4";
	 ...
	 */
	public static MedicationCardDocument loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static MedicationCardDocument loadFromFile(File inputFile) throws JAXBException, IOException {
		MedicationCardDocument retVal;
		JAXBContext context = JAXBContext.newInstance(MedicationCardDocument.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<MedicationCardDocument> root = mar.unmarshal(source, MedicationCardDocument.class);
