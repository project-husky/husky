...
public class GestationalAge extends CodedResults {
	 ...
	 *         Gestationsalter in Satz-form: "Das Gestationsalter beträgt: X
	 *         Wochen und Y Tage"</div> <div class="fr"></div>
	 *         <div class="it"></div>
	 */
	...
	private void setDaysOfWeeksAndDays(int days) {
		...
		mDays.setEffectiveTime(DateUtilMdht.createUnknownTime(NullFlavor.NA));
	}
	...
	private void setWeeksOfWeeksAndDays(int weeks) {
		...
		mWeeks.setEffectiveTime(DateUtilMdht.createUnknownTime(NullFlavor.NA));
	}
