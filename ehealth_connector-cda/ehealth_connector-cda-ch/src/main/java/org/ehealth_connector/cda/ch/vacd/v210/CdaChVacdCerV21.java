...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.15 Template
 * description: Swiss eVACDOC - Immunization Certificate
 *
 * Element description: Swiss eVACDOC - Immunization CertificateConformity rules
...
public class CdaChVacdCerV21
	...
	/**
	 * Gets the hl7TemplateId CDA-CH-VACD / Immunization Certificate ART-DECOR
	 * model.
	 */
	...
	/**
	 * Gets the hl7Title The document title MUST read: - [de]: 'Impfausweis' -
	 * [fr]: 'Carnet de vaccination' - [it]: 'Certificato di vaccinazione' -
	 ...
	 *         occurred.
	 */
	public static CdaChVacdCerV21 loadFromFile(String inputFileName)
	 ...
	 */
	public static CdaChVacdCerV21 loadFromFile(File inputFile) throws JAXBException, IOException {
		CdaChVacdCerV21 retVal;
		JAXBContext context = JAXBContext.newInstance(CdaChVacdCerV21.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdaChVacdCerV21> root = mar.unmarshal(source, CdaChVacdCerV21.class);
	...
	/**
	 * Sets the hl7TemplateId CDA-CH-VACD / Immunization Certificate ART-DECOR
	 * model.
	 */
	...
	/**
	 * Sets the hl7Title The document title MUST read: - [de]: 'Impfausweis' -
	 * [fr]: 'Carnet de vaccination' - [it]: 'Certificato di vaccinazione' -
	 * [en]: 'Immunization Certificate'
	 */
