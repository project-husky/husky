...
public enum XdsConfCod implements ValueSetEnumInterface {
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "xds-confCod";
	 ...
	 */
	public static XdsConfCod getEnum(String code) {
		for (final XdsConfCod x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(XdsConfCod.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	XdsConfCod(String code, String codeSystem, String displayName, String displayNameEn, String displayNameDe, String displayNameFr, String displayNameIt) {
		this.code = code;
