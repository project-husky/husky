...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.17 Template
 * description: Swiss eVACDOC - Immunization Recommendation Request
 *
 * Element description: Swiss eVACDOC - Immunization Recommendation
 * RequestConformity rules that are not further modelled in ART-DECOR: - XML
 * encodingUTF-8 encoding is required. All CDA-CH V2 documents MUST start with
 * this line:&lt;?xml version="1.0" encoding="UTF-8"?&gt; - Phone numbersPhone
 * numbers MUST be declared in the international format.Dots (.) MUST be used as
 * separators for grouping of number blocks.The minus sign (-) MUST be used as a
 * separator between public and internal telephone numbers. Purpose: Some
 * telephone exchanges - especially in the US, allow direct dial-up of an
 * internal telephone number after the actual connection has been established
 * over the public telephone network.Examples:&lt;telecom
...
public class CdaChVacdReqV21
	 ...
	 * instance was created. Its demographic data is masked as much as possible.
	 * Only the demographic information (such as gender, birthdate and city)
	 * that is needed for a immunization recommendation is allowed.
	 */
	...
	/**
	 * Gets the hl7TemplateId CDA-CH-VACD / Immunization Recommendation Request
	 * ART-DECOR model.
	 */
	...
	/**
	 * Gets the hl7Title The document title MUST read: - [en]: 'Immunization
	 * Recommendation Request' - [de]: 'Anfrage Impfempfehlung' - [fr]: 'Demande
	 * de recommandation vaccinale' - [it]: 'Richiesta di raccomandazione di
	 * vaccinazione'
	 */
	 ...
	 *         occurred.
	 */
	public static CdaChVacdReqV21 loadFromFile(String inputFileName)
	 ...
	 */
	public static CdaChVacdReqV21 loadFromFile(File inputFile) throws JAXBException, IOException {
		CdaChVacdReqV21 retVal;
		JAXBContext context = JAXBContext.newInstance(CdaChVacdReqV21.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdaChVacdReqV21> root = mar.unmarshal(source, CdaChVacdReqV21.class);
	...
	/**
	 * Sets the hl7TemplateId CDA-CH-VACD / Immunization Recommendation Request
	 * ART-DECOR model.
	 */
	...
	/**
	 * Sets the hl7Title The document title MUST read: - [en]: 'Immunization
	 * Recommendation Request' - [de]: 'Anfrage Impfempfehlung' - [fr]: 'Demande
	 * de recommandation vaccinale' - [it]: 'Richiesta di raccomandazione di
	 * vaccinazione'
	 */
