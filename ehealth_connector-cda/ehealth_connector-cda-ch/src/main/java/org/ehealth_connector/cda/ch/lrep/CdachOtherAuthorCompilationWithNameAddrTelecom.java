 ...
 */
public class CdachOtherAuthorCompilationWithNameAddrTelecom extends org.ehealth_connector.common.hl7cdar2.CE {
	 ...
	 */
	public static CdachOtherAuthorCompilationWithNameAddrTelecom loadFromFile(String inputFileName) throws JAXBException, IOException {
	 ...
	 */
	public static CdachOtherAuthorCompilationWithNameAddrTelecom loadFromFile(File inputFile) throws JAXBException, IOException {
		CdachOtherAuthorCompilationWithNameAddrTelecom retVal;
		JAXBContext context = JAXBContext.newInstance(CdachOtherAuthorCompilationWithNameAddrTelecom.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdachOtherAuthorCompilationWithNameAddrTelecom> root = mar.unmarshal(source, CdachOtherAuthorCompilationWithNameAddrTelecom.class);
