...
/**
 * Original ART-DECOR template id: 2.16.756.5.30.1.1.10.1.16 Template
 * description: Swiss eVACDOC - Immunization Administration
 *
 * Element description: Swiss eVACDOC - Immunization AdministrationConformity
 * rules that are not further modelled in ART-DECOR: - XML encodingUTF-8
 * encoding is required. All CDA-CH V2 documents MUST start with this
 * line:&lt;?xml version="1.0" encoding="UTF-8"?&gt; - Phone numbersPhone
...
public class CdaChVacdAdmV21
	...
	/**
	 * Gets the hl7TemplateId CDA-CH-VACD / Immunization Administration
	 * ART-DECOR model.
	 */
	 ...
	 * Administration' - [de]: 'Verabreichte Impfung' - [fr]: 'Vaccin
	 * administré' - [it]: 'Vaccinazione somministrata'
	 */
	 ...
	 *         occurred.
	 */
	public static CdaChVacdAdmV21 loadFromFile(String inputFileName)
	 ...
	 */
	public static CdaChVacdAdmV21 loadFromFile(File inputFile) throws JAXBException, IOException {
		CdaChVacdAdmV21 retVal;
		JAXBContext context = JAXBContext.newInstance(CdaChVacdAdmV21.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<CdaChVacdAdmV21> root = mar.unmarshal(source, CdaChVacdAdmV21.class);
	...
	/**
	 * Sets the hl7TemplateId CDA-CH-VACD / Immunization Administration
	 * ART-DECOR model.
	 */
