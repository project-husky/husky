...
public class ChpalmHeaderRecordTargetHumanPatientWithNonHumanSubject
	 ...
	 */
	public static ChpalmHeaderRecordTargetHumanPatientWithNonHumanSubject loadFromFile(
			File inputFile) throws JAXBException, IOException {
		ChpalmHeaderRecordTargetHumanPatientWithNonHumanSubject retVal;
		JAXBContext context = JAXBContext
				.newInstance(ChpalmHeaderRecordTargetHumanPatientWithNonHumanSubject.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<ChpalmHeaderRecordTargetHumanPatientWithNonHumanSubject> root = mar
				.unmarshal(source, ChpalmHeaderRecordTargetHumanPatientWithNonHumanSubject.class);
