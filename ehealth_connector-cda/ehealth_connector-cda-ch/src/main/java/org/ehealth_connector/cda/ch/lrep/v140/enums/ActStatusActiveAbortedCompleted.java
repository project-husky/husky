...
public enum ActStatusActiveAbortedCompleted implements ValueSetEnumInterface {
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_ID = "2.16.756.5.30.1.1.11.80";
	 ...
	 * <!-- @formatter:on -->
	 */
	public static final String VALUE_SET_NAME = "ActStatusActiveAbortedCompleted";
	 ...
	 */
	public static ActStatusActiveAbortedCompleted getEnum(String code) {
		for (final ActStatusActiveAbortedCompleted x : values()) {
	...
	public static boolean isEnumOfValueSet(String enumName) {
		...
		try {
			Enum.valueOf(ActStatusActiveAbortedCompleted.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	ActStatusActiveAbortedCompleted(String code, String codeSystem, String displayName,
