...
public class CdaChEdesEdpnTest extends TestUtils {
	...
	public void narrativeSectionsTest() {
		...
		assertTrue(cda.getNarrativeTextSectionAllergiesAndOtherAdverseReactions().contains(
				SectionsEDES.ALLERGIES_AND_OTHER_ADVERSE_REACTIONS.getContentIdPrefix()));
		...
		assertTrue(cda.getNarrativeTextSectionEdConsultations().contains(
		...
		assertTrue(cda.getNarrativeTextSectionEdDiagnosis().contains(
		...
		assertTrue(cda.getNarrativeTextSectionCodedPhysicalExam().contains(
				SectionsEDES.CODED_PHYSICAL_EXAM.getContentIdPrefix()));
		...
		assertTrue(cda.getNarrativeTextSectionResults().contains(
		...
		assertTrue(cda.getNarrativeTextSectionListOfSurgeries().contains(
	...
	public void sectionsLanguageCodeTest() {
		...
		cda.addCodedVitalSign(new VitalSignObservation(VitalSignCodes.INTRAVASCULAR_SYSTOLIC,
				effectiveTime, ObservationInterpretationVitalSign.HIGH, ActSite.LEFT_ARM, new Value("140",
						Ucum.MilliMetersOfMercury)), null);

		cda.addCodedVitalSign(new VitalSignObservation(VitalSignCodes.INTRAVASCULAR_DIASTOLIC,
				effectiveTime, ObservationInterpretationVitalSign.HIGH, ActSite.LEFT_ARM, new Value("90",
						Ucum.MilliMetersOfMercury)), null);
