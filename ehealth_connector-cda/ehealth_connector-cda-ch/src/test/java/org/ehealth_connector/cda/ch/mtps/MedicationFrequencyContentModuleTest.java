...
import org.ehealth_connector.cda.ch.mtps.MedicationFrequencyContentModule.DosageType;
...
public class MedicationFrequencyContentModuleTest {
	...
	public void test1NTimesPerDay() throws Exception {
		...
		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
		frequency.setMedicationFrequency(PosologyType.NTimesADay, 3, null, null, 0, null,null);
		final Document document = entry.getDocument();
		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
...
//	@Test
//	public void test3NTimesPerMonth() throws Exception {
//		final PrescriptionItemEntry entry = new PrescriptionItemEntry();
//		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
//		frequency.setMedicationFrequency(PosologyType.NTimesAMonth, 4, null, null, 0, null, null);
//		final Document document = entry.getDocument();
//		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
//		assertEquals(PosologyType.NTimesAMonth, medicationFrequency.posology);
//		assertEquals(new Double(4.0), new Double(medicationFrequency.posologyFactor));
//	}
	...
	public void test5NTimesPerDayDuringMealsEvery3Days() throws Exception {
		final PrescriptionItemEntry entry = new PrescriptionItemEntry();
		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
		frequency.setMedicationFrequency(PosologyType.NTimesADay, 2, new TimingEvent[] {TimingEvent.DURING_MEAL}, FrequencyType.EveryXDay, 3, null, null);
		final Document document = entry.getDocument();
		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
		assertEquals(PosologyType.NTimesADay, medicationFrequency.posology);
		assertEquals(new Double(2.0), new Double(medicationFrequency.posologyFactor));
	...
	public void test6BeforeBreakfast() throws Exception {
		final PrescriptionItemEntry entry = new PrescriptionItemEntry();
		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
		frequency.setMedicationFrequency(PosologyType.TimingEvent, 0, new TimingEvent[] {TimingEvent.BEFORE_BREAKFAST}, null, 3, null, null);
		final Document document = entry.getDocument();
		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
...
//	@Test
//	public void test7BeforeBreakfast3TimesPerMonth() throws Exception {
//		final PrescriptionItemEntry entry = new PrescriptionItemEntry();
//		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
//		frequency.setMedicationFrequency(PosologyType.TimingEvent, 0, new TimingEvent[] {TimingEvent.BEFORE_BREAKFAST}, FrequencyType.XTimesAMonth, 3, null, null);
//		final Document document = entry.getDocument();
//		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
//		assertEquals(PosologyType.TimingEvent, medicationFrequency.posology);
//		assertEquals(TimingEvent.BEFORE_BREAKFAST, medicationFrequency.timingEvents[0]);
//		assertEquals(FrequencyType.XTimesAMonth, medicationFrequency.frequency);
//		assertEquals(new Double(3.0), new Double(medicationFrequency.frequencyFactor));
//	}
	...
	public void test10MorningEveningBeforeMeal() throws Exception {
		final PrescriptionItemEntry entry = new PrescriptionItemEntry();
		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
		frequency.setMedicationFrequency(PosologyType.TimingEvent, 0, new TimingEvent[] {TimingEvent.BEFORE_BREAKFAST, TimingEvent.BEFORE_DINNER}, null, 3, null, null);
		final Document document = entry.getDocument();
		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
		assertEquals(PosologyType.TimingEvent, medicationFrequency.posology);
		assertEquals(TimingEvent.BEFORE_BREAKFAST, medicationFrequency.timingEvents[0]);
...
//	@Test
//	public void test10MorningEveningBeforeMealEveryTwoDays() throws Exception {
//		final PrescriptionItemEntry entry = new PrescriptionItemEntry();
//		MedicationFrequencyContentModule frequency = new MedicationFrequencyContentModule(entry);
//		frequency.setMedicationFrequency(PosologyType.TimingEvent, 0, new TimingEvent[] {TimingEvent.BEFORE_BREAKFAST, TimingEvent.BEFORE_DINNER}, FrequencyType.EveryXDay, 2, null, null);
//		final Document document = entry.getDocument();
//		MedicationFrequency medicationFrequency = frequency.getMedicationFrequency();
//		assertEquals(TimingEvent.BEFORE_BREAKFAST, medicationFrequency.timingEvents[0]);
//		assertEquals(TimingEvent.BEFORE_DINNER, medicationFrequency.timingEvents[1]);
//		assertEquals(PosologyType.TimingEvent, medicationFrequency.posology);
//		assertEquals(FrequencyType.EveryXDay, medicationFrequency.frequency);
//		assertEquals(new Double(2.0), new Double(medicationFrequency.frequencyFactor));
//	}
	...
	public void testSplitDosing() throws Exception {
		...
		frequency.setMedicationFrequency(PosologyType.TimingEvent, 0, new TimingEvent[] {TimingEvent.DURING_BREAKFAST, TimingEvent.DURING_LUNCH, TimingEvent.DURING_DINNER, TimingEvent.BEFORE_SLEEP}, null,0, DosageType.Split, values); 
		final Document document = entry.getDocument();
		...
		assertEquals(new Double(2.0), new Double(medicationFrequency.doseQuantities[0].getPhysicalQuantity().getValue().doubleValue()));
		assertEquals(new Double(1.5), new Double(medicationFrequency.doseQuantities[1].getPhysicalQuantity().getValue().doubleValue()));
		assertEquals(new Double(2.5), new Double(medicationFrequency.doseQuantities[2].getPhysicalQuantity().getValue().doubleValue()));
		assertEquals(new Double(4.0), new Double(medicationFrequency.doseQuantities[3].getPhysicalQuantity().getValue().doubleValue()));
