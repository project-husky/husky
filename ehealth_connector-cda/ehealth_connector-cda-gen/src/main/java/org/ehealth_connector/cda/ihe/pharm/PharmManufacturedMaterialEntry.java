...
public class PharmManufacturedMaterialEntry extends
	 ...
	 * FIXME convenienc api: what is the correct resolution?
	 *
	 ...
	 *
	 * @param ts the new expiration time
	 */
	 ...
	 *
	 * @param ingredientCode the new ingredient code
	 */
	 ...
	 *
	 * @param quantity the new ingredient quantity
	 */
	 ...
	 *
	 * @param formCode the new packaged medicine form code
	 */
	 ...
	 *
	 * @param name the new packaged medicine name
	 */
	 ...
	 *
	 * @param productCode the new packaged medicine product code
	 */
	 ...
	 *
	 * @param value the new packaged medicine quantity
	 */
