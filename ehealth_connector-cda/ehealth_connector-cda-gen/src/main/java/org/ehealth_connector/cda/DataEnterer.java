...
public class DataEnterer {
	...
	public Date getTimeAsDate() {
		if (mDataEnterer.getTime() != null) {
			return DateUtil.parseDates(mDataEnterer.getTime().getValue());
		}
		return null;
	}
	...
	public IVL_TS getTimeAsIVL_TS() {
		...
		if (mDataEnterer.getTime() != null) {
			try {
				retVal = DateUtil.createIVL_TSFromHL7Date(mDataEnterer.getTime().getValue());
	...
	public String getTimeAsString() {
		if (mDataEnterer.getTime() != null) {
			return DateUtil.parseDateToStr(mDataEnterer.getTime());
		}
		return null;
	}
	...
	public void setTime(Date date) {
		if (date != null) {
			mDataEnterer.setTime(DateUtil.convertDateToTsyyyyMMddHHmmssZZZZ(date));
		} else {
			mDataEnterer.setTime(DateUtil.convertDateToTsyyyyMMddHHmmssZZZZ(new Date()));
		}
	}
