...
/**
 * MdhtEntryObservationFacade is a facade for extending the mdht objects generated by the model
 ...
 *
 * @param <E>            the model type to provide for implemting the facade to it, extending an Act
 */
public class MdhtEntryActFacade<E extends Act> extends MdhtFacade<E>{
	...
	public String getTextReference() {
		if ((this.getMdht()!=null) && (this.getMdht().getText() != null) && (this.getMdht().getText().getReference() != null)) {
	 ...
	 *
	 * @param value the new text reference
	 */
	@Override
