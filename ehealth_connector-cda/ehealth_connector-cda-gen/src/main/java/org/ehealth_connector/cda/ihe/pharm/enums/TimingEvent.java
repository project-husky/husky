...
public enum TimingEvent {
	...
	/** <div class="en"> Before sleep</div><div class="fr">Avant d’aller dormir (hors sieste)</div> */
	...
	BEFORE_MEAL("AC", "Before meal",
			"Avant un repas"), 
	
	/** <div class="en"> After meal</div><div class="fr">Après un repas</div> */
	AFTER_MEAL("PC", "After meal",
			"Après un repas"), 
	
	/** <div class="en"> Between meals</div><div class="fr">Entre les repas</div> */
	BETWEEN_MEALS("IC", "Between meals",
			"Entre les repas"), 
	
	/** <div class="en"> Before breakfast</div><div class="fr">Avant le petit-déjeuner</div> */
	BEFORE_BREAKFAST("ACM", "Before breakfast",
			"Avant le petit-déjeuner"), 
	
	/** <div class="en"> Before lunch</div><div class="fr">Avant le repas de midi</div> */
	BEFORE_LUNCH("ACD", "Before lunch",
			"Avant le repas de midi"), 
	
	/** <div class="en"> Before dinner</div><div class="fr">Avant le repas du soir</div> */
	BEFORE_DINNER("ACV", "Before dinner",
			"Avant le repas du soir"), 
	
	/** <div class="en"> After breakfast</div><div class="fr">Après le petit-déjeuner</div> */
	AFTER_BREAKFAST("PCM", "After breakfast",
			"Après le petit-déjeuner"), 
	
	/** <div class="en"> After lunch</div><div class="fr">Après le repas de midi</div> */
	AFTER_LUNCH("PCD", "After lunch",
			"Après le repas de midi"), 
	
	/** <div class="en"> After dinner</div><div class="fr">Après le repas du soir</div> */
	AFTER_DINNER("PCV", "After dinner",
			"Après le repas du soir"), 
	
	/** <div class="en"> Between breakfast and lunch</div><div class="fr">Entre le petit-déjeuner et le repas de midi</div> */
	BETWEEN_BREAKFAST_AND_LUNCH("ICM", "Between breakfast and lunch",
			"Entre le petit-déjeuner et le repas de midi"), 
	
	/** <div class="en"> Between lunch and dinner</div><div class="fr">Entre le repas de midi et le repas du soir</div> */
	BETWEEN_LUNCH_AND_DINNER("ICD", "Between lunch and dinner",
			"Entre le repas de midi et le repas du soir"), 
	
	/** <div class="en"> Between dinner and sleep</div><div class="fr">Entre le repas du soir et l’heure du coucher</div> */
	...
	DURING_MEAL("C", "During meal",
			"Pendant le repas"), 
	
	/** <div class="en"> During lunch</div><div class="fr">Pendant le repas de midi</div> */
	DURING_LUNCH("CD", "During lunch",
			"Pendant le repas de midi"), 
	
	/** <div class="en"> During breakfast</div><div class="fr">Pendant le petit-déjeuner</div> */
	DURING_BREAKFAST("CM", "During breakfast",
			"Pendant le petit-déjeuner"), 
	
	/** <div class="en"> During dinner</div><div class="fr">Pendant le repas du soir</div> */
	DURING_DINNER("CV", "During dinner",
