...
/**
 * MdhtFace is a facade for extending the mdht objects generated by the model The design enables that all derived convenience objects can use the underlying mdht model but the exposing api of the classes is independent of the mdht implementation.
 *
 * @param <E>
...
public class MdhtFacade<E extends InfrastructureRoot> {
	 ...
	 *            the template id extension, mdht does not provide templateId extension attribute for modeling, this extension necessary for swiss templates and can be added during for the specified root during constructing the facade
	 */
	 ...
	 *            the section
	 * @param reference
	 *            the content id the section should be searched for by the reference, reference has to start with a # (relative)
	 * @return the string
	 */
	...
	/**
	 * returns the object serialized as a DOM document which can be used in testing for correct xml model generation.
	 *
	 * @return the document
	 */
	 ...
	 * Gets the document.
	 *
	 * @param namespaceAware if doucment should be built with namespace aware set (for xpath)
	 * @return the document
	 */
