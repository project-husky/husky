...
public enum NullFlavor {
	 ...
	 * extension will be used to convey the derivation expressionexpression.</div>
	 * <div class="de"></div> <div class="fr"></div> <div class="it"></div>
	 */
	DERIVED("DER", "derived"),
	/**
	 * <div class="en">Description:The value as represented in the instance is not
	 * a member of the set of permitted data values in the constrained value
	 * domain of a variable.</div> <div class="de"></div> <div class="fr"></div>
	 * <div class="it"></div>
	 */
	INVALID("INV", "invalid"),
	/**
	 * <div class="en">There is information on this item available but it has not
	 * been provided by the sender due to security, privacy or other reasons.
	 ...
	 * receiver that the information does exist without providing any
	 * detail.</div> <div class="de">Anonymisierte Daten</div>
	 * <div class="fr"></div> <div class="it"></div>
	 */
	MASKED("MSK", "masked"),
	/**
	 * <div class="en">Negative infinity of numbers.</div> <div class="de"></div>
	 * <div class="fr"></div> <div class="it"></div>
	 */
	 ...
	 * exceptional value is provided. This is the most general exceptional value.
	 * It is also the default exceptional value.</div> <div class="de"></div>
	 * <div class="fr"></div> <div class="it"></div>
	 */
	...
	/**
	 * <div class="en">This information has not been sought (e.g. patient was not
	 * asked)</div> <div class="de"></div> <div class="fr"></div>
	 * <div class="it"></div>
	 */
	NOT_ASKED("NASK", "not asked"),
	/**
	 * <div class="en">Value is not present in a message. This is only defined in
	 ...
	 * default of all defaults.</div> <div class="de"></div>
	 * <div class="fr"></div> <div class="it"></div>
	 */
	NOT_PRESENT("NP", "not present"),
	/**
	 * <div class="en">Description:The actual value is not a member of the set of
	 * permitted data values in the constrained value domain of a variable. (e.g.
	 * concept not provided by required code system). Usage Notes: This flavor and
	 * its specializations are most commonly used with the CD datatype and its
	 * flavors. However, it may apply to *any* datatype where the constraints of
	 * the type are tighter than can be conveyed. For example, a PQ that is for a
	 * true measured amount whose units are not supported in UCUM, a need to
	 * convey a REAL when the type has been constrained to INT, etc. With coded
	 * datatypes, this null flavor may only be used if the vocabulary binding has
	 * a coding strength of CNE. By definition, all local codes and original text
	 * are part of the value set if the coding strength is CWE.</div>
	 * <div class="de">Andere Gründe</div> <div class="fr"></div>
	 * <div class="it"></div>
	 */
	OTHER("OTH", "other"),
	/**
	 * <div class="en">Positive infinity of numbers.</div> <div class="de"></div>
	 * <div class="fr"></div> <div class="it"></div>
	 */
	 ...
	 * text has been captured for a PQ, but not attempt has been made to split the
	 * value and unit or to encode the unit in UCUM. Usage Notes: If it is known
	 * that it is not possible to encode the concept, OTH should be used instead.
	 * However, use of UNC does not necessarily guarantee the concept will be
	 * encodable, only that encoding has not been attempted. Data type properties
	 * such as original text and translations may be present when this null flavor
	 * is included.</div> <div class="de"></div> <div class="fr"></div>
	 * <div class="it"></div>
	 */
	 ...
	 * constraints (value set, datatype, etc.), then the OTH or UNC flavor should
	 * be used. No properties should be included for a datatype with this property
	 * unless: Those properties themselves directly translate to a semantic of
	 * 'unknown'. (E.g. a local code sent as a translation that conveys 'unknown')
	 * Those properties further qualify the nature of what is unknown. (E.g.
	 * specifying a use code of 'H' and a URL prefix of 'tel:' to convey that it
	 * is the home phone number that is unknown.)</div> <div class="de">Unbekannt,
	 * ohne weitere Präzisierung</div> <div class="fr"></div>
	 * <div class="it"></div>
	 */
	UNKNOWN("UNK", "unknown");
