...
public class CdaChTest extends TestUtils {
	private CdaChVacd c;
	private String uuid;
	...
	public void testAuthor() {
		...
		final Author b = new Author(patient1);
	...
	public void testSetterGetterCdaCh() {
		...
		assertTrue(
				isEqual(Confidentiality.RESTRICED.getCode(), c.getConfidentialityCode().getCode()));
		// doc id root
		...
		try {
			c.saveToFile(getTempFilePath("testCdaCd.xml"));
