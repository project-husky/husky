 ...
 * need to be made here.</div> <div class="de">Dieses Enum dient dazu, dass ein
 * ValueSetEntry richtig behandelt werden kann (z.B. Abbilden der Baumstruktur).
 * Der Inhalt des Enums ist wie von ART-DECOR vorgegeben. Bei einer allfälligen
 * Implementierung der Schnittstelle zum Terminologieserver muss hier evtl. ein
 * Mapping zu den Entry Typen im Terminologieserver gemacht werden.</div>.
 */
