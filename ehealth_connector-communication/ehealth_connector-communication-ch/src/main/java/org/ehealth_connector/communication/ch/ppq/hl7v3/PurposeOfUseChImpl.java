...
public abstract class PurposeOfUseChImpl {
	...
	public static PurposeOfUse AUTO() {
		return createPurposeOfUse(
				org.ehealth_connector.communication.ch.ppq.epr.enums.PurposeOfUse.AUTOMATIC_UPLOAD);
	}

	private static PurposeOfUse createPurposeOfUse(
			org.ehealth_connector.communication.ch.ppq.epr.enums.PurposeOfUse code) {
	...
	public static PurposeOfUse EMER() {
		return createPurposeOfUse(
				org.ehealth_connector.communication.ch.ppq.epr.enums.PurposeOfUse.EMERGENCY_ACCESS);
	}
	...
	public static PurposeOfUse NORM() {
		return createPurposeOfUse(
				org.ehealth_connector.communication.ch.ppq.epr.enums.PurposeOfUse.NORMAL_ACCESS);
	}
