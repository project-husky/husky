...
public enum AgentRole implements ValueSetEnumInterface {
	 ...
	 */
	public static AgentRole getEnum(String code) {
	 ...
	 *            the display name it
	 */
	AgentRole(String code, String codeSystem, String displayName, String displayNameEn, String displayNameDe, String displayNameFr, String displayNameIt) {
		this.code = code;
