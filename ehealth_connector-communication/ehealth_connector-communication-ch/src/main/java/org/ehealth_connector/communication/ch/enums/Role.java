...
public enum Role implements ValueSetEnumInterface {
	 ...
	 */
	DOCUMENT_ADMINISTRATOR("DADM", "2.16.756.5.30.1.127.3.10.6", "Document Administrator", "Document Administrator", "Dokumentenadministrator", "Administrateur des documents", "Amministratore documenti"),
	/**
	 ...
	 */
	POLICY_ADMINISTRATOR("PADM", "2.16.756.5.30.1.127.3.10.6", "Policy Administrator", "Policy Administrator", "Datenschutzrichtlinien-Administrator", "Administrateur des directives de protection des données", "Amministratore diritti di accesso"),
	/**
	...
	public static boolean isEnumOfValueSet(final String enumName) {
		...
		try {
			Enum.valueOf(Role.class, enumName);
			return true;
