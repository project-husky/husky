...
public enum HealthcareFacilityTypeCode implements ValueSetEnumInterface {
	 ...
	 */
	DIAGNOSTIC_INSTITUTION("722171005", "Diagnostic institution (environment)", "Diagnostic institution", "Institution für medizinische Diagnostik", "Institut d’aide au diagnostic", "Istituto di diagnostica medica"),
	/**
	 ...
	 */
	ACCIDENT_AND_EMERGENCY_DEPARTMENT("225728007", "Accident and Emergency department (environment)", "Accident and Emergency department ", "Notfall-/Rettungsdienste", "Service d'urgence et de sauvetage", "Servizio di pronto soccorso e di salvataggio"),
	/**
	 ...
	 */
	HEALTH_AUTHORITY("394747008", "Health Authority (qualifier value)", "Health Authority ", "Gesundheitsbehörde", "Autorité sanitaire", "Autorità sanitaria"),
	/**
	 ...
	 */
	PRIVATE_HOME_BASED_CARE("66280005", "Private home-based care (environment)", "Private home-based care ", "Organisation für Pflege zu Hause", "Soins à domicile", "Servizio di assistenza e cura a domicilio"),
	/**
	 ...
	 */
	HOSPITAL("22232009", "Hospital (environment)", "Hospital ", "Stationäre Einrichtung/Spital", "Hôpital", "Ospedale"),
	/**
	 ...
	 * militare</div>
	 */
	MILITARY_HEALTH_INSTITUTION("722172003", "Military health institution (environment)", "Military health institution", "Armeeärztliche Dienste", "Service sanitaire de l'armée", "Servizio di medicina militare"),
	/**
	 ...
	 */
	PRISON_BASED_CARE_SITE("722173008", "Prison based care site (environment)", "Prison based care site", "Gesundheitseinrichtung in der Haftanstalt", "Service de santé en milieu carcéral", "Struttura sanitaria in uno stabilimento carcerario"),
	/**
	 ...
	 * cura</div>
	 */
	NURSING_HOME("42665001", "Nursing home (environment)", "Nursing home ", "Pflegeheim", "Etablissement médico-social", "Casa di cura"),
	/**
	 * <div class="en">Pharmacy </div> <div class="de">Apotheke</div>
	 * <div class="fr">Pharmacie</div> <div class="it">Farmacia</div>
	 */
	PHARMACY("264372000", "Pharmacy (environment)", "Pharmacy ", "Apotheke", "Pharmacie", "Farmacia"),
	/**
	 ...
	 * studi medici</div>
	 */
	AMBULATORY_CARE_SITE("35971002", "Ambulatory care site (environment)", "Ambulatory care site", "Ambulante Einrichtung/Ambulatorium", "Etablissement ambulatoire", "Struttura ambulatoriale, incl. gli studi medici"),
	/**
	 ...
	 */
	REHABILITATION_HOSPITAL("80522000", "Rehabilitation hospital (environment)", "Rehabilitation hospital ", "Organisation für stationäre Rehabilitation", "Réadaptation stationnaire", "Istituto di riabilitazione stazionaria"),
	/**
	 ...
	 * telemedicina</div>
	 */
	TELEMEDICINE_INSTITUTION("288565001", "Medical center (environment)", "Telemedicine institution", "Telemedizinische Einrichtung", "Institut de télémédecine", "Centro di telemedicina"),
	/**
	 ...
	 */
	GENERAL_PRACTICE_PREMISES("264358009", "General practice premises (environement)", "General practice premises", "Arztpraxis", "Cabinet médical", "Studio medico"),
	/**
	 ...
	 */
	OTHER_SITE_OF_CARE("43741000", "Site of care (social concept)", "Other Site of Care", "Andere Gesundheitsorganisation", "Autres prestataires de soins", "Altre organizzazioni sanitarie");
	 ...
	 *            the display name it
	 */
	HealthcareFacilityTypeCode(String code, String displayName, String displayNameEn,
