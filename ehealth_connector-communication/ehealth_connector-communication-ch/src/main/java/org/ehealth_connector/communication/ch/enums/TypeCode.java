...
public enum TypeCode implements CodedMetadataEnumInterface {
	 ...
	 */
	ANDERE_NICHT_NAHER_SPEZIFIZIERT("60999",
			"Andere nicht näher spezifiziert"), /**
												 * <div class="de">Anästhesie
												 * Bericht</div>
												 * <div class="fr"></div>
												 * <div class="it"></div>
												 */
	ANASTHESIE_BERICHT("60032",
			"Anästhesie Bericht"), /**
									 * <div class="de">Austrittsbericht
									 * (lang-pflegerisch)</div>
									 * <div class="fr"></div>
									 * <div class="it"></div>
									 */
	AUSTRITTSBERICHT_LANG_PFLEGERISCH("60012",
			"Austrittsbericht (lang-pflegerisch)"), /**
													 * <div class="de">
													 * Austrittsbericht
													 * (lang-ärztlich)</div>
													 * <div class="fr">Lettre de
													 * sortie</div>
													 * <div class="it"></div>
													 */
	AUSTRITTSBERICHT_LANG_ARZTLICH("60010",
			"Austrittsbericht (lang-ärztlich)"), /**
													 * <div class="de">
													 * Behandlungsschema</div>
													 * <div class="fr"></div>
													 * <div class="it"></div>
													 */
	BEHANDLUNGSSCHEMA("60045",
			"Behandlungsschema"), /**
									 * <div class="de">Beschlussprotokoll</div>
									 * <div class="fr"></div>
									 * <div class="it"></div>
									 */
	BESCHLUSSPROTOKOLL("60039",
			"Beschlussprotokoll"), /**
									 * <div class="de">Dokument mit
									 * Kontraindikationen,
	...
	ECHOKARDIOGRAPHIE_BEFUND("60029",
			"Echokardiographie-Befund"), /**
											 ...
											 * <div class="it"></div>
											 */
	EINTRITTSBERICHT("60008",
			"Eintrittsbericht"), /**
									 * <div class="de">elektronischer
									 * Impfausweis</div> <div class="fr"></div>
									 * <div class="it"></div>
									 */
	ELEKTRONISCHER_IMPFAUSWEIS("60043",
			"elektronischer Impfausweis"), /**
											 * <div class="de">elektronisches
											 * Rezept</div>
											 * <div class="fr">Ordonnance de
											 * médicaments</div>
											 * <div class="it"></div>
											 */
	ELEKTRONISCHES_REZEPT("60006",
			"elektronisches Rezept"), /**
										 * <div class="de">Geburtsanzeige</div>
										 * <div class="fr"></div>
										 * <div class="it"></div>
										 */
	GEBURTSANZEIGE("60047",
			"Geburtsanzeige"), /**
								 * <div class="de">Herzkatheter-Befund</div>
								 * <div class="fr">Rapport de cathétérisme
								 * cardiaque</div> <div class="it"></div>
								 */
	HERZKATHETER_BEFUND("60028",
			"Herzkatheter-Befund"), /**
									 * <div class="de">Histologie-Befund</div>
									 * <div class="fr"></div>
									 * <div class="it"></div>
									 */
	HISTOLOGIE_BEFUND("60027",
			"Histologie-Befund"), /**
									 * <div class="de">Kardiologie
									 * Verlaufs-Bericht</div>
									 * <div class="fr"></div>
									 * <div class="it"></div>
									 */
	KARDIOLOGIE_VERLAUFS_BERICHT("60037",
			"Kardiologie Verlaufs-Bericht"), /**
												 * <div class="de">klinisches
												 * Verlaufsblatt</div>
												 * <div class="fr"></div>
												 * <div class="it"></div>
												 */
	KLINISCHES_VERLAUFSBLATT("60036",
			"klinisches Verlaufsblatt"), /**
											 * <div class="de">Knochenmark-
											 * Biopsie-Befund</div>
											 * <div class="fr"></div>
											 * <div class="it"></div>
											 */
	KNOCHENMARK_BIOPSIE_BEFUND("60026",
			"Knochenmark-Biopsie-Befund"), /**
											 * <div class="de">Konsilauftrag
											 * (allgemein)</div>
											 * <div class="fr">Demande de
											 * consultation</div>
											 * <div class="it"></div>
											 */
	KONSILAUFTRAG_ALLGEMEIN("60017",
			"Konsilauftrag (allgemein)"), /**
											 * <div class="de">
											 * Konsultationsbericht</div>
											 * <div class="fr">Rapport de
											 * consultation</div>
											 * <div class="it"></div>
											 */
	KONSULTATIONSBERICHT("60021",
			"Konsultationsbericht"), /**
										 * <div class="de">Kostengutsprache
										 * </div> <div class="fr"></div>
										 * <div class="it"></div>
										 */
	KOSTENGUTSPRACHE("60048", "Kostengutsprache"), /**
													 ...
													 * <div class="it"></div>
													 */
	KURVE_INTENSIVSTATION("60038",
			"Kurve Intensivstation"), /**
										 * <div class="de">Kurz-Austrittsbericht
										 * (pflegerisch)</div>
										 * <div class="fr"></div>
										 * <div class="it"></div>
										 */
	KURZ_AUSTRITTSBERICHT_PFLEGERISCH("60011",
			"Kurz-Austrittsbericht (pflegerisch)"), /**
													 * <div class="de">Kurz-
													 * Austrittsbericht
													 * (ärztlich)</div>
													 * <div class="fr">Avis de
													 * sortie</div>
													 * <div class="it"></div>
													 */
	KURZ_AUSTRITTSBERICHT_ARZTLICH("60009",
	...
	LABOR_BEFUND("60023",
			"Labor-Befund"), /**
								 ...
								 */
	LUNGENFUNKTIONS_BEFUND("60030",
			"Lungenfunktions-Befund"), /**
										 * <div class="de">Medikamentenliste
										 * (aktuell)</div> <div class="fr">Liste
										 * des médicaments</div>
										 * <div class="it"></div>
										 */
	MEDIKAMENTENLISTE_AKTUELL("60005",
			"Medikamentenliste (aktuell)"), /**
											 * <div class="de">Meldung
											 * übertragbare Erkrankung</div>
											 * <div class="fr"></div>
											 * <div class="it"></div>
											 */
	MELDUNG_UBERTRAGBARE_ERKRANKUNG("60042",
			"Meldung übertragbare Erkrankung"), /**
												 * <div class="de">Nicht
												 * spezifizierte Bilddaten</div>
												 * <div class="fr"></div>
												 * <div class="it"></div>
												 */
	NICHT_SPEZIFIZIERTE_BILDDATEN("60040",
			"Nicht spezifizierte Bilddaten"), /**
												 ...
												 * <div class="it"></div>
												 */
	NOTFALLBERICHT("60035",
			"Notfallbericht"), /**
								 * <div class="de">Notfall-Ausweis</div>
								 * <div class="fr"></div> <div class="it"></div>
								 */
	NOTFALL_AUSWEIS("60044",
			"Notfall-Ausweis"), /**
	...
	OP_BERICHT("60033",
			"OP-Bericht"), /**
							 ...
							 * <div class="fr"></div> <div class="it"></div>
							 */
	PATHOLOGIEAUFTRAG("60019",
			"Pathologieauftrag"), /**
									 * <div class="de">Pathologie-Befund</div>
									 * <div class="fr">Rapport de
									 * pathologie</div> <div class="it"></div>
									 */
	PATHOLOGIE_BEFUND("60025",
			"Pathologie-Befund"), /**
									 * <div class="de">Patienteneinwilligung
									 * </div> <div class="fr">Consentement du
									 * patient</div> <div class="it"></div>
									 */
	PATIENTENEINWILLIGUNG("60002",
			"Patienteneinwilligung "), /**
										 * <div class="de">Patienteneinwilligung
										 * für die Verwendung der elektronischen
										 * Daten</div>
										 * <div class="fr">Consentement du
	...
	PATIENTENEINWILLIGUNG_FUR_DIE_VERWENDUNG_DER_ELEKTRONISCHEN_DATEN("60001",
			"Patienteneinwilligung für die Verwendung der elektronischen Daten"), /**
																					 ...
																					 * </div>
																					 */
	PATIENTENVERFUGUNG("60003",
			"Patientenverfügung"), /**
									 * <div class="de">Patient Summary
									 * (medizinische Zusammenfassung)</div>
	...
	PFLEGEBERICHT("60016",
			"Pflegebericht"), /**
								 ...
								 * <div class="fr"></div> <div class="it"></div>
								 */
	PFLEGEPLAN_ALLGEMEIN("60015",
			"Pflegeplan (allgemein)"), /**
										 * <div class="de">Physiotherapiebericht
										 * </div> <div class="fr"></div>
										 * <div class="it"></div>
										 */
	PHYSIOTHERAPIEBERICHT("60031",
			"Physiotherapiebericht"), /**
										 * <div class="de">Radiologieauftrag
										 * </div> <div class="fr"></div>
										 * <div class="it"></div>
										 */
	RADIOLOGIEAUFTRAG("60020",
			"Radiologieauftrag"), /**
									 * <div class="de">Radiologie-Befund</div>
									 * <div class="fr">Rapport d'imagerie</div>
									 * <div class="it"></div>
									 */
	RADIOLOGIE_BEFUND("60024",
			"Radiologie-Befund"), /**
									 * <div class="de">Radiologische
									 * Bilddaten</div> <div class="fr"></div>
									 * <div class="it"></div>
									 */
	RADIOLOGISCHE_BILDDATEN("60041",
	...
	UNBEKANNT("60900",
			"Unbekannt"), /**
							 * <div class="de">Untersuchungsbefund
							 * (allgemein)</div> <div class="fr">Rapport
							 * d'examen (non laboratoire)</div>
							 * <div class="it"></div>
							 */
	UNTERSUCHUNGSBEFUND_ALLGEMEIN("60022",
			"Untersuchungsbefund (allgemein)"), /**
												 * <div class="de">Verlaufs- /
												 * Austrittsbericht Gynäkologie
												 * und Geburtshilfe</div>
												 * <div class="fr"></div>
												 * <div class="it"></div>
												 */
	...
	WUNDBEFUND("60034",
			"Wundbefund"), /**
							 * <div class="de">Zuweisungsschreiben/
							 * Einweisungsschreiben</div>
