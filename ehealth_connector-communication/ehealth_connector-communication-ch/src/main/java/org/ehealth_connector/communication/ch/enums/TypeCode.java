...
public enum TypeCode implements ValueSetEnumInterface {
	 ...
	 * ecocardiografia </div>
	 */
	ELECTROCARDIOGRAM_REPORT("399345000", "2.16.840.1.113883.6.96",
			"Adult echocardiography procedure report (record artifact)", "Electrocardiogram report",
			"Echokardiographie Befund", "Rapport d'électrocardiographie (ECG)",
			"Referto di ecocardiografia "),
	/**
