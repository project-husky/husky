...
public enum TypeCode implements ValueSetEnumInterface {
	 ...
	 */
	PATIENT_CONSENT("371537001", "Consent report (record artifact)", "Patient Consent", "Patienteneinwilligung", "Consentement du patient", "Consenso del paziente"),
	/**
	 ...
	 * paziente</div>
	 */
	ADVANCE_DIRECTIVE_REPORT("371538006", "Advance directive report (record artifact)", "Advance directive report", "Patientenverfügung", "Directives anticipées du patient", "Direttive anticipate del paziente"),
	/**
	 ...
	 */
	PATIENT_SUMMARY("371534008", "Summary report (record artifact)", "Patient Summary", "Patient Summary (medizinische Zusammenfassung)", "Résumé du dossier médical", "Patient Summary (riassunto medico)"),
	/**
	 ...
	 */
	MEDICATION_SUMMARY("721912009", "Medication summary document (record artifact)", "Medication summary", "Medikamentenliste (aktuell)", "Liste des médicaments", "Elenco dei medicamenti"),
	/**
	 * <div class="en">Drug prescription</div> <div class="de">Rezept</div>
	 * <div class="fr">Ordonnance</div> <div class="it">Ricetta medica</div>
	 */
	DRUG_PRESCRIPTION("440545006", "Prescription record (record artifact)", "Drug prescription", "Rezept", "Ordonnance", "Ricetta medica"),
	/**
	 ...
	 */
	NON_DRUG_PRESCRIPTION("1371000195104", "Non-drug prescription record (record artifact)", "Non-drug prescription", "Nicht-Arzneimittelbezogene Verordnung", "Ordonnance nonmédicamenteuse", "Richiesta di prestazione sanitaria"),
	/**
	 ...
	 */
	MEDICATION_DISPENSATION("275670009", "Prescription exemption certificate (record artifact)", "Medication Dispensation ", "Dispensation", "Dispensation", "Dispensazione"),
	/**
	 ...
	 */
	MEDICATION_COMMENT("1221000195109", "Medication Comment (record artifact)", "Medication Comment", "Kommentar zu Medikation", "Commentaire sur la médication", "Commento alla terapia farmacologica"),
	/**
	 ...
	 * farmacologico</div>
	 */
	MEDICATION_TREATMENT_PLAN("761931002", "Medication treatment plan report (record artifact)", "Medication Treatment Plan", "Therapieentscheid ", "Plan de traitement pharmacologique", "Programma di trattamento farmacologico"),
	/**
	 ...
	 */
	ADMISSION_REQUEST("721915006", "Admission request document (record artifact)", "Admission request", "Zuweisungsschreiben/Einweisungsschreiben", "Demande d'admission", "Richiesta di ricovero/ammissione"),
	/**
	 ...
	 */
	ADMISSION_REPORT("371542009", "Admission history and physical report (record artifact)", "Admission report", "Eintrittsbericht", "Rapport d'admission", "Rapporto di ammissione"),
	/**
	 ...
	 */
	DISCHARGE_SUMMARY("373942005", "Discharge summary (record artifact)", "Discharge summary", "Austrittsbericht", "Lettre de sortie", "Rapporto/lettera d'uscita"),
	/**
	 ...
	 */
	TRANSFER_SUMMARY_REPORT("371535009", "Transfer summary report (record artifact)", "Transfer summary report", "Verlegungsbericht", "Rapport de transfert", "Rapporto di trasferimento"),
	/**
	 ...
	 */
	CARE_PLAN("278448002", "Care plan (qualifier value)", "Care plan", "Pflegeplan (allgemein)", "Plan de soins", "Piano di cura"),
	/**
	 ...
	 */
	NURSING_REPORT("5531000179105", "Nursing report (record artifact)", "Nursing report", "Pflegebericht", "Rapport de soins infirmiers", "Rapporto infermieristico"),
	/**
	 ...
	 */
	REFERRAL_REQUEST("721927009", "Referral note (record artifact)", "Referral request", "Konsilauftrag (allgemein)", "Demande de consultation", "Richiesta di consulto"),
	/**
	 ...
	 */
	CONSULTATION_REPORT("371530004", "Clinical consultation report (record artifact)", "Consultation report", "Konsultationsbericht", "Rapport de consultation", "Rapporto di consultazione"),
	/**
	 ...
	 * (generale)</div>
	 */
	CLINICAL_PROCEDURE_REPORT("371525003", "Clinical procedure report (record artifact)", "Clinical procedure report", "Untersuchungsbefund (allgemein)", "Rapport d'examen", "Risultato d'esame (generale)"),
	/**
	 ...
	 */
	LABORATORY_REPORT("4241000179101", "Laboratory report (record artifact)", "Laboratory report", "Labor-Befund", "Résultat de laboratoire", "Referto di laboratorio"),
	/**
	 ...
	 */
	PATHOLOGY_REPORT("371528001", "Pathology report (record artifact)", "Pathology report", "Pathologie-Befund", "Rapport de pathologie", "Referto di patologia"),
	/**
	 ...
	 */
	BONE_MARROW_PATHOLOGY_BIOPSY_REPORT("721631001", "Bone marrow pathology biopsy report (record artifact)", "Bone marrow Pathology biopsy report", "Knochenmark-Biopsie-Befund", "Rapport de la biopsie de la moelle osseuse", "Referto di biopsia del midollo osseo"),
	/**
	 ...
	 * cardiaco</div>
	 */
	CARDIAC_CATHETERIZATION_REPORT("721968000", "Cardiac catheterization report (record artifact)", "Cardiac catheterization report", "Herzkatheter-Befund", "Rapport du cathétérisme cardiaque", "Referto di cateterismo cardiaco"),
	/**
	 ...
	 * ecocardiografia </div>
	 */
	ELECTROCARDIOGRAM_REPORT("399345000", "Adult echocardiography procedure report (record artifact)", "Electrocardiogram report", "Echokardiographie Befund", "Rapport d'électrocardiographie (ECG)", "Referto di ecocardiografia "),
	/**
	 ...
	 */
	ULTRASOUND_IMAGING_REPORT("4221000179107", "Ultrasound imaging report (record artifact)", "Ultrasound imaging report", "Ultraschall-Befund", "Rapport de l'ultrason", "Referto ecografico"),
	/**
	 ...
	 */
	RADIOLOGY_REPORT("371527006", "Radiology report (record artifact)", "Radiology report", "Radiologie-Befund", "Rapport de l'examen radiologique", "Referto radiologico"),
	/**
	 ...
	 */
	ANAESTHESIOLOGY_REPORT("416779005", "Anesthesia record (record artifact)", "Anaesthesiology report", "Anästhesie-Befund", "Rapport de l'anésthésie", "Referto anestesiologico"),
	/**
	 * <div class="en">Operative report</div> <div class="de">OP-Bericht</div>
	 * <div class="fr">Protocole opératoire</div> <div class="it">Referto
	 * operatorio</div>
	 */
	OPERATIVE_REPORT("371526002", "Operative report (record artifact)", "Operative report", "OP-Bericht", "Protocole opératoire", "Referto operatorio"),
	/**
	 ...
	 */
	BIRTH_CERTIFICATE("444561001", "Birth certificate (record artifact)", "Birth certificate", "Geburtsurkunde", "Certificat de naissance", "Cerificato di nascita"),
	/**
	 ...
	 */
	DEATH_CERTIFICATE("307930005", "Death certificate (record artifact)", "Death certificate", "Todesbescheinigung", "Certificat de décès", "Certificato di morte"),
	/**
	 ...
	 * sulle ferite</div>
	 */
	WOUND_REPORT("721599005", "Wound care management note (record artifact)", "Wound report", "Wund-Befund", "Rapport sur les blessures", "Rapporto sulle ferite"),
	/**
	 ...
	 */
	PROGRESS_NOTE("371532007", "Progress report (record artifact)", "Progress note", "Klinisches Verlaufsblatt", "Note de suite", "Diario clinico"),
	/**
	 ...
	 */
	CONCLUSION_INTERPRETATION_DOCUMENT("722091001", "Conclusion interpretation document (record artifact)", "Conclusion interpretation document", "Beschlussprotokoll", "Rapport de décision", "Rapporto decisionale"),
	/**
	 ...
	 */
	IMAGE_REFERENCE("900000000000471000", "Image reference (foundation metadata concept)", "Image reference", "Referenz auf Bilddaten", "Référence d'Image", "Referenza nei dati immagine"),
	/**
	 ...
	 * vaccinazione</div>
	 */
	IMMUNIZATION_RECORD("41000179103", "Immunization record (record artifact)", "Immunization record", "Impfausweis/Impfdossier", "Certificat / carnet de vaccination", "Certificato/libretto di vaccinazione"),
	/**
	 ...
	 */
	OTHER_EPD_DOCUMENT_TYPE("424975005", "Record entry (record artifact)", "Other EPD-document type", "Anderer EPD Dokumenten-Typ", "Autre type de document DEP", "Altri tipi di documento CIP"),
	/**
	 * <div class="en">Audit trail</div> <div class="de">Audit trail</div>
	 * <div class="fr">Journal d'audit</div> <div class="it">Audit trail</div>
	 */
	AUDIT_TRAIL("722160009", "Audit trail report (record artifact) ", "Audit trail", "Audit trail", "Journal d'audit", "Audit trail"),
	/**
	 * <div class="en">Order</div> <div class="de">Auftrag</div>
	 * <div class="fr">Demande</div> <div class="it">Ordine</div>
	 */
	ORDER("721963009", "Order (record artifact)", "Order", "Auftrag", "Demande", "Ordine");
	 ...
	 *            the display name it
	 */
	TypeCode(String code, String displayName, String displayNameEn, String displayNameDe,
