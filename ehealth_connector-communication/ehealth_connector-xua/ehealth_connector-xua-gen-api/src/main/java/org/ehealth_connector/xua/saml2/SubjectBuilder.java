...
public interface SubjectBuilder extends SimpleBuilder<SubjectType> {
	 ...
	 *  <div class="en">a {@link java.util.List} of {@link org.ehealth_connector.xua.saml2.SubjectConfirmation} to be set</div>
	 * 	<div class="de">eine {@link java.util.List} von {@link org.ehealth_connector.xua.saml2.SubjectConfirmation} die gesetzt werden soll</div>
	 *  <div class="fr"></div>
	 *  <div class="it"></div>
	 * @return
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Method to set a list {@link org.ehealth_connector.xua.saml2.SubjectConfirmation}s of the SubjectConfirmation to be build.</div>
	 * <div class="de">Methode um eine liste von {@link org.ehealth_connector.xua.saml2.SubjectConfirmation} dem SubjectConfirmation hinzuzufügen.</div>
	 * <div class="fr"></div>
	 * <div class="it"></div>
	 *
