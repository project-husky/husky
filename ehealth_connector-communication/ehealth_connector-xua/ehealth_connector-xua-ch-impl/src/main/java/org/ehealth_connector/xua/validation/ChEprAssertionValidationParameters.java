 ...
 * {@link org.opensaml.saml.common.assertion.ValidationContext} while using the {@link ChEprAssertionValidator}.
 */
public class ChEprAssertionValidationParameters {
    ...
    /**
     * Carries a {@link org.ehealth_connector.communication.ch.enums.Role} specifying the CH-EPR Role. Assistants and
    ...
    /**
     * Carries a {@link PurposeOfUse} specifying the purpose of use.
     */
    ...
    /**
     * Carries a {@link List<String>} specifying a plain text the subject's organization name as registered in the
     * HPD or empty, if not known.
     */
    public static final String CH_EPR_ORGANIZATIONS_NAME = STD_PREFIX + STMT_INFIX + ".ChEprOrganizationsName";

    /**
     * Carries a {@link List<String>} specifying the ID of the subject's organization or group registered in the HPD or
     * empty, if not known.
     */
