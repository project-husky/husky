 ...
 *
 */
package org.ehealth_connector.xua.communication.impl;
...
public class ConvenienceUserAccessAuthenticationImpl
	...
	public ConvenienceUserAccessAuthenticationImpl() throws InitializationException {
		...
		initializers.add(
				new org.ehealth_connector.xua.hl7v3.config.XmlObjectProviderInitializer());
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.ehealth_connector.xua.communication.xua.XUserAssertionModule#invokeGetXUserAssertion(org.ehealth_connector.xua.core.SecurityHeaderElement,
	 *      org.ehealth_connector.xua.communication.xua.XUserAssertionRequest,
	 *      org.ehealth_connector.xua.communication.config.XuaClientConfig)
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.ehealth_connector.xua.authentication.AuthenticationModule#invokeUserAuthentication(org.ehealth_connector.xua.authentication.AuthnRequest,
	 *      org.ehealth_connector.xua.communication.config.IdpClientConfig)
	 */
	@Override
