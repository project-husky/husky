...
public class MedicationDispenseDocument
	 ...
	 */
	public void addHl7Authorization(
			org.husky.common.hl7cdar2.POCDMT000040Authorization value) {
	...
	public void addHl7InFulfillmentOf(
			org.husky.common.hl7cdar2.POCDMT000040InFulfillmentOf value) {
	...
	public void addHl7Informant(
			org.husky.common.hl7cdar2.POCDMT000040Informant12 value) {
	...
	private static org.husky.common.hl7cdar2.POCDMT000040InfrastructureRootTypeId createHl7TypeIdFixedValue(
		...
		ObjectFactory factory = new ObjectFactory();
		org.husky.common.hl7cdar2.POCDMT000040InfrastructureRootTypeId retVal = factory
	...
	/**
	 * Gets the hl7Code IHE PHARM DIS document code
	 */
	...
	public void initFirstVersion(Identificator newDocId) {
		...
		if (docId == null)
			docId = new Identificator(Identificator.builder()
					.withRoot(org.husky.common.utils.UUID.generate()).build());
	 ...
	 *         occurred.
	 */
	public static MedicationDispenseDocument loadFromFile(String inputFileName)
	 ...
	 */
	public static MedicationDispenseDocument loadFromFile(File inputFile)
			throws JAXBException, IOException {
		...
		JAXBElement<MedicationDispenseDocument> root = mar.unmarshal(source,
				MedicationDispenseDocument.class);
	...
	/**
	 * Sets the hl7Code IHE PHARM DIS document code
	 */
