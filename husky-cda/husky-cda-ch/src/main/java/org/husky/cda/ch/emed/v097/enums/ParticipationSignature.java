...
public enum ParticipationSignature implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for intended</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for required</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for signed</div>
	 * <!-- @formatter:on -->
	 */
	 ...
	 */
	public static ParticipationSignature getEnum(final String code) {
	...
	public static boolean isEnumOfValueSet(final String enumName) {
		...
		try {
			Enum.valueOf(ParticipationSignature.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	ParticipationSignature(final String code, final String codeSystem, final String displayName,
