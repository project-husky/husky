 ...
 *
 * Identifier: 2.16.840.1.113883.1.11.12249
...
public enum LanguageAbilityMode implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Expressed signed</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Expressed spoken</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Expressed written</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Received signed</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Received spoken</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Received written</div>
	 * <!-- @formatter:on -->
	 */
	...
	public static boolean isEnumOfValueSet(final String enumName) {
		...
		try {
			Enum.valueOf(LanguageAbilityMode.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	LanguageAbilityMode(final String code, final String codeSystem, final String displayName,
