...
public class MedicationCardDocument
	 ...
	 *         occurred.
	 */
	public static MedicationCardDocument loadFromFile(String inputFileName)
	 ...
	 */
	public static MedicationCardDocument loadFromFile(File inputFile)
			throws JAXBException, IOException {
		MedicationCardDocument retVal;
		JAXBContext context = JAXBContext.newInstance(MedicationCardDocument.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<MedicationCardDocument> root = mar.unmarshal(source,
				MedicationCardDocument.class);
