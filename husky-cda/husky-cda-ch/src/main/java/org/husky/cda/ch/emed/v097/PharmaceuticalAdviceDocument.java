...
public class PharmaceuticalAdviceDocument
	...
	/**
	 * Gets the hl7Code IHE PHARM PADV document code
	 */
	 ...
	 *         occurred.
	 */
	public static PharmaceuticalAdviceDocument loadFromFile(String inputFileName)
	 ...
	 */
	public static PharmaceuticalAdviceDocument loadFromFile(File inputFile)
			throws JAXBException, IOException {
		...
		JAXBElement<PharmaceuticalAdviceDocument> root = mar.unmarshal(source,
				PharmaceuticalAdviceDocument.class);
	...
	/**
	 * Sets the hl7Code IHE PHARM PADV document code
	 */
