...
public class ManufacturedMaterialEntryContentModule
		extends org.husky.common.hl7cdar2.POCDMT000040Material {

	public ManufacturedMaterialEntryContentModule() {
		super.setClassCode("MMAT");
		super.setDeterminerCode(
				org.husky.common.hl7cdar2.EntityDeterminerDetermined.KIND);
	...
	public void addPharmIngredient(
			org.husky.common.hl7cdar2.COCTMT230100UVIngredient value) {
	 ...
	 *            the desired fixed value for this argument.
	 */
	private static org.husky.common.hl7cdar2.EN createHl7NameFixedValue(
			String nullFlavor) {
		ObjectFactory factory = new ObjectFactory();
	 ...
	 *            the desired fixed value for this argument.
	 */
	private static org.husky.common.hl7cdar2.COCTMT230100UVContent createPharmAsContentFixedValue(
			String classCode) {
		ObjectFactory factory = new ObjectFactory();
		org.husky.common.hl7cdar2.COCTMT230100UVContent retVal = factory
				.createCOCTMT230100UVContent();
		retVal.setClassCode(
				org.husky.common.hl7cdar2.RoleClassContent.fromValue(classCode));
		return retVal;
	}
	 ...
	 *            the desired fixed value for this argument.
	 */
	private static org.husky.common.hl7cdar2.COCTMT230100UVIngredient createPharmIngredientFixedValue(
			String classCode) {
		ObjectFactory factory = new ObjectFactory();
		org.husky.common.hl7cdar2.COCTMT230100UVIngredient retVal = factory
	...
	public void setPharmAsContent(
			org.husky.common.hl7cdar2.COCTMT230100UVContent value) {
