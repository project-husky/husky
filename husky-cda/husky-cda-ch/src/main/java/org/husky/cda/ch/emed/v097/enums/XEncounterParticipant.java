...
/**
 * <!-- @formatter:off -->
 * Enumeration of x_EncounterParticipant values
 *
 * <div class="en"><p> <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>Clones using this x_domain should have a name "encounterParticipant".</p></div>
 * <div class="de">no designation found for language GERMAN</div>
 * <div class="fr">no designation found for language FRENCH</div>
 * <div class="it">no designation found for language ITALIAN</div>
 *
 * Identifier: 2.16.840.1.113883.1.11.19600
...
public enum XEncounterParticipant implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for admitter</div>
	 * <!-- @formatter:on -->
	 */
	public static final String ADMITTER_CODE = "ADM";

	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for attender</div>
	 * <!-- @formatter:on -->
	 */
	public static final String ATTENDER_CODE = "ATND";

	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for consultant</div>
	 * <!-- @formatter:on -->
	 */
	public static final String CONSULTANT_CODE = "CON";

	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for discharger</div>
	 * <!-- @formatter:on -->
	 */
	public static final String DISCHARGER_CODE = "DIS";

	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for referrer</div>
	 * <!-- @formatter:on -->
	 */
	public static final String REFERRER_CODE = "REF";
	 ...
	 */
	public static XEncounterParticipant getEnum(final String code) {
		for (final XEncounterParticipant x : values()) {
	...
	public static boolean isEnumOfValueSet(final String enumName) {
		...
		try {
			Enum.valueOf(XEncounterParticipant.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	XEncounterParticipant(final String code, final String codeSystem, final String displayName,
