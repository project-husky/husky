 ...
 *
 * <div class="en"><p> <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>A value representing the level of proficiency in a language.</p><p> <i>Example:</i> Excellent, good, fair, poor.</p></div>
 * <div class="de">no designation found for language GERMAN</div>
 * <div class="fr">no designation found for language FRENCH</div>
 * <div class="it">no designation found for language ITALIAN</div>
 *
 * Identifier: 2.16.840.1.113883.1.11.12199
...
public enum LanguageAbilityProficiency implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Excellent</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Fair</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Good</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for Poor</div>
	 * <!-- @formatter:on -->
	 */
	...
	public static boolean isEnumOfValueSet(final String enumName) {
		...
		try {
			Enum.valueOf(LanguageAbilityProficiency.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	LanguageAbilityProficiency(final String code, final String codeSystem, final String displayName,
