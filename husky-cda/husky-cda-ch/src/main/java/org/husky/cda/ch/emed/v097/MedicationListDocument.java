...
public class MedicationListDocument
	 ...
	 *         occurred.
	 */
	public static MedicationListDocument loadFromFile(String inputFileName)
	 ...
	 */
	public static MedicationListDocument loadFromFile(File inputFile)
			throws JAXBException, IOException {
		MedicationListDocument retVal;
		JAXBContext context = JAXBContext.newInstance(MedicationListDocument.class);
		Unmarshaller mar = context.createUnmarshaller();
		StreamSource source = new StreamSource(inputFile);
		JAXBElement<MedicationListDocument> root = mar.unmarshal(source,
				MedicationListDocument.class);
