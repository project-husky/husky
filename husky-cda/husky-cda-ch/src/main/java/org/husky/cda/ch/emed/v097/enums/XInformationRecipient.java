 ...
 *
 * <div class="en"><p> <b>History description 2014-03-26: </b>Lock all vaue sets untouched since 2014-03-26 to trackingId 2014T1_2014_03_26</p><b>description: </b><p>Used to represent participant(s) who should receive a copy of a document.</p></div>
 * <div class="de">no designation found for language GERMAN</div>
 * <div class="fr">no designation found for language FRENCH</div>
 * <div class="it">no designation found for language ITALIAN</div>
 *
 * Identifier: 2.16.840.1.113883.1.11.19366
...
public enum XInformationRecipient implements ValueSetEnumInterface {
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for primary information recipient</div>
	 * <!-- @formatter:on -->
	 */
	...
	/**
	 * <!-- @formatter:off -->
	 * <div class="en">Code for tracker</div>
	 * <!-- @formatter:on -->
	 */
	 ...
	 */
	public static XInformationRecipient getEnum(final String code) {
	...
	public static boolean isEnumOfValueSet(final String enumName) {
		...
		try {
			Enum.valueOf(XInformationRecipient.class, enumName);
			return true;
	 ...
	 *            the display name it
	 */
	XInformationRecipient(final String code, final String codeSystem, final String displayName,
