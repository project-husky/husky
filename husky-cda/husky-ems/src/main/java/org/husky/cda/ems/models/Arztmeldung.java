...
import org.husky.cda.ems.generated.artdecor.EpimsDocumentArztmeldung;
import org.husky.cda.ems.generated.artdecor.EpimsEntryHospitalization;
import org.husky.cda.ems.generated.artdecor.EpimsSectionEmssectionArztmeldung;
import org.husky.cda.ems.narrative.ArztmeldungNarrativeTextGenerator;
...
public class Arztmeldung {
	...
	public Practitioner getLegalAuthenticator() {
		return legalAuthenticator;
	}

	public void setLegalAuthenticator(Practitioner legalAuthenticator) {
	...
	private void addHeader(EpimsDocumentArztmeldung cda) {
		...
		if (this.getAuthors() != null && !this.getAuthors().isEmpty()) {
			for (Practitioner author : getAuthors()) {
