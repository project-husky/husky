...
public class Therapieart extends POCDMT000040EntryRelationship {
	...
	private static org.projecthusky.common.hl7cdar2.POCDMT000040Act createHl7ActFixedValue(String classCode, String moodCode) {
		org.projecthusky.common.hl7cdar2.POCDMT000040Act retVal = new org.projecthusky.common.hl7cdar2.POCDMT000040Act();
		retVal.setClassCode(XActClassDocumentEntryAct.fromValue(classCode));
		retVal.setMoodCode(XDocumentActMood.fromValue(moodCode));
        return retVal;
    }
