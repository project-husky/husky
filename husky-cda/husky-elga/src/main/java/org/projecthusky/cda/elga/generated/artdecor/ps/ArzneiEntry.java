...
public class ArzneiEntry extends POCDMT000040ManufacturedProduct {
    ...
    public ArzneiEntry() {
        super.setClassCode(org.projecthusky.common.hl7cdar2.RoleClassManufacturedProduct.MANU);
     ...
     */
    private static org.projecthusky.common.hl7cdar2.POCDMT000040Material createHl7ManufacturedMaterialFixedValue(String classCode, String determinerCode) {
        ObjectFactory factory = new ObjectFactory();
        org.projecthusky.common.hl7cdar2.POCDMT000040Material retVal = factory.createPOCDMT000040Material();
        retVal.setClassCode(classCode);
        retVal.setDeterminerCode(org.projecthusky.common.hl7cdar2.EntityDeterminerDetermined.fromValue(determinerCode));
        return retVal;
    }
