 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.1.1.1<br>
 * Effective date: 2014-03-25 00:00:00<br>
 * Status: active
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-21")
public class HeaderParticipantAnsprechpartner extends POCDMT000040Participant1 {

    public HeaderParticipantAnsprechpartner() {
        super.getTypeCode().add("CALLBCK");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.1.1.1"));
