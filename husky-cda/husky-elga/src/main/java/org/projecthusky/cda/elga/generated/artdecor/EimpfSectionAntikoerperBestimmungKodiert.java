 ...
 * 
 * Identifier: 1.2.40.0.34.6.0.11.2.7<br>
 * Effective date: 2019-04-12 16:06:34<br>
 * Version: 2019<br>
 * Status: active
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-18")
public class EimpfSectionAntikoerperBestimmungKodiert extends POCDMT000040Section {

    public EimpfSectionAntikoerperBestimmungKodiert() {
        super.getClassCode().add("DOCSECT");
        super.getMoodCode().add("EVN");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.6.0.11.2.7"));
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.3.6.1.4.1.19376.1.3.3.2.1"));
        super.setCode(createHl7CodeFixedValue("26436-6",
     ...
     */
    private static org.projecthusky.common.hl7cdar2.CE createHl7CodeFixedValue(String code, String codeSystem) {
