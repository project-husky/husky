...
/**
 * LebensstilTabakkonsumNominalEntry
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.31<br>
 * Effective date: 2019-01-25 19:51:12<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class LebensstilTabakkonsumNominalEntry extends POCDMT000040Observation {

    public LebensstilTabakkonsumNominalEntry() {
        super.getClassCode().add("OBS");
        super.setMoodCode(org.projecthusky.common.hl7cdar2.XActMoodDocumentObservation.EVN);
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.31"));
        super.setCode(createHl7CodeFixedValue("Cigarette consumption",
                                              "SNOMED CT",
     ...
     */
    public org.projecthusky.common.hl7cdar2.IVLTS getHl7EffectiveTme() {
     ...
     */
    public void setHl7EffectiveTme(org.projecthusky.common.hl7cdar2.IVLTS value) {
