...
public enum Hl7LanguageAbilityMode implements ValueSetEnumInterface {
     ...
     */
    @Nullable
    public static Hl7LanguageAbilityMode getEnum(@Nullable final String code) {
        for (final Hl7LanguageAbilityMode x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(Hl7LanguageAbilityMode.class,
                         enumName);
            return true;
     ...
     */
    Hl7LanguageAbilityMode(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
