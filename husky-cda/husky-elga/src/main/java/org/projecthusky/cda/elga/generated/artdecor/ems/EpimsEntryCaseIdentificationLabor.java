 ...
 * <p>
 * Template description: Template CDA Observation (prototype, directly derived from POCD_RM000040 MIF)<br>
 * <p>
 * Identifier: 1.2.40.0.34.6.0.11.3.91<br>
 * Effective date: 2020-04-22 15:31:59<br>
 * Version: 2020<br>
 * Status: draft
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-01")
public class EpimsEntryCaseIdentificationLabor extends POCDMT000040Observation {

    public EpimsEntryCaseIdentificationLabor() {
        super.getClassCode().add("CASE");
        super.setMoodCode(org.projecthusky.common.hl7cdar2.XActMoodDocumentObservation.EVN);
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.6.0.11.3.91"));
    ...
    /**
     * Adds a predefined org.projecthusky.common.hl7cdar2.II, filled by: "1.2.40.0.34.3.1.1"
     * @return the predefined element.
     */
    public static org.projecthusky.common.hl7cdar2.II getPredefinedId1240034311() {
