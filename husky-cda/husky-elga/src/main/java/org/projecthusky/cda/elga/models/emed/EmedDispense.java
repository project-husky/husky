...
import org.projecthusky.cda.elga.generated.artdecor.emed.AbgabeSection;
import org.projecthusky.cda.elga.generated.artdecor.emed.EMedikationAbgabe;
...
public class EmedDispense  {
	...
	protected AbgabeSection getAbgabeSection() {
		...
		MedBaseTextGenerator textbuilder = new MedBaseTextGenerator(
				patientInstructions, pharmacistInstructions);
		textKonsUeberwGrund.getContent().addAll(textbuilder.getTablesFromCda(deliverySection.getEntry()));
