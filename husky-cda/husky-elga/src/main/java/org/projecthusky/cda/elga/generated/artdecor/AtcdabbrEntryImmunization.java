 ...
 * 
 * Identifier: 1.2.40.0.34.6.0.11.3.1<br>
 * Effective date: 2022-01-25 14:21:09<br>
 * Version: 1.3.0+20220127<br>
 * Status: active
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-18")
public class AtcdabbrEntryImmunization extends POCDMT000040SubstanceAdministration {

    public AtcdabbrEntryImmunization() {
        super.getClassCode().add("SBADM");
        super.setMoodCode(org.projecthusky.common.hl7cdar2.XDocumentSubstanceMood.EVN);
		super.setNegationInd(Boolean.FALSE);
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.6.0.11.3.1"));
        ...
        super.setCode(createHl7CodeFixedValue("IMMUNIZ",
     ...
     */
    private static org.projecthusky.common.hl7cdar2.CD createHl7CodeFixedValue(String code, String codeSystem, String codeSystemName) {
        ObjectFactory factory = new ObjectFactory();
        org.projecthusky.common.hl7cdar2.CD retVal = factory.createCD();
        retVal.setCode(code);
