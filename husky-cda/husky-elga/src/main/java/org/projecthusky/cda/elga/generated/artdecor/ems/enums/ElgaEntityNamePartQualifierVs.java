...
public enum ElgaEntityNamePartQualifierVs implements ValueSetEnumInterface {
     ...
     */
    public static final String VALUE_SET_NAME = "ELGA_EntityNamePartQualifier_VS";
     ...
     */
    @Nullable
    public static ElgaEntityNamePartQualifierVs getEnum(@Nullable final String code) {
        for (final ElgaEntityNamePartQualifierVs x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ElgaEntityNamePartQualifierVs.class,
                         enumName);
            return true;
     ...
     */
    ElgaEntityNamePartQualifierVs(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
