 ...
 * Effective date: 2022-02-25 00:00<br>
...
public enum EImpfImpfstoffeVs implements ValueSetEnumInterface {
    ...
    CERVARIX_FSPR_0_5ML("3513450",
                        ...
                        "TOTRANSLATE"),
    /**
     * EN: COMIRNATY COV19         10x6.<br>
     */
    COMIRNATY_COV19_10X6("5506359",
                         "1.2.40.0.34.4.16.1",
                         "COMIRNATY COV19         10x6",
                         "COMIRNATY COV19         10x6",
                         "TOTRANSLATE",
                         "TOTRANSLATE",
                         "TOTRANSLATE"),
    /**
     * EN: COMIRNATY COV19        195x6.<br>
     */
    COMIRNATY_COV19_195X6("5506342",
                          "1.2.40.0.34.4.16.1",
                          "COMIRNATY COV19        195x6",
                          "COMIRNATY COV19        195x6",
                          "TOTRANSLATE",
                          "TOTRANSLATE",
                          "TOTRANSLATE"),
    ...
    DUKORAL_SUSP_BRGRAN_2X1DOSIS("2465140",
                                 ...
                                 "TOTRANSLATE"),
    /**
     * EN: EFLUELDA FSPR O.KAN.0,7ML.<br>
     */
    EFLUELDA_FSPR_O_KAN_0_7ML("4989918",
                              "1.2.40.0.34.4.16.1",
                              "EFLUELDA FSPR O.KAN.0,7ML",
                              "EFLUELDA FSPR O.KAN.0,7ML",
                              "TOTRANSLATE",
                              "TOTRANSLATE",
                              "TOTRANSLATE"),
    ...
    ENGERIX_B_FSPR_10MCG_0_5ML("1292200",
                               ...
                               "TOTRANSLATE"),
    /**
     * EN: ENGERIX-B INJ FSPR 20MCG/1ML.<br>
     */
    ENGERIX_B_INJ_FSPR_20MCG_1ML("1364721",
                                 "1.2.40.0.34.4.16.1",
                                 "ENGERIX-B INJ FSPR 20MCG/1ML",
                                 "ENGERIX-B INJ FSPR 20MCG/1ML",
                                 "TOTRANSLATE",
                                 "TOTRANSLATE",
                                 "TOTRANSLATE"),
     ...
     */
    FLUCELVAX_TETRA_FSPR_0_5ML("4966403",
                               "1.2.40.0.34.4.16.1",
     ...
     */
    FSME_IMMUN_FSPR_0_5ML_NAD_F("0515738",
                                "1.2.40.0.34.4.16.1",
    ...
    HEXYON_IJSUS_FSPR_2_KAN("3928168",
                            ...
                            "TOTRANSLATE"),
    /**
     * EN: INFANRIX HEXA GLASFL.<br>
     */
    INFANRIX_HEXA_GLASFL("2479314",
                         "1.2.40.0.34.4.16.1",
                         "INFANRIX HEXA GLASFL.",
                         "INFANRIX HEXA GLASFL.",
                         "TOTRANSLATE",
                         "TOTRANSLATE",
                         "TOTRANSLATE"),
    ...
    INFLUVAC_FSPR_0_5ML_O_KANUEL("1265597",
                                 ...
                                 "TOTRANSLATE"),
    /**
     * EN: INFLUVAC TETRA FSPR 0,5ML.<br>
     */
    INFLUVAC_TETRA_FSPR_0_5ML("4482993",
                              "1.2.40.0.34.4.16.1",
                              "INFLUVAC TETRA FSPR 0,5ML",
                              "INFLUVAC TETRA FSPR 0,5ML",
                              "TOTRANSLATE",
                              "TOTRANSLATE",
                              "TOTRANSLATE"),
    ...
    IXIARO_FSPR("3537551",
                ...
                "TOTRANSLATE"),
    /**
     * EN: JANSSEN COV19           10x5.<br>
     */
    JANSSEN_COV19_10X5("4991720",
                       "1.2.40.0.34.4.16.1",
                       "JANSSEN COV19           10x5",
                       "JANSSEN COV19           10x5",
                       "TOTRANSLATE",
                       ...
                       "TOTRANSLATE"),
    /**
     * EN: JANSSEN COV19           20x5.<br>
     */
    JANSSEN_COV19_20X5("5502522",
                       "1.2.40.0.34.4.16.1",
                       "JANSSEN COV19           20x5",
                       "JANSSEN COV19           20x5",
                       "TOTRANSLATE",
     ...
     */
    PREVENAR_13_FSPR_0_5ML_N("3756589",
                             "1.2.40.0.34.4.16.1",
    ...
    RABIPUR_PLV_LSM_2_5IE_ML("2454461",
                             ...
                             "TOTRANSLATE"),
    /**
     * EN: RABIPUR PLV+LSM INJ FSPR.<br>
     */
    RABIPUR_PLV_LSM_INJ_FSPR("4465799",
                             "1.2.40.0.34.4.16.1",
                             "RABIPUR PLV+LSM INJ FSPR",
                             "RABIPUR PLV+LSM INJ FSPR",
                             "TOTRANSLATE",
                             "TOTRANSLATE",
                             "TOTRANSLATE"),
    /**
     * EN: REPEVAX FSPR 0,5ML +KANUELEN.<br>
     */
    REPEVAX_FSPR_0_5ML_KANUELEN("2467788",
                                "1.2.40.0.34.4.16.1",
                                "REPEVAX FSPR 0,5ML +KANUELEN",
                                "REPEVAX FSPR 0,5ML +KANUELEN",
                                "TOTRANSLATE",
                                "TOTRANSLATE",
                                "TOTRANSLATE"),
    /**
     * EN: REVAXIS SPR+2 KANUE.<br>
     */
    REVAXIS_SPR_2_KANUE("2469988",
                        "1.2.40.0.34.4.16.1",
                        "REVAXIS SPR+2 KANUE",
                        "REVAXIS SPR+2 KANUE",
                        "TOTRANSLATE",
     ...
     */
    SHINGRIX_PLV_SUSP_IJSUS_DFL("4985398",
                                "1.2.40.0.34.4.16.1",
                                ...
                                "TOTRANSLATE"),
    /**
     * EN: STAMARIL PLV+LSM DFL+FSPR+2K.<br>
     */
    STAMARIL_PLV_LSM_DFL_FSPR_2K("2470017",
                                 "1.2.40.0.34.4.16.1",
                                 "STAMARIL PLV+LSM DFL+FSPR+2K",
                                 "STAMARIL PLV+LSM DFL+FSPR+2K",
                                 "TOTRANSLATE",
                                 "TOTRANSLATE",
                                 "TOTRANSLATE"),
    ...
    TYPHERIX_IJLSG_25MCG_0_5ML("1333991",
                               ...
                               "TOTRANSLATE"),
    /**
     * EN: TYPHIM VI FSPR 0,5ML +2 KAN.<br>
     */
    TYPHIM_VI_FSPR_0_5ML_2_KAN("2469994",
                               "1.2.40.0.34.4.16.1",
                               "TYPHIM VI FSPR 0,5ML +2 KAN.",
                               "TYPHIM VI FSPR 0,5ML +2 KAN.",
                               "TOTRANSLATE",
                               "TOTRANSLATE",
                               "TOTRANSLATE"),
    /**
     * EN: VAQTA FSPR INJ.SUS.<br>
     */
    VAQTA_FSPR_INJ_SUS("3904699",
                       "1.2.40.0.34.4.16.1",
                       "VAQTA FSPR INJ.SUS",
                       "VAQTA FSPR INJ.SUS",
                       "TOTRANSLATE",
                       ...
                       "TOTRANSLATE"),
    /**
     * EN: VAQTA K FSPR INJ.SUS.<br>
     */
    VAQTA_K_FSPR_INJ_SUS("3904713",
                         "1.2.40.0.34.4.16.1",
                         "VAQTA K FSPR INJ.SUS",
                         "VAQTA K FSPR INJ.SUS",
                         "TOTRANSLATE",
                         "TOTRANSLATE",
                         "TOTRANSLATE"),
    ...
    VARILRIX_PLV_LSM_INJSUSP("1316018",
                             ...
                             "TOTRANSLATE"),
    /**
     * EN: VARIVAX PLV+LSM INJSUSP FSPR.<br>
     */
    VARIVAX_PLV_LSM_INJSUSP_FSPR("2454923",
                                 "1.2.40.0.34.4.16.1",
                                 "VARIVAX PLV+LSM INJSUSP FSPR",
                                 "VARIVAX PLV+LSM INJSUSP FSPR",
                                 "TOTRANSLATE",
                                 "TOTRANSLATE",
                                 "TOTRANSLATE"),
    ...
    VAXIGRIP_TETRA_FSPR_O_K("4467858",
                            ...
                            "TOTRANSLATE"),
    /**
     * EN: VAXNEUVANCE IJSUS FSPR  +1ND.<br>
     */
    VAXNEUVANCE_IJSUS_FSPR_1ND("5505414",
                               "1.2.40.0.34.4.16.1",
                               "VAXNEUVANCE IJSUS FSPR  +1ND",
                               "VAXNEUVANCE IJSUS FSPR  +1ND",
                               "TOTRANSLATE",
                               "TOTRANSLATE",
                               "TOTRANSLATE"),
    ...
    /**
     * EN: Code for COMIRNATY COV19         10x6.<br>
     */
    public static final String COMIRNATY_COV19_10X6_CODE = "5506359";

    /**
     * EN: Code for COMIRNATY COV19        195x6.<br>
     */
    ...
    /**
     * EN: Code for EFLUELDA FSPR O.KAN.0,7ML.<br>
     */
    ...
    /**
     * EN: Code for ENGERIX-B INJ FSPR 20MCG/1ML.<br>
     */
    ...
    /**
     * EN: Code for INFANRIX HEXA GLASFL.<br>
     */
    ...
    /**
     * EN: Code for INFLUVAC TETRA FSPR 0,5ML.<br>
     */
    ...
    /**
     * EN: Code for JANSSEN COV19           10x5.<br>
     */
    public static final String JANSSEN_COV19_10X5_CODE = "4991720";

    /**
     * EN: Code for JANSSEN COV19           20x5.<br>
     */
    ...
    /**
     * EN: Code for STAMARIL PLV+LSM DFL+FSPR+2K.<br>
     */
    ...
    /**
     * EN: Code for VARIVAX PLV+LSM INJSUSP FSPR.<br>
     */
    ...
    /**
     * EN: Code for VAXNEUVANCE IJSUS FSPR  +1ND.<br>
     */
    public static final String VAXNEUVANCE_IJSUS_FSPR_1ND_CODE = "5505414";
     ...
     */
    @Nullable
    public static EImpfImpfstoffeVs getEnum(@Nullable final String code) {
        for (final EImpfImpfstoffeVs x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(EImpfImpfstoffeVs.class,
                         enumName);
            return true;
     ...
     */
    EImpfImpfstoffeVs(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
