 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.14<br>
 * Effective date: 2017-07-13 21:15:15<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class AllergyStatusObservation extends POCDMT000040Observation {

    public AllergyStatusObservation() {
		super.getClassCode().add("OBS");
		super.setMoodCode(XActMoodDocumentObservation.EVN);
		super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.14"));
