 ...
 * <p>
 * EN: ELGA Valueset for type of therapy.<br>
...
public enum ElgaMedikationTherapieArt implements ValueSetEnumInterface {
    ...
    /**
     * EN: Einzelverordnung.<br>
     */
    EINZELVERORDNUNG("EINZEL",
                     ...
                     "TOTRANSLATE"),
    /**
     * EN: Nicht-Einzelverordnung.<br>
     */
    NICHT_EINZELVERORDNUNG("NICHTEINZEL",
                           "1.2.40.0.10.1.4.3.4.3.6",
                           "Nicht-Einzelverordnung",
                           "Nicht-Einzelverordnung",
                           "TOTRANSLATE",
                           "TOTRANSLATE",
                           "TOTRANSLATE");
    ...
    /**
     * EN: Code for Einzelverordnung.<br>
     */
    public static final String EINZELVERORDNUNG_CODE = "EINZEL";

    /**
     * EN: Code for Nicht-Einzelverordnung.<br>
     */
    public static final String NICHT_EINZELVERORDNUNG_CODE = "NICHTEINZEL";
     ...
     */
    public static final String CODE_SYSTEM_ID = "1.2.40.0.10.1.4.3.4.3.6";
