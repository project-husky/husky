 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.1<br>
 * Effective date: 2016-11-06 16:32:31<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class AllergienUnvertraeglichkeitenEntry extends POCDMT000040Act {
    ...
    public AllergienUnvertraeglichkeitenEntry() {
        ...
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.1"));
     ...
     */
    private static org.projecthusky.common.hl7cdar2.POCDMT000040Author createHl7AuthorFixedValue(String typeCode, String contextControlCode) {
    ...
    /**
     * Creates fixed contents for CDA Element hl7Informant
     *
     * @param typeCode the desired fixed value for this argument.
     * @param contextControlCode the desired fixed value for this argument.
     */
    private static org.projecthusky.common.hl7cdar2.POCDMT000040Informant12 createHl7InformantFixedValue(String typeCode, String contextControlCode) {
        ObjectFactory factory = new ObjectFactory();
        org.projecthusky.common.hl7cdar2.POCDMT000040Informant12 retVal = factory.createPOCDMT000040Informant12();
        retVal.getTypeCode().add(typeCode);
        retVal.setContextControlCode(contextControlCode);
        return retVal;
    }
    ...
    /**
     * Adds a predefined org.projecthusky.common.hl7cdar2.POCDMT000040Informant12, filled by: "INF", "OP"
     * @return the predefined element.
     */
    public static org.projecthusky.common.hl7cdar2.POCDMT000040Informant12 getPredefinedInformantInfOp() {
        return createHl7InformantFixedValue("INF",
                                            "OP");
    }
