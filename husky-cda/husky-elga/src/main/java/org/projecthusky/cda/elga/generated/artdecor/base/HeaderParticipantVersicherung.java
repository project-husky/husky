 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.1.1.6<br>
 * Effective date: 2015-11-25 00:00:00<br>
 * Status: active
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-21")
public class HeaderParticipantVersicherung extends POCDMT000040Participant1 {

    public HeaderParticipantVersicherung() {
        super.getTypeCode().add("HLD");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.1.1.6"));
