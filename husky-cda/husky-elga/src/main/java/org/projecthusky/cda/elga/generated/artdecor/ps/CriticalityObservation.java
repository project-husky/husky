 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.18<br>
 * Effective date: 2017-08-10 19:52:16<br>
 * Status: draft
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class CriticalityObservation extends POCDMT000040Observation {

    public CriticalityObservation() {
		super.getClassCode().add("OBS");
		super.setMoodCode(XActMoodDocumentObservation.EVN);
		super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.18"));
        super.setCode(createHl7CodeFixedValue("82606-5",
