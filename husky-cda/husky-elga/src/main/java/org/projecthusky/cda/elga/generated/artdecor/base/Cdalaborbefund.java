...
public class Cdalaborbefund extends POCDMT000040ClinicalDocument {
     ...
     */
    private static org.projecthusky.common.hl7cdar2.POCDMT000040Participant1 createHl7ParticipantFixedValue(String typeCode, String nullFlavor) {
        ObjectFactory factory = new ObjectFactory();
        org.projecthusky.common.hl7cdar2.POCDMT000040Participant1 retVal = factory.createPOCDMT000040Participant1();
