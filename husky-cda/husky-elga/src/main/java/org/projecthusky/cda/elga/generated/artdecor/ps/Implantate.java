 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.4<br>
 * Effective date: 2017-02-26 11:36:47<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class Implantate extends POCDMT000040Section {

    public Implantate() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.4"));
        super.setCode(createHl7CodeFixedValue("46264-8",
