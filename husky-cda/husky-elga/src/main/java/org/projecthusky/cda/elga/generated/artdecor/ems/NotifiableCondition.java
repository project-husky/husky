 ...
 * <p>
 * <p>
 * Identifier: 1.3.6.1.4.1.19376.1.3.1.1.1<br>
...
public class NotifiableCondition extends POCDMT000040Observation {
    ...
    public NotifiableCondition() {
        ...
        super.setCode(createHl7CodeFixedValue("170516003",
     ...
     */
    private static org.projecthusky.common.hl7cdar2.CE createHl7ValueFixedValue() {
        ObjectFactory factory = new ObjectFactory();
     ...
     * Sets the hl7Value
     */
    public void setHl7Value(org.projecthusky.common.hl7cdar2.CE value) {
        getValue().clear();
        getValue().add(value);
    }
}
