 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.4.2.4<br>
...
public class Ueberweisungsgrund extends POCDMT000040Section {

    public Ueberweisungsgrund() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.4.2.4"));
        super.setCode(createHl7CodeFixedValue("46239-0",
