 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.13<br>
 * Effective date: 2017-07-13 21:04:49<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class ProblemStatusObservationEntry extends POCDMT000040Observation {

    public ProblemStatusObservationEntry() {
        super.getClassCode().add("OBS");
        super.setMoodCode(org.husky.common.hl7cdar2.XActMoodDocumentObservation.EVN);
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.13"));
