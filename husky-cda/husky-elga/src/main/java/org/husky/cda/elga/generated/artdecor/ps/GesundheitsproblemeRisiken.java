 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.2<br>
 * Effective date: 2017-01-26 13:50:54<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class GesundheitsproblemeRisiken extends POCDMT000040Section {

    public GesundheitsproblemeRisiken() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.2"));
