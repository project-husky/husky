 ...
 * <p>
 * Identifier: 1.2.40.0.34.10.35<br>
...
public enum ElgaProblemarten implements ValueSetEnumInterface {
    ...
    FUNCTIONAL_LIMITATION("248536006",
                          ...
                          "TOTRANSLATE"),
    /**
     * EN: no current problems or disability.<br>
     */
     ...
     */
    @Nullable
    public static ElgaProblemarten getEnum(@Nullable final String code) {
        for (final ElgaProblemarten x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ElgaProblemarten.class,
                         enumName);
            return true;
     ...
     */
    ElgaProblemarten(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
