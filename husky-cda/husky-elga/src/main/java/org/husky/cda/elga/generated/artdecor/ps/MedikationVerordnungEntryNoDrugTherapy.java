...
public class MedikationVerordnungEntryNoDrugTherapy
	 ...
	 *            the desired fixed value for this argument.
	 */
	private static org.husky.common.hl7cdar2.POCDMT000040Consumable createHl7ConsumableFixedValue() {
		ObjectFactory factory = new ObjectFactory();
		org.husky.common.hl7cdar2.POCDMT000040Consumable retVal = factory.createPOCDMT000040Consumable();
		org.husky.common.hl7cdar2.POCDMT000040ManufacturedProduct prod = factory
		...
		org.husky.common.hl7cdar2.POCDMT000040Material material = factory.createPOCDMT000040Material();
