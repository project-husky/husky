 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.1.1.4<br>
 * Effective date: 2013-11-13 00:00:00<br>
 * Status: active
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class HeaderParticipantNotfallkontakt extends POCDMT000040Participant1 {

    public HeaderParticipantNotfallkontakt() {
        super.getTypeCode().add("IND");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.1.1.4"));
        super.setAssociatedEntity(createHl7AssociatedEntityFixedValue("ECON"));
    }
