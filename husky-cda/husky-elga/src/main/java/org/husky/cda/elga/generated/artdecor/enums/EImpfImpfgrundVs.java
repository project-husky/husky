...
public enum EImpfImpfgrundVs implements ValueSetEnumInterface {
     ...
     */
    @Nullable
    public static EImpfImpfgrundVs getEnum(@Nullable final String code) {
        for (final EImpfImpfgrundVs x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(EImpfImpfgrundVs.class,
                         enumName);
            return true;
     ...
     */
    EImpfImpfgrundVs(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
