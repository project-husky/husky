...
public class AtcdabbrEntryImmunizationRecommendation extends POCDMT000040SubstanceAdministration {
     ...
     */
    private static org.husky.common.hl7cdar2.POCDMT000040Consumable createHl7ConsumableFixedValue(String typeCode) {
        ObjectFactory factory = new ObjectFactory();
        org.husky.common.hl7cdar2.POCDMT000040Consumable retVal = factory.createPOCDMT000040Consumable();
     ...
     * @param nullFlavor the desired fixed value for this argument.
     */
    private static org.husky.common.hl7cdar2.IVLPQ createHl7DoseQuantityFixedValue(String nullFlavor) {
        ObjectFactory factory = new ObjectFactory();
     ...
     */
    private static org.husky.common.hl7cdar2.POCDMT000040EntryRelationship createHl7EntryRelationshipFixedValue(String typeCode, String contextConductionInd) {
        ObjectFactory factory = new ObjectFactory();
     ...
     * @param typeCode the desired fixed value for this argument.
     */
    private static org.husky.common.hl7cdar2.POCDMT000040Precondition createHl7PreconditionFixedValue(String typeCode) {
        ObjectFactory factory = new ObjectFactory();
        org.husky.common.hl7cdar2.POCDMT000040Precondition retVal = factory.createPOCDMT000040Precondition();
        retVal.getTypeCode().add(typeCode);
        return retVal;
    }
     ...
     */
    public static org.husky.common.hl7cdar2.CD getPredefinedApproachSiteCodeNa() {
        return createHl7ApproachSiteCodeFixedValue("NA");
    }

    /**
     * Adds a predefined org.husky.common.hl7cdar2.POCDMT000040Consumable, filled by: "CSM"
     * @return the predefined element.
     */
    public static org.husky.common.hl7cdar2.POCDMT000040Consumable getPredefinedConsumableCsm() {
        return createHl7ConsumableFixedValue("CSM");
    }

    /**
     * Adds a predefined org.husky.common.hl7cdar2.IVLPQ, filled by: "NA"
     * @return the predefined element.
     */
    public static org.husky.common.hl7cdar2.IVLPQ getPredefinedDoseQuantityNa() {
        return createHl7DoseQuantityFixedValue("NA");
    }

    /**
     * Adds a predefined org.husky.common.hl7cdar2.POCDMT000040EntryRelationship, filled by: "RSON", "true"
     * @return the predefined element.
     */
    public static org.husky.common.hl7cdar2.POCDMT000040EntryRelationship getPredefinedEntryRelationshipRsonTrue() {
