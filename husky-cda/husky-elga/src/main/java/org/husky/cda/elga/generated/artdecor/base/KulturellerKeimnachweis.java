 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.30025<br>
 * Effective date: 2017-02-23 00:00:00<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-21")
public class KulturellerKeimnachweis extends POCDMT000040Organizer {

    public KulturellerKeimnachweis() {
     ...
     * @param typeCode the desired fixed value for this argument.
     */
    private static org.husky.common.hl7cdar2.POCDMT000040Specimen createHl7SpecimenFixedValue(String typeCode) {
        ObjectFactory factory = new ObjectFactory();
        org.husky.common.hl7cdar2.POCDMT000040Specimen retVal = factory.createPOCDMT000040Specimen();
     ...
     */
    public List<org.husky.common.hl7cdar2.POCDMT000040Specimen> getHl7Specimen() {
        return specimen;
    }
     ...
     */
    public void setHl7Specimen(org.husky.common.hl7cdar2.POCDMT000040Specimen value) {
        getSpecimen().clear();
