 ...
 * <p>
 * EN: Value Set current smoking status.<br>
 * DE: No designation found.<br>
 * FR: No designation found.<br>
 * IT: No designation found.<br>
 * <p>
 * Identifier: 1.2.40.0.34.10.204<br>
...
public enum ElgaCurrentSmokingStatus implements ValueSetEnumInterface {
    ...
    NEVER_SMOKED_TOBACCO("266919005",
                         ...
                         "TOTRANSLATE"),
    /**
     * EN: Occasional tobacco smoker.<br>
     */
    ...
    SMOKES_TOBACCO_DAILY("449868002",
                         ...
                         "TOTRANSLATE"),
    /**
     * EN: Tobacco smoking consumption unknown.<br>
     */
     ...
     */
    @Nullable
    public static ElgaCurrentSmokingStatus getEnum(@Nullable final String code) {
        for (final ElgaCurrentSmokingStatus x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ElgaCurrentSmokingStatus.class,
                         enumName);
            return true;
     ...
     */
    ElgaCurrentSmokingStatus(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
