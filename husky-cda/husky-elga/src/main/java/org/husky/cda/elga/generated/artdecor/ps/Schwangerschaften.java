 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.9<br>
 * Effective date: 2017-03-11 18:04:25<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class Schwangerschaften extends POCDMT000040Section {

    public Schwangerschaften() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.9"));
        super.setCode(createHl7CodeFixedValue("10162-6",
