 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.8.1<br>
 * Effective date: 2014-01-31 00:00:00<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-22")
public class EMedikationRezept extends POCDMT000040ClinicalDocument {

    public EMedikationRezept() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.8.1"));
        ...
        super.setId(createHl7IdFixedValue("1.2.40.0.10.1.4.3.4.2.1",
                                          "e-MedAT"));
        super.setCode(createHl7CodeFixedValue("57833-6",
     ...
     */
	private static org.husky.common.hl7cdar2.POCDMT000040Component2 createHl7ComponentFixedValue(String typeCode,
			boolean contextConductionInd) {
		org.husky.common.hl7cdar2.POCDMT000040Component2 retVal = new org.husky.common.hl7cdar2.POCDMT000040Component2();
     ...
     */
    private static org.husky.common.hl7cdar2.II createHl7IdFixedValue(String root, String assigningAuthorityName) {
        ObjectFactory factory = new ObjectFactory();
    ...
    /**
	 * Adds a predefined org.husky.common.hl7cdar2.POCDMT000040Component2, filled
	 * by: "COMP", "true"
	 * 
