 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.10006<br>
...
public class Cdaabgabe extends POCDMT000040ClinicalDocument {

    public Cdaabgabe() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.8.2"));
        ...
        super.setId(createHl7IdFixedValue("1.2.40.0.10.1.4.3.4.2.1",
                                          "e-MedAT"));
        super.setCode(createHl7CodeFixedValue("60593-1",
     ...
     */
    public List<org.husky.common.hl7cdar2.POCDMT000040RelatedDocument> getHl7RelatedDocument() {
     ...
     */
    public void setHl7RelatedDocument(org.husky.common.hl7cdar2.POCDMT000040RelatedDocument value) {
