 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.12<br>
 * Effective date: 2017-08-04 12:10:57<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class Beeintraechtigungen extends POCDMT000040Section {

    public Beeintraechtigungen() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.12"));
        super.setCode(createHl7CodeFixedValue("47420-5",
