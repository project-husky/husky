 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.1.2.8<br>
 * Effective date: 2011-12-19 00:00:00<br>
 * Status: active
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class Risiken extends POCDMT000040Section {

    public Risiken() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.1.2.8"));
        super.setCode(createHl7CodeFixedValue("51898-5",
