...
/**
 * LebensstilAlkoholkonsumNominalEntry
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.32<br>
 * Effective date: 2019-01-25 19:59:25<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class LebensstilAlkoholkonsumNominalEntry extends POCDMT000040Observation {

    public LebensstilAlkoholkonsumNominalEntry() {
        super.getClassCode().add("OBS");
        super.setMoodCode(org.husky.common.hl7cdar2.XActMoodDocumentObservation.EVN);
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.32"));
        super.setCode(createHl7CodeFixedValue("How often do you have a drink containing alcohol",
                                              "LOINC",
     ...
     * Adds a hl7Value
     */
    public void addHl7Value(org.husky.common.hl7cdar2.ANY value) {
        getValue().add(value);
    }
