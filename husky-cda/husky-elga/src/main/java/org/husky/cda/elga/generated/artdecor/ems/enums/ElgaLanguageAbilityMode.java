 ...
 * <p>
 * Identifier: 1.2.40.0.34.10.175<br>
 * Effective date: 2017-07-27 00:00<br>
 * Version: 4.2<br>
 * Status: FINAL
 */
@Generated(value = "org.husky.codegenerator.ch.valuesets.UpdateValueSets", date = "2022-02-01")
public enum ElgaLanguageAbilityMode implements ValueSetEnumInterface {
     ...
     */
    public static final String VALUE_SET_NAME = "ELGA_LanguageAbilityMode";
     ...
     */
    @Nullable
    public static ElgaLanguageAbilityMode getEnum(@Nullable final String code) {
        for (final ElgaLanguageAbilityMode x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ElgaLanguageAbilityMode.class,
                         enumName);
            return true;
     ...
     */
    ElgaLanguageAbilityMode(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
