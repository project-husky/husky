...
public class AtcdabbrOtherVaccineProduct extends POCDMT000040ManufacturedProduct {
     ...
     * @param determinerCode the desired fixed value for this argument.
     */
	private static org.husky.common.hl7cdar2.POCDMT000040Organization createHl7ManufacturerOrganizationFixedValue(
			String classCode, String determinerCode) {
		org.husky.common.hl7cdar2.POCDMT000040Organization retVal = new org.husky.common.hl7cdar2.POCDMT000040Organization();
		retVal.setClassCode(classCode);
