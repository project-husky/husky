...
public class AllergienUnvertraeglichkeitenEntry extends POCDMT000040Act {
     ...
     */
    private static org.husky.common.hl7cdar2.POCDMT000040Author createHl7AuthorFixedValue(String typeCode, String contextControlCode) {
     ...
     * @param contextControlCode the desired fixed value for this argument.
     */
    private static org.husky.common.hl7cdar2.POCDMT000040Informant12 createHl7InformantFixedValue(String typeCode, String contextControlCode) {
        ObjectFactory factory = new ObjectFactory();
        org.husky.common.hl7cdar2.POCDMT000040Informant12 retVal = factory.createPOCDMT000040Informant12();
        retVal.getTypeCode().add(typeCode);
        retVal.setContextControlCode(contextControlCode);
        return retVal;
    }
    ...
    /**
     * Adds a predefined org.husky.common.hl7cdar2.POCDMT000040Informant12, filled by: "INF", "OP"
     * @return the predefined element.
     */
    public static org.husky.common.hl7cdar2.POCDMT000040Informant12 getPredefinedInformantInfOp() {
