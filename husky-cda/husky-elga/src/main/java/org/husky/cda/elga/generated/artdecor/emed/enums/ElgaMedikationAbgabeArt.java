...
public enum ElgaMedikationAbgabeArt implements ValueSetEnumInterface {
     ...
     */
    public static final String VALUE_SET_ID = "1.2.40.0.34.10.159";

    /**
     * Name of the value set.
     */
    public static final String VALUE_SET_NAME = "ELGA_MedikationAbgabeArt";
     ...
     */
    @Nullable
    public static ElgaMedikationAbgabeArt getEnum(@Nullable final String code) {
        for (final ElgaMedikationAbgabeArt x : values()) {
    ...
    public static boolean isEnumOfValueSet(@Nullable final String enumName) {
        ...
        try {
            Enum.valueOf(ElgaMedikationAbgabeArt.class,
                         enumName);
            return true;
     ...
     */
    ElgaMedikationAbgabeArt(@NonNull final String code, @NonNull final String codeSystem, @NonNull final String displayName, @NonNull final String displayNameEn, @NonNull final String displayNameDe, @NonNull final String displayNameFr, @NonNull final String displayNameIt) {
