 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.3<br>
 * Effective date: 2017-01-28 14:16:09<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class DurchgefuehrteEingriffe extends POCDMT000040Section {

    public DurchgefuehrteEingriffe() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.3"));
        super.setCode(createHl7CodeFixedValue("67803-7",
