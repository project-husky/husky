 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.14.2.2<br>
 * Effective date: 2017-09-07 15:33:55<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class WeitereInformationen extends POCDMT000040Section {

    public WeitereInformationen() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.14.2.2"));
        super.setCode(createHl7CodeFixedValue("55752-0 ",
