...
public class LaboratoryObservation extends POCDMT000040Observation {
     ...
     * @param typeCode the desired fixed value for this argument.
     */
    private static org.husky.common.hl7cdar2.POCDMT000040ReferenceRange createHl7ReferenceRangeFixedValue(String typeCode) {
        ObjectFactory factory = new ObjectFactory();
        org.husky.common.hl7cdar2.POCDMT000040ReferenceRange retVal = factory.createPOCDMT000040ReferenceRange();
        retVal.getTypeCode().add(typeCode);
        return retVal;
    }
    ...
    /**
     * Adds a predefined org.husky.common.hl7cdar2.POCDMT000040ReferenceRange, filled by: "REFV"
     * @return the predefined element.
     */
    public static org.husky.common.hl7cdar2.POCDMT000040ReferenceRange getPredefinedReferenceRangeRefv() {
