...
public class HeaderParticipantHausarzt extends POCDMT000040Participant1 {
     ...
     */
    public void addHl7FunctionCode(org.husky.common.hl7cdar2.CE value) {
        functionCode = value;
    }
     ...
     */
    private static org.husky.common.hl7cdar2.CE createHl7FunctionCodeFixedValue(String code, String codeSystem, String codeSystemName, String displayName) {
        ObjectFactory factory = new ObjectFactory();
