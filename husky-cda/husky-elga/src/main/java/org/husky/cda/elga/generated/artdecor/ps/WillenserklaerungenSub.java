...
/**
 * Willenserklaerungen_SUB
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.19<br>
 * Effective date: 2019-01-20 20:00:40<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class WillenserklaerungenSub extends POCDMT000040Section {

    public WillenserklaerungenSub() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.19"));
        super.setCode(createHl7CodeFixedValue("42348-3",
