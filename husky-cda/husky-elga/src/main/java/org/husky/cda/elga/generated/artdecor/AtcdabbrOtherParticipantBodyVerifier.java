...
public class AtcdabbrOtherParticipantBodyVerifier extends POCDMT000040Participant2 {

    public AtcdabbrOtherParticipantBodyVerifier() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.6.0.11.9.44"));
	...
	private static org.husky.common.hl7cdar2.POCDMT000040ParticipantRole createHl7ParticipantRoleFixedValue(
			String classCode) {
		org.husky.common.hl7cdar2.POCDMT000040ParticipantRole retVal = new org.husky.common.hl7cdar2.POCDMT000040ParticipantRole();
