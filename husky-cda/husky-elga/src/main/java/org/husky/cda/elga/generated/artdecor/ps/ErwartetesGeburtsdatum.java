...
/**
 * ErwartetesGeburtsdatum
 * <p>
 * Template description: <br>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.3.24<br>
 * Effective date: 2017-08-23 21:55:44<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class ErwartetesGeburtsdatum extends POCDMT000040Observation {

    public ErwartetesGeburtsdatum() {
        super.getClassCode().add("OBS");
        super.setMoodCode(org.husky.common.hl7cdar2.XActMoodDocumentObservation.EVN);
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.3.24"));
