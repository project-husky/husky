...
/**
 * PharmazeutischeEmpfehlungSektion
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.8.4.2.1<br>
 * Effective date: 2014-01-31 00:00:00<br>
 * Status: active
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-02-22")
public class PharmazeutischeEmpfehlungSektion extends POCDMT000040Section {

    public PharmazeutischeEmpfehlungSektion() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.8.4.2.1"));
