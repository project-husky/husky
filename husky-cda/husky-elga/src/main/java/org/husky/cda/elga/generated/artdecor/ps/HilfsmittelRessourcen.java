 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.1.2.9<br>
 * Effective date: 2011-12-19 00:00:00<br>
 * Status: active
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class HilfsmittelRessourcen extends POCDMT000040Section {

    public HilfsmittelRessourcen() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.1.2.9"));
        super.setCode(createHl7CodeFixedValue("RES",
                                              "1.2.40.0.34.5.40",
                                              null,
