 ...
 * <p>
 * <p>
 * Identifier: 1.2.40.0.34.11.13.2.10<br>
 * Effective date: 2017-03-12 12:10:30<br>
 * Version: 0.1<br>
 * Status: draft
 */
@Generated(value = "org.husky.codegenerator.cda.ArtDecor2JavaGenerator", date = "2022-03-01")
public class DiagnostischeResultate extends POCDMT000040Section {

    public DiagnostischeResultate() {
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.13.2.10"));
        super.setCode(createHl7CodeFixedValue("30954-2",
