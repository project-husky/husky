...
public class EimpfEntryAntikoerperBestimmungLaboratoryObservation extends POCDMT000040Observation {

    public EimpfEntryAntikoerperBestimmungLaboratoryObservation() {
		super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.6.0.11.3.16"));
